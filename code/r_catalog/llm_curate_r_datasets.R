...
#
# Exemples :
# Rscript code/r_catalog/llm_curate_r_datasets.R --max_rows 5
# Rscript code/r_catalog/llm_curate_r_datasets.R --package ade4 --bundle macon
# Rscript code/r_catalog/llm_curate_r_datasets.R --category Bons_candidats_spatial --max_rows 20
...
main <- function() {
  ...
  source(file.path("code", "r_catalog", "Inspection_of_each_dataset.R"), encoding = "UTF-8")
