...
Usage:
    python code/r_catalog/enrich_web.py --license-year
    python code/r_catalog/enrich_web.py --publication
    python code/r_catalog/enrich_web.py --license-year --publication
"""
