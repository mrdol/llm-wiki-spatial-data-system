...
# Rscript code/r_catalog/render_r_dataset_rd_docs.R --package spDataLarge
# Rscript code/r_catalog/render_r_dataset_rd_docs.R --package spData --package spDataLarge
# Rscript code/r_catalog/render_r_dataset_rd_docs.R --package spDataLarge --dataset lsl
#
# Sorties :
...
show_package_help <- function(pkg) {
  ...
  # source("code/r_catalog/render_r_dataset_rd_docs.R")
