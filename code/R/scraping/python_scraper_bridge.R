...
portal_scraper_scripts <- c(
  ...
  zenodo = "code/pipeline_portals/python/scrape_zenodo.py",
  figshare = "code/pipeline_portals/python/scrape_figshare.py",
  dataverse = "code/pipeline_portals/python/scrape_dataverse.py",
  dryad = "code/pipeline_portals/python/scrape_dryad.py",
  world_bank = "code/pipeline_portals/python/scrape_world_bank.py",
  eurostat = "code/pipeline_portals/python/scrape_eurostat.py",
  oecd = "code/pipeline_portals/python/scrape_oecd.py",
  un_comtrade = "code/pipeline_portals/python/scrape_un_comtrade.py",
  data_gouv = "code/pipeline_portals/python/scrape_data_gouv.py",
  insee = "code/pipeline_portals/python/scrape_insee.py",
  cepii = "code/pipeline_portals/python/scrape_cepii.py"
)

software_scraper_scripts <- c(
  python_packages = "code/python_catalog/extract_python_software_datasets.py"
)
...
run_portal_plan <- function(warehouse_id = NULL,
  ...
  run_python_script(
    script = "code/pipeline_portals/python/run_portal_plan.py",
    args = list(
...
run_portal_jobs <- function(warehouse_id = NULL,
  ...
  run_python_script(
    script = "code/pipeline_portals/python/execute_portal_jobs.py",
    args = list(
      warehouse_id = warehouse_id,
      dataset_id = dataset_id,
      plan = plan,
