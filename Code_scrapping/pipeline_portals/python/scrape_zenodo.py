...
from portal_common import DEFAULT_DATACANDIDATE_DOWNLOAD_DIR, description_metadata, download_candidate_files


REPO_ROOT = Path(__file__).resolve().parents[3]
DEFAULT_OUTPUT = REPO_ROOT / "data" / "manifests" / "datasets" / "zenodo.records.jsonl"
...
def parse_zenodo_record(
    ...
    *,
    ...
    source_description = metadata.get("description") or metadata.get("notes")
