...
portal_scraper_scripts <- c(
  ...
  zenodo = "Code_scrapping/pipeline_portals/python/scrape_zenodo.py",
  figshare = "Code_scrapping/pipeline_portals/python/scrape_figshare.py",
  dataverse = "Code_scrapping/pipeline_portals/python/scrape_dataverse.py",
  dryad = "Code_scrapping/pipeline_portals/python/scrape_dryad.py",
  world_bank = "Code_scrapping/pipeline_portals/python/scrape_world_bank.py",
  eurostat = "Code_scrapping/pipeline_portals/python/scrape_eurostat.py",
  oecd = "Code_scrapping/pipeline_portals/python/scrape_oecd.py",
  un_comtrade = "Code_scrapping/pipeline_portals/python/scrape_un_comtrade.py",
  data_gouv = "Code_scrapping/pipeline_portals/python/scrape_data_gouv.py",
  insee = "Code_scrapping/pipeline_portals/python/scrape_insee.py",
...
run_portal_plan <- function(warehouse_id = NULL,
  ...
  run_python_script(
    script = "Code_scrapping/pipeline_portals/python/run_portal_plan.py",
    args = list(
...
run_portal_jobs <- function(warehouse_id = NULL,
  ...
  run_python_script(
    script = "Code_scrapping/pipeline_portals/python/execute_portal_jobs.py",
    args = list(
      warehouse_id = warehouse_id,
      dataset_id = dataset_id,
      plan = plan,
