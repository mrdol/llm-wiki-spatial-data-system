...
| paper_arequipa_climate | converted_to_sf | not_ready_relevance_check | no | climate grid product not linked to a Y~X regression benchmark | verify paper-data relation or exclude |
