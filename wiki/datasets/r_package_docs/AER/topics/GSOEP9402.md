...
Details
     ...
     three types of secondary school: ‘"Hauptschule"’ (lower secondary
...
References
     ...
     Winkelmann, R., and Boes, S. (2009). _Analysis of Microdata_, 2nd
...
school: factor ; missing=0 ; examples=Gymnasium

birthyear: integer ; missing=0 ; examples=1981, 1980

gender: factor ; missing=0 ; examples=female

kids: integer ; missing=0 ; examples=2, 3

parity: integer ; missing=0 ; examples=2, 3

income: numeric ; missing=0 ; examples=35160.1134914512, 65748.3452691929, 120962.356460804

size: numeric ; missing=0 ; examples=4, 3

state: factor ; missing=0 ; examples=Berlin

marital: factor ; missing=0 ; examples=married

meducation: numeric ; missing=0 ; examples=14.5, 10.5, 12

memployment: factor ; missing=0 ; examples=none, parttime

year: numeric ; missing=0 ; examples=1995, 1994
