...
Format
     ...
     interest Interest rate (average yearly discount rate at the New
...
gnp: numeric ; missing=0 ; examples=873.4, 944, 992.7

invest: numeric ; missing=0 ; examples=133.3, 149.3, 144.2

price: numeric ; missing=0 ; examples=82.54, 86.79, 91.45

interest: numeric ; missing=0 ; examples=5.16, 5.87, 5.95
