...
References
     ...
     Functions.  _Review of Economic Studies_, *36*, 241-250.

     Zellner, A. and Ryu, H. (1998). Alternative Functional Forms for
     Production, Cost and Returns to Scale Functions.  _Journal of
     Applied Econometrics_, *13*, 101-127.
...
valueadded: numeric ; missing=0 ; examples=126.148, 3201.486, 690.67

capital: numeric ; missing=0 ; examples=3.804, 185.446, 39.712

labor: numeric ; missing=0 ; examples=31.551, 452.844, 124.074

firms: integer ; missing=0 ; examples=68, 1372, 154
