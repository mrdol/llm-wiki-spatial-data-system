...
Format
     ...
     job Ordered factor indicating job category, with levels
...
References
     ...
     H.K. (2004).  _Econometric Methods with Applications in Business
     and Economics_.  Oxford: Oxford University Press.


Variables detected from installed object

job: ordered/factor ; missing=0 ; examples=manage, admin

education: integer ; missing=0 ; examples=15, 16, 12

gender: factor ; missing=0 ; examples=male, female

minority: factor ; missing=0 ; examples=no
