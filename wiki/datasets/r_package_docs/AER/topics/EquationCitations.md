...
Format
     ...
     journal Factor. Journal in which the paper was published (The
          American Naturalist, Evolution, Proceedings of the Royal
...
References
     ...
     Impedes Communication among Biologists. _PNAS - Proceedings of the
     National Academy of Sciences of the United States of America_,
     *109*, 11735-11739. doi:10.1073/pnas.1205259109
     <https://doi.org/10.1073/pnas.1205259109>
...
journal: factor ; missing=0 ; examples=AmNat

authors: character ; missing=0 ; examples=Prodohl et al., Mauricio, Thrall et al.

volume: integer ; missing=0 ; examples=151

startpage: integer ; missing=0 ; examples=7, 20, 29

pages: integer ; missing=0 ; examples=13, 9, 17

equations: integer ; missing=0 ; examples=0, 2, 15

mainequations: integer ; missing=0 ; examples=0, 2, 15

appequations: integer ; missing=0 ; examples=0

cites: integer ; missing=0 ; examples=37, 178, 25

selfcites: integer ; missing=0 ; examples=4, 5, 10

othercites: integer ; missing=0 ; examples=33, 173, 15

theocites: integer ; missing=0 ; examples=8, 19

nontheocites: integer ; missing=0 ; examples=22, 150, 6
