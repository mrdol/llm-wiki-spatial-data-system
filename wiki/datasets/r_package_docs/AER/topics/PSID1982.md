...
experience: integer ; missing=0 ; examples=9, 36, 12

weeks: integer ; missing=0 ; examples=32, 30, 46

occupation: factor ; missing=0 ; examples=white, blue

industry: factor ; missing=0 ; examples=yes

south: factor ; missing=0 ; examples=yes, no
...
union: factor ; missing=0 ; examples=no, yes

education: integer ; missing=0 ; examples=9, 11, 12

ethnicity: factor ; missing=0 ; examples=other

wage: numeric ; missing=0 ; examples=515, 912, 954
