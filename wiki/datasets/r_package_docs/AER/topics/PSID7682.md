...
Format
     ...
     occupation factor. Is the individual a white-collar (‘"white"’) or
          blue-collar (‘"blue"’) worker?

     industry factor. Does the individual work in a manufacturing
          industry?
...
References
     ...
     Estimators. _Journal of Applied Econometrics_, *5*, 401-406.

     Baltagi, B.H. (2001). _Econometric Analysis of Panel Data_, 2nd
     ...
     Greene, W.H. (2008). _Econometric Analysis_, 6th ed. Upper Saddle
...
experience: integer ; missing=0 ; examples=3, 4, 5

weeks: integer ; missing=0 ; examples=32, 43, 40

occupation: factor ; missing=0 ; examples=white

industry: factor ; missing=0 ; examples=no
...
education: integer ; missing=0 ; examples=9

ethnicity: factor ; missing=0 ; examples=other

wage: numeric ; missing=0 ; examples=260, 305, 402

year: factor ; missing=0 ; examples=1976, 1977, 1978

id: factor ; missing=0 ; examples=1
