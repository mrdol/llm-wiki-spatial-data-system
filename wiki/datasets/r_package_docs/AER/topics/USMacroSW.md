...
Format
     ...
     gbpusd GBP/USD exchange rate (US dollar in cents per British
          pound).
...
unemp: numeric ; missing=0 ; examples=3.93333339691162, 4.09999990463257, 4.23333311080933

cpi: numeric ; missing=0 ; examples=27.7766666412354, 28.013334274292, 28.263334274292

ffrate: numeric ; missing=0 ; examples=2.96000003814697, 3, 3.47000002861023

tbill: numeric ; missing=0 ; examples=3.07999992370605, 3.28999996185303, 3.52999997138977

tbond: numeric ; missing=0 ; examples=3.42000007629395, 3.65000009536743, 4.07000017166138

gbpusd: numeric ; missing=0 ; examples=279.3046875, 279.023712158203, 278.5087890625

gdpjp: numeric ; missing=0 ; examples=10149, 10904, 11231
