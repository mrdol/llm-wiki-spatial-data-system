...
Format
     ...
     other factor. Is the mother's ethnicity neither African-American
          nor Hispanic, nor Caucasian? (see below)
...
References
     ...
     _American Economic Review_, *88*, 450-477.
...
morekids: factor ; missing=0 ; examples=no

gender1: factor ; missing=0 ; examples=male, female

gender2: factor ; missing=0 ; examples=female, male

age: integer ; missing=0 ; examples=27, 30

afam: factor ; missing=0 ; examples=no

hispanic: factor ; missing=0 ; examples=no

other: factor ; missing=0 ; examples=no

work: integer ; missing=0 ; examples=0, 30
