...
Format
     ...
     returns real annual returns on stocks, measured using the
          Ibbotson-Sinquefeld data base.

     growth annual growth rate of output, measured by real GNP (from
          the given year to the next year).

     inflation inflation rate, measured as growth of price rate (from
          December of the previous year to December of the present
          year).
...
References
     ...
     Output and Real Stock Returns. _American Economic Review_, *75*,
     1115-1123.

     Lott, W.F., and Ray, S.C. (1992). _Applied Econometrics: Problems
     with Data Sets_. New York: The Dryden Press.
...
returns: numeric ; missing=3 ; examples=53, 31.2, 3.7

growth: numeric ; missing=3 ; examples=6.7, 2.1, 1.8

inflation: numeric ; missing=3 ; examples=-0.4, 0.4, 2.9

growth2: numeric ; missing=0 ; examples=3.9, 4, -1.3

inflation2: numeric ; missing=0 ; examples=2.2, 2.1, 0.6
