...
Format
     ...
     convictions Number of convictions divided by number of murders in
          1950.

     executions Average number of executions during 1946-1950 divided
          by convictions in 1950.
...
References
     ...
     Maddala, G.S. (2001). _Introduction to Econometrics_, 3rd ed. New
     York: John Wiley.

     McManus, W.S. (1985). Estimates of the Deterrent Effect of Capital
     Punishment: The Importance of the Researcher's Prior Beliefs.
     _Journal of Political Economy_, *93*, 417-425.

     Stokes, H. (2004). On the Advantage of Using Two or More
     Econometric Software Systems to Solve the Same Problem. _Journal
     of Economic and Social Measurement_, *29*, 307-320.


Variables detected from installed object

rate: numeric ; missing=0 ; examples=19.25, 7.53, 5.66

convictions: numeric ; missing=0 ; examples=0.204, 0.327, 0.401

executions: numeric ; missing=0 ; examples=0.035, 0.081, 0.012

time: integer ; missing=0 ; examples=47, 58, 82

income: numeric ; missing=0 ; examples=1.1, 0.92, 1.72

lfp: numeric ; missing=0 ; examples=51.2, 48.5, 50.8

noncauc: numeric ; missing=0 ; examples=0.321, 0.224, 0.127

southern: factor ; missing=0 ; examples=yes, no
