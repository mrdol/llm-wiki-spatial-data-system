...
Format
     ...
     kids Number of children. This is coded as a numerical variable but
     ...
     ethnicity factor indicating ethnicity.  Is the individual
          Caucasian (‘"cauc"’) or not (‘"other"’)?

     city16 factor. Did the respondent live in a city (with population
          > 50,000) at age 16?

     lowincome16 factor. Was the income below average at age 16?

     immigrant factor. Was the respondent (or both parents) born
          abroad?
...
kids: numeric ; missing=0 ; examples=0, 1

age: integer ; missing=0 ; examples=25, 30, 55

education: integer ; missing=0 ; examples=14, 13, 2

year: integer ; missing=0 ; examples=2002

siblings: integer ; missing=0 ; examples=1, 4

agefirstbirth: numeric ; missing=5808 ; examples=19, 27, 22

ethnicity: factor ; missing=0 ; examples=cauc

city16: factor ; missing=0 ; examples=no, yes

lowincome16: factor ; missing=0 ; examples=no

immigrant: factor ; missing=0 ; examples=no, yes
