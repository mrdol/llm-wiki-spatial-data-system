...
Format
     ...
     ethnicity factor indicating ethnicity (African-American, Hispanic
          or other).

     score base year composite test score. These are achievement tests
...
References
     ...
     Community Colleges on Educational Attainment. _Journal of Business
     & Economic Statistics_, *12*, 217-224.
...
ethnicity: factor ; missing=0 ; examples=other

score: numeric ; missing=0 ; examples=39.1500015258789, 48.8699989318848, 48.7400016784668

fcollege: factor ; missing=0 ; examples=yes, no

mcollege: factor ; missing=0 ; examples=no

home: factor ; missing=0 ; examples=yes

urban: factor ; missing=0 ; examples=yes

unemp: numeric ; missing=0 ; examples=6.19999980926514

wage: numeric ; missing=0 ; examples=8.09000015258789

distance: numeric ; missing=0 ; examples=0.200000002980232

tuition: numeric ; missing=0 ; examples=0.889150023460388

education: numeric ; missing=0 ; examples=12

income: factor ; missing=0 ; examples=high, low
