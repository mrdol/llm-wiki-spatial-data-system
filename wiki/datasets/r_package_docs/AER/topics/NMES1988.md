...
References
     ...
     Elderly: A Finite Mixture Approach. _Journal of Applied
     Econometrics_, *12*, 313-336.

     Zeileis, A., Kleiber, C., and Jackman, S. (2008). Regression
     Models for Count Data in R. _Journal of Statistical Software_,
     *27*(8). doi:10.18637/jss.v027.i08
...
visits: integer ; missing=0 ; examples=5, 1, 13

nvisits: integer ; missing=0 ; examples=0

ovisits: integer ; missing=0 ; examples=0, 2

novisits: integer ; missing=0 ; examples=0

emergency: integer ; missing=0 ; examples=0, 2, 3

hospital: integer ; missing=0 ; examples=1, 0, 3

health: factor ; missing=0 ; examples=average, poor

chronic: integer ; missing=0 ; examples=2, 4

adl: factor ; missing=0 ; examples=normal, limited

region: factor ; missing=0 ; examples=other

age: numeric ; missing=0 ; examples=6.9, 7.4, 6.6

afam: factor ; missing=0 ; examples=yes, no

gender: factor ; missing=0 ; examples=male, female

married: factor ; missing=0 ; examples=yes, no

school: integer ; missing=0 ; examples=6, 10

income: numeric ; missing=0 ; examples=2.881, 2.7478, 0.6532

employed: factor ; missing=0 ; examples=yes, no

insurance: factor ; missing=0 ; examples=yes, no

medicaid: factor ; missing=0 ; examples=no, yes
