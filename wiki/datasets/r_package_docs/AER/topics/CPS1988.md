...
Format
     ...
     ethnicity Factor with levels ‘"cauc"’ and ‘"afam"’
          (African-American).

     smsa Factor. Does the individual reside in a Standard Metropolitan
          Statistical Area (SMSA)?

     region Factor with levels ‘"northeast"’, ‘"midwest"’, ‘"south"’,
          ‘"west"’.
...
References
     ...
     Moment Testing of Quantile Regression Models.  _Empirical
     Economics_, *26*, 307-324.

     Buchinsky, M. (1998). Recent Advances in Quantile Regression
     Models: A Practical Guide for Empirical Research.  _Journal of
     Human Resources_, *33*, 88-126.
...
wage: numeric ; missing=0 ; examples=354.94, 123.46, 370.37

education: integer ; missing=0 ; examples=7, 12, 9

experience: integer ; missing=0 ; examples=45, 1, 9

ethnicity: factor ; missing=0 ; examples=cauc

smsa: factor ; missing=0 ; examples=yes

region: factor ; missing=0 ; examples=northeast

parttime: factor ; missing=0 ; examples=no, yes
