...
References
     ...
     Bergstrom, T. (2001). Free Labor for Costly Journals? _Journal of
     Economic Perspectives_, 15, 183-198.
...
title: character ; missing=0 ; examples=Asian-Pacific Economic Literature, South African Journal of Economic History, Computational Economics

publisher: factor ; missing=0 ; examples=Blackwell, So Afr ec history assn, Kluwer

society: factor ; missing=0 ; examples=no

price: integer ; missing=0 ; examples=123, 20, 443

pages: integer ; missing=0 ; examples=440, 309, 567

charpp: integer ; missing=0 ; examples=3822, 1782, 2924

citations: integer ; missing=0 ; examples=21, 22

foundingyear: integer ; missing=0 ; examples=1986, 1987

subs: integer ; missing=0 ; examples=14, 59, 17

field: factor ; missing=0 ; examples=General, Economic History, Specialized
