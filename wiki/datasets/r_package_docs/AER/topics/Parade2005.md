...
earnings: numeric ; missing=0 ; examples=10000, 1e+07, 85000

age: numeric ; missing=0 ; examples=26, 18, 39

gender: factor ; missing=0 ; examples=male, female

state: factor ; missing=0 ; examples=ND, CA, NE

celebrity: factor ; missing=0 ; examples=no, yes
