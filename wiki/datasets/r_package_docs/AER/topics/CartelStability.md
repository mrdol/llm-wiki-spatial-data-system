...
Format
     ...
     season factor indicating season of year. To match the weekly data,
          the calendar has been divided into 13 periods, each
          approximately 4 weeks long.
...
References
     ...
     Executive Committee, 1880-1886. _The Bell Journal of Economics_,
     *14*, 301-314.
...
price: numeric ; missing=0 ; examples=0.4

cartel: factor ; missing=0 ; examples=yes

quantity: integer ; missing=0 ; examples=13632, 20035, 16319

season: factor ; missing=0 ; examples=Jan  1 - Jan 28

ice: factor ; missing=0 ; examples=yes
