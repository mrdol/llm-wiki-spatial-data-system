...
Format
     ...
     participation Factor. Did the individual participate in the
          program?
...
References
     ...
     Education.  _Journal of Economic Education_, *11*, 37-44.
...
grade: factor ; missing=0 ; examples=decrease

average: numeric ; missing=0 ; examples=2.66, 2.89, 3.28

testscore: integer ; missing=0 ; examples=20, 22, 24

participation: factor ; missing=0 ; examples=no
