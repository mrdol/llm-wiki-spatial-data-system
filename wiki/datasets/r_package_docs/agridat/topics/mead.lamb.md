...
Format
     ...
     ‘breed’ breed: B1, B2, B3

     ‘lambclass’ lambing class: L0, L1, L2, L3
...
farm: factor ; missing=0 ; examples=F1

breed: factor ; missing=0 ; examples=A

lambclass: factor ; missing=0 ; examples=L0, L1, L2

y: integer ; missing=0 ; examples=10, 21, 96
