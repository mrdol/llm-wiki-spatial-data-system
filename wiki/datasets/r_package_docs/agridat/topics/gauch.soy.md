...
Format
     ...
     ‘rep’ repeated measurement

     ‘gen’ genotype, 7 levels

     ‘env’ environment, 55 levels

     ‘year’ year, 77-88

     ‘loc’ location, 10 levels
...
Details
     ...
     experiment.  The replications appear in random order and do _NOT_
...
yield: integer ; missing=0 ; examples=2729, 2662, 2638

rep: factor ; missing=0 ; examples=R1

gen: factor ; missing=0 ; examples=Evan, Wilk, Chip

env: factor ; missing=0 ; examples=A77

year: integer ; missing=0 ; examples=77

loc: factor ; missing=0 ; examples=Aurora
