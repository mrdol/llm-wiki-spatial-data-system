...
Source
     ...
     of test cultivars with checks _Canadian Journal of Plant Science_,
...
References
     ...
     Performance For Cultivar x Location Data.  _Canadian Journal of
     Plant Science_, 68, 193-198.  https://doi.org/10.4141/cjps88-018
     ...
     Stability Statistics.  _Agronomy Journal_, 92; 454-459.
     https://doi.org/10.2134/agronj2000.923454x


Variables detected from installed object

gen: factor ; missing=0 ; examples=Bruce, Conquest, Laurier

region: factor ; missing=0 ; examples=Atlantic

loc: factor ; missing=0 ; examples=L01

yield: integer ; missing=0 ; examples=4175, 4151, 4482
