...
Source
     ...
     feeding sheep in the house with roots.  _Annals of Agriculture_,
     14, 133-139.
...
food: factor ; missing=0 ; examples=potatoes, turnips, beet

animal: integer ; missing=0 ; examples=1, 6, 11

breed: factor ; missing=0 ; examples=france, beauce, champagne

weight: numeric ; missing=0 ; examples=69.75, 71, 77.25

date: integer ; missing=0 ; examples=0
