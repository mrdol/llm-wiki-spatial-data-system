...
Source
     ...
     Stabilitatsparameter.  _EDV in Medizin und Biologie_, 10 (4),
     112-117.  Table 1.
...
References
     ...
     measures of phenotypic stability.  _Biometrics_, 43, 45-53.


Variables detected from installed object

gen: factor ; missing=0 ; examples=Jubilar, Diplomat, Caribo

env: factor ; missing=0 ; examples=E01

yield: numeric ; missing=0 ; examples=76.3, 78.7, 78.2
