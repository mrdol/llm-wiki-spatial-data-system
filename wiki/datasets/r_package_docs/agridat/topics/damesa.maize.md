...
Source
     ...
     Piepho (2017).  One Step at a Time: Stage-Wise Analysis of a
     Series of Experiments.  Agronomy J, 109, 845-857.
...
gen: factor ; missing=0 ; examples=G06, G22, G17

row: integer ; missing=0 ; examples=1

col: integer ; missing=0 ; examples=1, 2, 3

yield: numeric ; missing=0 ; examples=9.93, 6.51, 7.92
