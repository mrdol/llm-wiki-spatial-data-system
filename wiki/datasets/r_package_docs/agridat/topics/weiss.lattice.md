...
Format
     ...
     ‘gen’ genotype factor, 49 levels

     ‘rep’ rep factor, 4 levels
...
Source
     ...
     Among Large Numbers of Soybean Varieties.  Table 5.  _Agricultural
     Research Bulletins, Nos. 251-259_.
     https://lib.dr.iastate.edu/ag_researchbulletins/24/


Variables detected from installed object

yield: numeric ; missing=0 ; examples=24.5, 23.3, 30.9

gen: factor ; missing=0 ; examples=G45, G47, G49

rep: factor ; missing=0 ; examples=R1

col: integer ; missing=0 ; examples=1, 2, 3

row: integer ; missing=0 ; examples=7
