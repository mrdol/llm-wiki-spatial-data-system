...
Source
     ...
     south-central Washington. _Phytopathology_, 86, 480-484.
     https://doi.org/10.1094/Phyto-86-480

References

     Vinayanand Kandala, _Logistic Regression_


Variables detected from installed object

year: integer ; missing=0 ; examples=1970, 1971, 1972

area: integer ; missing=0 ; examples=0

blight: integer ; missing=0 ; examples=0

rain.am: integer ; missing=0 ; examples=8, 9

rain.ja: integer ; missing=0 ; examples=1, 4, 6

precip.m: numeric ; missing=0 ; examples=5.84, 6.86, 47.29
