...
Source
     ...
     Containing NaCl.  _Crop science_, 23, 882-885.
     https://doi.org/10.2135/cropsci1983.0011183X002300050016x


Variables detected from installed object

gen: factor ; missing=0 ; examples=Anchor, Apollo, Baker

germ: integer ; missing=0 ; examples=100

nacl: numeric ; missing=0 ; examples=0
