...
Format
     ...
     ‘gen’ genotype, 10 levels

     ‘env’ environment, 17 levels
...
Source
     ...
     incomplete variety x environment data.  _Journal of Agricultural
     Science_, 93, 81-86.  https://doi.org/10.1017/S0021859600086159

References

     Hans-Pieter Piepho, 1997.  Analyzing Genotype-Environment Data by
     Mixed-Models with Multiplicative Terms. _Biometrics_, 53, 761-766.
...
yield: numeric ; missing=0 ; examples=2.7, 2.77, 3.13
