...
Format
     ...
     ‘plot’ plot number, consistent across years

     ‘year’ year. Last two digits of 1895, 1896, 1897
...
Details
     ...
     Harris (1920).  Each plot was 1/10 acre, but the dimensions are
     not given. Note that 1/10 acre is also the area of a square 1
     chain (66 feet) on a side.
...
plot: integer ; missing=0 ; examples=101, 102, 103

year: integer ; missing=0 ; examples=1895

yield: numeric ; missing=0 ; examples=30, 29.1, 25.7
