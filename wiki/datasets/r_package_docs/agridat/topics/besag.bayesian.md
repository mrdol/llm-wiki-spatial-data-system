...
Format
     ...
     ‘col’ column (also blocking factor)

     ‘row’ row

     ‘yield’ yield

     ‘gen’ variety/genotype
...
row: integer ; missing=0 ; examples=75, 74, 73

yield: numeric ; missing=1 ; examples=9.29, 8.16, 8.97

gen: factor ; missing=0 ; examples=G57, G39, G03
