...
Details
     ...
     test lines.  The 6 check lines were replicated in each
     environment.
...
gen: integer ; missing=0 ; examples=1, 2, 3

yield: numeric ; missing=0 ; examples=13.22, 12.47, 12.48
