...
Format
     ...
     ‘yield’ grain yield kg/ha divided by 10

Details

     Grown at Roseworthy Agricultural College.  Plots were 5 m long (4
     m sown, 3.3 m harvested) by 0.75 m wide.
...
References
     ...
     Paul H. C. Eilersd (2018).  Correcting for spatial heterogeneity
     in plant breeding experiments with P-splines.  Spatial Statistics,
     23, 52-71.  https://doi.org/10.1016/j.spasta.2017.10.003


Variables detected from installed object

row: integer ; missing=0 ; examples=15, 14, 13

col: integer ; missing=0 ; examples=1

yield: integer ; missing=0 ; examples=256, 198, 218
