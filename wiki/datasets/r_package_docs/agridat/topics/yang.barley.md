...
Multi-environment trial of barley in Alberta, 6 varieties at 18
...
Format
     ...
     ‘site’ site factor, 18 levels

     ‘gen’ genotype factor, 6 levels
...
site: factor ; missing=0 ; examples=Beaverlodge, BigLakes, Calmar

gen: factor ; missing=0 ; examples=ACMetcalfe

yield: numeric ; missing=0 ; examples=4.13, 6.73, 10.18
