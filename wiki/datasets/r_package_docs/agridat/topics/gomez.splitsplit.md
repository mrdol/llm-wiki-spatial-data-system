...
Format
     ...
     ‘nitro’ nitrogen fertilizer, in kilograms/hectare

     ‘management’ plot management

     ‘gen’ genotype/variety of rice
...
management: factor ; missing=0 ; examples=Minimum

gen: factor ; missing=0 ; examples=V1, V2, V3

yield: numeric ; missing=0 ; examples=3.32, 6.101, 5.355

col: integer ; missing=0 ; examples=2

row: integer ; missing=0 ; examples=12, 10, 11
