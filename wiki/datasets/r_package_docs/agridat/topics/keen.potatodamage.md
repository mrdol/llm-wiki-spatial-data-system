...
Format
     ...
     ‘count’ count of tubers in each combination of categories
...
Details
     ...
     combinations of treatments involved about 20 potato tubers.
...
energy: factor ; missing=0 ; examples=E1

weight: factor ; missing=0 ; examples=W1

gen: factor ; missing=0 ; examples=G1

rod: factor ; missing=0 ; examples=R1, R2, R3

damage: factor ; missing=0 ; examples=D1

count: integer ; missing=0 ; examples=5, 8, 6
