...
Format
     ...
     ‘n’ nitrogen treatment, 3 levels 0, 1, 2

     ‘p’ phosphorous treatment, 3 levels 0, 1, 2

     ‘k’ potassium treatment, 3 levels 0, 1, 2

     ‘b’ bagasse treatment, 3 levels 0, 1, 2

     ‘m’ filter press mud treatment, 3 levels 0, 1, 2
...
yield: numeric ; missing=0 ; examples=5.91, 5.93, 4.11
...
trt: integer ; missing=0 ; examples=112, 22222, 20101

n: integer ; missing=0 ; examples=0, 2

p: integer ; missing=0 ; examples=0, 2

k: integer ; missing=0 ; examples=1, 2

b: integer ; missing=0 ; examples=1, 2, 0

m: integer ; missing=0 ; examples=2, 1
