...
Multi-environment trial of corn silage, Year * Loc * Variety with
covariate
...
Format
     ...
     ‘env’ environment/district, 1-7

     ‘gen’ genotype, 1-10

     ‘yield’ dry-matter silage yield for corn

     ‘chu’ corn heat units, thousand degrees Celsius
...
yield: numeric ; missing=0 ; examples=6.27, 5.57, 8.45

chu: numeric ; missing=0 ; examples=2.57, 2.53, 2.72
