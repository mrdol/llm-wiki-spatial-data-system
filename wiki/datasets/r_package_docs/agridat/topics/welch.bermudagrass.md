...
Format
     ...
     ‘n’ nitrogen fertilizer, 4 levels

     ‘p’ phosphorus, 4 levels

     ‘k’ potassium, 4 levels

     ‘yield’ yield of grass, tons/ac
...
p: integer ; missing=0 ; examples=0, 22, 44

k: integer ; missing=0 ; examples=0

yield: numeric ; missing=0 ; examples=1.98, 2.38, 2.18
