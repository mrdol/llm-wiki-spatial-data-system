...
Format
     ...
     ‘gen’ genotype. Note, this is numeric!

     ‘env’ environment

     ‘straw’ straw length

     ‘emergence’ ear emergence, Julian date
...
Source
     ...
     agronomic characters in a wheat germplasm collection.  In: _Wheat
     Genetic Resources. Meeting Diverse Needs_.  Wiley, Chichester,
     U.K., pp.113-130.

References

     Piepho, HP (2003).  Model-based mean adjustment in quantitative
     germplasm evaluation data.  _Genetic Resources and Crop
     Evolution_, 50, 281-290.  https://doi.org/10.1023/A:1023503900759


Variables detected from installed object

gen: integer ; missing=0 ; examples=264, 271, 277

env: factor ; missing=0 ; examples=1970

straw: integer ; missing=188 ; examples=121, 90, 117

emergence: integer ; missing=174 ; examples=156, 155, 148
