...
Format
     ...
     ‘plants’ plants per plot

     ‘flowers’ number of pistillate flowers

     ‘branches’ number of branches

     ‘leaves’ number of leaves

     ‘totalfruit’ total fruit number

     ‘culledfruit’ culled fruit number

     ‘earlyfruit’ early fruit number
...
cycle: integer ; missing=0 ; examples=1

rep: integer ; missing=0 ; examples=1, 2, 3

plants: integer ; missing=0 ; examples=29, 21, 31

flowers: integer ; missing=0 ; examples=22, 17, 52

branches: integer ; missing=0 ; examples=40, 34, 32

leaves: integer ; missing=0 ; examples=240, 120, 440

totalfruit: integer ; missing=0 ; examples=1, 17, 29

culledfruit: integer ; missing=0 ; examples=0, 2, 15

earlyfruit: integer ; missing=0 ; examples=0, 1, 3
