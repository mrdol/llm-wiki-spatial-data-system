...
Source
     ...
     mould epidemics.  _Plant Pathology_. doi:10.1111/ppa.12590
...
study: factor ; missing=0 ; examples=S09

year: integer ; missing=0 ; examples=2010

loc: factor ; missing=0 ; examples=Agua Fria

elev: integer ; missing=0 ; examples=891

region: factor ; missing=0 ; examples=Northern

trt: factor ; missing=0 ; examples=T01, T02, T03

yield: numeric ; missing=0 ; examples=3729, 3739, 3863

mold: numeric ; missing=0 ; examples=37.7, 11.6, 33.5

sclerotia: integer ; missing=66 ; examples=5092, 6154, 200
