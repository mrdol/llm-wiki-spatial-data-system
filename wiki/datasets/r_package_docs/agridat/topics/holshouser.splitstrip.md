...
Format
     ...
     ‘cultivar’ cultivar factor, 4 levels

     ‘spacing’ row spacing

     ‘pop’ population (thousand per acre)
...
cultivar: factor ; missing=0 ; examples=AG4601, AG4701

spacing: integer ; missing=0 ; examples=9, 18

pop: integer ; missing=0 ; examples=120, 300

yield: numeric ; missing=6 ; examples=19.5, 26.2, 26.4
