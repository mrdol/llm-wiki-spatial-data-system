...
Details
     ...
     Each site had 2 reps in 1991 and 3 reps in 1992.  Each rep was
     laid out as a factorial RCB design; one randomization was used for
     all sites in 1991 and one (different) randomization was used for
     all sites in 1992.  (This was confirmed with the principal
     investigator.)
...
gen: factor ; missing=0 ; examples=Illyarrie, Gungurru, Merrit

site: factor ; missing=0 ; examples=S01

rep: factor ; missing=0 ; examples=R1

rate: integer ; missing=0 ; examples=40, 60

row: integer ; missing=0 ; examples=1, 2, 3

col: integer ; missing=0 ; examples=1

serp: factor ; missing=0 ; examples=SE1, SE2, SE3

linrow: numeric ; missing=0 ; examples=-0.75, -0.65, -0.55

lincol: numeric ; missing=0 ; examples=-2.5

linrate: numeric ; missing=0 ; examples=-0.1694215, 1.8305785

yield: numeric ; missing=28 ; examples=0.6171, 1.1936, 1.0994

year: integer ; missing=0 ; examples=91

loc: factor ; missing=0 ; examples=Badgingerra
