...
Description
     ...
     from Fisher's 1929 paper _Studies in Crop Variation 6_.  A
...
Format
     ...
     ‘nitro’ nitrogen fertilizer, cwt/acre

     ‘potash’ potash fertilizer, cwt/acre
...
Source
     ...
     _Journal of Agricultural Science_, 19: 201-213.
...
year: factor ; missing=0 ; examples=1925b

yield: numeric ; missing=0 ; examples=491, 437, 450

block: factor ; missing=0 ; examples=B1, B2

row: integer ; missing=0 ; examples=8, 7, 6

col: integer ; missing=0 ; examples=1

trt: factor ; missing=0 ; examples=m, l, p

nitro: integer ; missing=32 ; examples=2, 4

potash: integer ; missing=32 ; examples=4, 2

ptype: factor ; missing=144 ; examples=N, P
