...
Format
     ...
     ‘gen’ genotype/maize, ‘Bt’ ‘ISO’

     ‘thysan’ thysan abundance

     ‘aranei’ aranei abundance
...
Details
     ...
     Species abundances were measured for _Thysanoptera_ (thrips) and
     _Araneida_ (spiders) in 8 different plots.
...
gen: factor ; missing=0 ; examples=Bt

thysan: numeric ; missing=0 ; examples=16.6, 16.4, 11

aranei: numeric ; missing=0 ; examples=0.8, 0.6
