...
Format
     ...
     ‘irr’ irrigation level, 1..6

     ‘dir’ direction from sprinkler, N/S
...
Source
     ...
     the Line-Source Sprinkler System.  _Soil Science Society of
     America Journal_, 44, 886-888.
...
row: integer ; missing=0 ; examples=9

subplot: integer ; missing=0 ; examples=1, 2, 3

gen: factor ; missing=0 ; examples=Luke

yield: numeric ; missing=0 ; examples=2.4, 2.7, 5.6

irr: integer ; missing=0 ; examples=1, 2, 3
