...
Details
     ...
     Transcription details: Data typed by K.Wright from Roemer (1920),
     table 10.

Source

     Jegorow, M. (1909).  Zur Methodik des feldversuches.  Russian
     Journ Expt Agric, 10, 502-520.  Has a uniformity trial of oats.
...
yield: numeric ; missing=0 ; examples=1.87, 2.22, 2.05
