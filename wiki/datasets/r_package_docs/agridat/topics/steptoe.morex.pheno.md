...
Multi-environment trial of barley, phenotypic and genotypic data for a
population of Steptoe x Morex
...
Format
     ...
     ‘gen’ genotype factor with parents Steptoe and Morex, and 150
          crosses SM1, SM2, ..., SM200. Not all 200 numbers were used.
     ...
     with genotypic data of the 223 markers for the 150 crosses of
     Steptoe x Morex.
...
Source
     ...
     August 1, 1995 https://wheat.pw.usda.gov/ggpages/SxM.  Accessed
     Jan 2015.
...
References
     ...
     _Theoretical and Applied Genetics_, 87, 392-401.
     ...
     interaction model in QTL mapping for adaptation in barley.  _Theor
     Appl Genet_, 93, 30-37.  https://doi.org/10.1007/BF00225723

     Piepho, Hans-Peter. 2000.  A mixed-model approach to mapping
     quantitative trait loci in barley on the basis of multiple
     environment data.  _Genetics_, 156, 2043-2050.

     M. Malosetti, J. Voltas, I. Romagosa, S.E. Ullrich, F.A. van
     Eeuwijk. (2004).  Mixed models including environmental covariables
     for studying QTL by environment interaction.  _Euphytica_, 137,
     139-145.  https://doi.org/10.1023/B:EUPH.0000040511.4638


Variables detected from installed object

gen: factor ; missing=0 ; examples=Steptoe

env: factor ; missing=0 ; examples=MN92, MTi92, MTd92

amylase: numeric ; missing=1066 ; examples=22.7, 30.1, 26.7

diapow: integer ; missing=1066 ; examples=46, 72, 78

hddate: numeric ; missing=0 ; examples=149.5, 178, 165

lodging: integer ; missing=1521 ; examples=10, 15, 0

malt: numeric ; missing=1067 ; examples=73.6, 76.5, 74.5

height: numeric ; missing=5 ; examples=84.5, 75.5, 111

protein: numeric ; missing=1067 ; examples=10.5, 11.2, 13.4

yield: numeric ; missing=0 ; examples=5.5315, 8.6403, 5.899
