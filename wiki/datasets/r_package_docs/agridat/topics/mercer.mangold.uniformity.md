...
Details
     ...
     Each plot was 3 drills, each drill being 2.4 feet wide.  Plots
     were 1/200 acres, 7.2 feet by 30.25 feet long The length of the
     plots runs with the horizontal lines of figures [in Table I], this
     being also the direction of the drills across the field.
...
References
     ...
     Ehrenberg, P. (1915).  Versuch eines Beweises für die
...
row: integer ; missing=0 ; examples=20

col: integer ; missing=0 ; examples=1, 2, 3

roots: integer ; missing=0 ; examples=376, 371, 355

leaves: integer ; missing=0 ; examples=67, 52, 50
