...
Format
     ...
     ‘year’ year of planting, last two digits
...
Source
     ...
     trials.  _Crop Science_, 24, 649-654.
     https://doi.org/10.2135/cropsci1984.0011183X002400040006x

References

     Walter W. Piegorsch, A. John Bailer. (2005) _Analyzing
     Environmental Data_, Wiley.


Variables detected from installed object

country: factor ; missing=0 ; examples=Bangladesh

loc: factor ; missing=0 ; examples=Barisal

year: integer ; missing=0 ; examples=78, 80, 81

month: integer ; missing=0 ; examples=3, 4

rad: integer ; missing=0 ; examples=404, 362, 421

mint: numeric ; missing=0 ; examples=27.2, 28.1, 29.2

yield: numeric ; missing=0 ; examples=2.8, 3.1, 2.3
