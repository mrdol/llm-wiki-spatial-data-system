...
Format
     ...
     ‘gen’ wheat variety, 108 levels

     ‘yield’ yield

Details

     A randomized complete block experiment.  There are 108 varieties
     in 3 reps.  Plots are 6 meters long, 0.75 meters wide, trimmed to
     4.2 meters lengths before harvest. Trimming was done by spraying
     the wheat with herbicide.  The sprayer travelled in a serpentine
...
gen: factor ; missing=0 ; examples=ANGAS, BT_SCHOMBURG, DGR/MNX-9-9e

yield: integer ; missing=0 ; examples=483, 526, 557
