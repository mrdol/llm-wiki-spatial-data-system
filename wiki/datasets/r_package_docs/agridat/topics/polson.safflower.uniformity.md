...
Details
     ...
     0.5 acres in size, 110 x 189 feet.  A four-row planter was used,
     22 inches between rows.  Four rows on either side and 12 feet on
     both ends were removed before harvesting.
...
yield: integer ; missing=0 ; examples=316, 442, 378
