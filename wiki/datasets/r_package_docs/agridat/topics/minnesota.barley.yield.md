...
Format
     ...
     ‘site’ site factor, 6 levels

     ‘gen_name’ genotype name

     ‘gen’ genotype (CI cereal introduction ID)
...
Source
     ...
     of barley in the United States and Canada 1922-1926.  United
     States Department of Agriculture, Technical Bulletin 96.
     ...
     (1940).  Yields of barley varieties in the United States and
     Canada 1932-36.  United States Dept of Agriculture, Technical
     Bulletin 735.
...
References
     ...
     Statistical Determination of Barley Varietal Adaptation.  Journal
     of the American Society of Agronomy, 26, 403-419.
     https://doi.org/10.2134/agronj1934.00021962002600050008x

     Hayes, H.K. and Immer, F.R. (1942).  Methods of plant breeding.
     McGraw Hill.

     Kevin Wright. (2013).  Revisiting Immer's Barley Data.  The
     American Statistitician, 67, 129-133.
     https://doi.org/10.1080/00031305.2013.801783


Variables detected from installed object

site: factor ; missing=0 ; examples=StPaul

gen_name: factor ; missing=0 ; examples=BlackHullless, Horsford, Bernard

gen: integer ; missing=0 ; examples=596, 507, 881

year: integer ; missing=0 ; examples=1893

yield: numeric ; missing=0 ; examples=24.1, 25, 22.8
