...
Format
     ...
     ‘category’ disease damage, ‘C1’ < ‘C2’ < ‘C3’

     ‘count’ number of plants in each category

Details

     In strawberries, red core disease is caused by a fungus,
     _Phytophtora fragariae_.  This experiment evaluated different
     ...
     9 plants.  Each plant was assessed for damage from fungus and
     rated as belonging to category C1, C2, or C3 (increasing damage).
...
Source
     ...
     extravariation is present.  Applied Statistics, 39, 75-84, Table
     1.  https://doi.org/10.2307/2347813


Variables detected from installed object

male: factor ; missing=0 ; examples=P1

female: factor ; missing=0 ; examples=P5, P6, P7

block: factor ; missing=0 ; examples=B1

category: factor ; missing=0 ; examples=C1

count: integer ; missing=0 ; examples=0, 2, 3
