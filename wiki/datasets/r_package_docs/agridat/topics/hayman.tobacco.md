...
Format
     ...
     ‘block’ block factor, 2 levels

     ‘male’ male parent, 8 levels

     ‘female’ female parent

     ‘day’ mean flowering time (days)

Details

     Data was collected in 1951 (Hayman 1954a) and 1952 (Hayman 1954b).

     In each year there were 8 varieties of Aztec tobacco, _Nicotiana
     rustica L._.
...
Source
     ...
     _Genetics_, 39, 789-809.  Table 3, page 805.
...
References
     ...
     models for diallel crosses: A review with R functions.
...
year: integer ; missing=0 ; examples=1951

block: factor ; missing=0 ; examples=B1

male: factor ; missing=0 ; examples=G1, G2, G3

female: factor ; missing=0 ; examples=G1

day: numeric ; missing=0 ; examples=27.6, 13.6, 24.6
