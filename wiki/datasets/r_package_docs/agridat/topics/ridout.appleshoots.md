...
Source
     ...
     Ridout, M. S., Hinde, J. P., and Demetrio, C. G. B. (1998).
     Models for Count Data with Many Zeros.  Proceedings of the 19th
...
roots: integer ; missing=0 ; examples=1

trtn: integer ; missing=0 ; examples=30

photo: integer ; missing=0 ; examples=8

bap: numeric ; missing=0 ; examples=2.2
