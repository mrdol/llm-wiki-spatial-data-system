...
Format
     ...
     ‘pot’ Pot factor, 4 levels

     ‘pair’ Pair factor, 12 levels

     ‘type’ Type factor, self-pollinated, cross-pollinated

     ‘height’ Height, in inches (measured to 1/8 inch)
...
Details
     ...
     observations.  We ought to have at least 50 plants in each case,
     in order to be in a position to deduce fair results".
...
Source
     ...
     Darwin, C. R. 1876. _The effects of cross and self fertilisation
     in the vegetable kingdom_. London: John Murray. Page 16.
...
References
     ...
     R. A. Fisher, (1935) _The Design of Experiments_, Oliver and Boyd.
     Page 30.


Variables detected from installed object

pot: factor ; missing=0 ; examples=I

pair: factor ; missing=0 ; examples=a, b

type: factor ; missing=0 ; examples=cross, self

height: numeric ; missing=0 ; examples=23.5, 17.375, 12
