...
Format
     ...
     ‘gen’ genotype/hybrid, 8 levels

     ‘pop’ population (plants)

     ‘yield’ yield, pounds per hill
...
Source
     ...
     Predicting Optimum Plant Density and Maximum Corn Yield. _Agronomy
     Journal_, 57, 241-244.
...
gen: factor ; missing=0 ; examples=Hy2x0h7

pop: integer ; missing=0 ; examples=2, 4, 6

yield: numeric ; missing=0 ; examples=1.176, 1.73, 1.98
