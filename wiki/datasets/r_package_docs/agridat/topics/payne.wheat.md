...
Format
     ...
     ‘rotation’ rotation treatment

     ‘nitro’ nitrogen rate kg/ha
...
Details
     ...
     AB = arable rotation with spring barley.  AF = arable rotation
     with bare fallow.  Ln3 = 3-year grass lay between crops.  Ln8 =
     8-year grass lay between crops.  Lc3 = 3-year grass-clover lay
     between crops.  Lc8 = 8-year grass-clover lay between crops.
...
rotation: factor ; missing=0 ; examples=AB

nitro: integer ; missing=0 ; examples=0, 70, 140

year: integer ; missing=0 ; examples=1981

yield: numeric ; missing=0 ; examples=3.84, 6.59, 7.49
