...
Format
     ...
     ‘yield’ grain yield, grams/m^2

Details

     An area 20 meters by 38 meters was planted to rice variety IR8.
     At harvest, a 1-meter border was removed around the field and
     ...
     Gomez and Alicbusan (1969) published 4 heatmaps of uniformity
     trials. Trial I heatmap matches the 3x3 moving average heatmap
     example below. The field was planted in 1968.
...
References
     ...
     Gomez, K.A. and R. C. Alicbusan (1969).  Estimation of optimum
     plot size from rice uniformity data.  The Philippine
     Agriculturist. 52, 586-601


Variables detected from installed object

row: integer ; missing=0 ; examples=36, 35, 34

col: integer ; missing=0 ; examples=1

yield: integer ; missing=0 ; examples=842, 803, 773
