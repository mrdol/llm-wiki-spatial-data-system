...
Source
     ...
     Repeated Measurements.  _Applied Statistics_, 36, 296-308.  Table
     1.  https://doi.org/10.2307/2347788

References

     W. Zhang, C. Leng and C. Y. Tang (2015).  A joint modelling
     approach for longitudinal studies _J. R. Statist. Soc. B_, 77
     (2015), 219-238.  https://doi.org/10.1111/rssb.12065


Variables detected from installed object

animal: factor ; missing=0 ; examples=A1, A2, A3

trt: factor ; missing=0 ; examples=A

day: integer ; missing=0 ; examples=0

weight: integer ; missing=0 ; examples=233, 231, 232
