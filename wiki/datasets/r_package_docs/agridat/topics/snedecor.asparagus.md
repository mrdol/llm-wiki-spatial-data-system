...
Source
     ...
     Snedecor and Cochran, 1989. _Statistical Methods_.

References

     Mick O'Neill, 2010.  _A Guide To Linear Mixed Models In An
     Experimental Design Context_.  Statistical Advisory & Training
     Service Pty Ltd.
...
year: integer ; missing=0 ; examples=1929, 1930, 1931

trt: factor ; missing=0 ; examples=Jun-01

yield: integer ; missing=0 ; examples=201, 230, 324
