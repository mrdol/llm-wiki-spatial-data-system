...
Details
     ...
     harvested in 1909.  The drill, 5.5 feet wide, was driven across
     the first series of 14 blocks, the boundaries of the blocks being
     later established.  Each series was sown the same way, no space
     was allowed between the blocks.  Each block was 5.5 ft square.
...
Source
     ...
     Arranging Plats To Secure Comparative Results.  Twenty-Fifth
...
year: integer ; missing=0 ; examples=1909

col: integer ; missing=0 ; examples=1, 2, 3

row: integer ; missing=0 ; examples=1

yield: integer ; missing=0 ; examples=671, 658, 657
