...
Details
     ...
     applications.  Lo management refers to bi-weekly irrigation and
     low nitrogen.
...
doy: integer ; missing=0 ; examples=168

block: factor ; missing=0 ; examples=B1, B2, B3

input: factor ; missing=0 ; examples=Hi

crop: factor ; missing=0 ; examples=M

yield: numeric ; missing=0 ; examples=0.426356589, 0.473684211, 0.444268148
