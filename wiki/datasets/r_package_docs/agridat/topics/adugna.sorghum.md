...
Format
     ...
     ‘gen’ genotype, 28 levels

     ‘trial’ trial, 2 levels

     ‘env’ environment, 13 levels

     ‘yield’ yield kg/ha

     ‘year’ year, 2001-2005

     ‘loc’ location, 3 levels
...
gen: factor ; missing=0 ; examples=G16, G17, G18

trial: factor ; missing=0 ; examples=T2

env: factor ; missing=0 ; examples=E01

yield: integer ; missing=0 ; examples=590, 554, 586

year: integer ; missing=0 ; examples=2001

loc: factor ; missing=0 ; examples=Mieso
