...
yield: numeric ; missing=0 ; examples=5.89, 6.17, 5.68

block: factor ; missing=0 ; examples=B1

gen: factor ; missing=0 ; examples=G54, G44, G68

fung: factor ; missing=0 ; examples=F1

row: integer ; missing=0 ; examples=1

bed: integer ; missing=0 ; examples=1, 2, 3
