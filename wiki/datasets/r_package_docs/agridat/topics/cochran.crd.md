...
Details
     ...
     treatments.  Control, plus spring and fall application of 300,
     600, 1200 pounds/acre of sulfur.  The response variable was
     infection as a percent of the surface area covered with scab.  A
     completely randomized design was used with 8 replications of the
...
Source
     ...
     W.G. Cochran and G. Cox, 1957.  _Experimental Designs_, 2nd ed.
     John Wiley, New York.
...
References
     ...
     field plot data.  _Agronomy Journal_, 80, 712-718.
...
inf: integer ; missing=0 ; examples=9, 12, 18

trt: factor ; missing=0 ; examples=F3, O, S6

row: integer ; missing=0 ; examples=4
