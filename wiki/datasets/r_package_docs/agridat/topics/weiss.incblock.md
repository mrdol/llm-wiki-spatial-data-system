...
Details
     ...
     experiment was 252 ft x 96 feet (7 block * 6 plots * 6 feet = 252,
     16*5 plots plus 4 gaps of 4 feet).  Weiss shows a figure of the
     field (that was later doubled in dize via using two rows per
     plot).
...
Source
     ...
     Among Large Numbers of Soybean Varieties.  _Agricultural Research
     Bulletins, Nos. 251-259_.
     https://lib.dr.iastate.edu/ag_researchbulletins/24/


Variables detected from installed object

block: factor ; missing=0 ; examples=B01, B02, B03

gen: factor ; missing=0 ; examples=G24, G15, G20

yield: numeric ; missing=0 ; examples=29.8, 24.2, 30.5

row: integer ; missing=0 ; examples=42, 36, 30
