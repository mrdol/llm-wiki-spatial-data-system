...
parker.orange.uniformity: Uniformity trial of oranges
...
Format
     ...
     ‘yield’ yield, pounds/tree for plot
...
Details
     ...
     Table 25 has mean top volume per tree for each plot in 1926.
     Table 26 has mean area of trunk cross section.

Source

     E. R. Parker & L. D. Batchelor. (1932).  Variation in the Yields
     of Fruit Trees in Relation to the Planning of Future Experiments.
...
References
     ...
     in a bearing citrus grove.  Vol B451. Berkeley, Cal. :
...
year: integer ; missing=0 ; examples=1921

row: integer ; missing=0 ; examples=1

col: integer ; missing=0 ; examples=1, 2, 3

yield: integer ; missing=526 ; examples=18, 34, 27
