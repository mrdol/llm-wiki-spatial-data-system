...
Format
     ...
     ‘resistivity’ Soil resistivity, ohms

     ‘is.ns’ Indicator of north/south track
...
northing: numeric ; missing=0 ; examples=0.018, 0.0178, 0.0176

easting: numeric ; missing=0 ; examples=0.016, 0.0252, 0.0345

resistivity: numeric ; missing=0 ; examples=34.15, 34.81, 35.65

is.ns: logical ; missing=0 ; examples=FALSE

track: integer ; missing=0 ; examples=1
