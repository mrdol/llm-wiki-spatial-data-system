...
Source
     ...
     Arthur Linder (1960).  Design and Analysis of Experiments, notes
     on lectures held during the fall semester 1963 at the Statistics
...
env: factor ; missing=0 ; examples=Realta

block: factor ; missing=0 ; examples=B1, B2, B3

gen: factor ; missing=0 ; examples=A

yield: integer ; missing=0 ; examples=174, 298, 317
