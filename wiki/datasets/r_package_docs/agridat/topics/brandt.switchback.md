...
Format
     ...
     ‘period’ period, 3 levels

     ‘yield’ milk yield, pounds
...
group: factor ; missing=0 ; examples=A

cow: factor ; missing=0 ; examples=C493, C647, C596

trt: factor ; missing=0 ; examples=T1

period: factor ; missing=0 ; examples=P1

yield: numeric ; missing=0 ; examples=433, 744.6, 858.2
