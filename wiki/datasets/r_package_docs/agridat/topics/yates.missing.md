...
Details
     ...
     tubers innoculated with _Phytophthora Erythroseptica_.
...
trt: factor ; missing=0 ; examples=0, n, k

block: factor ; missing=0 ; examples=B01

y: numeric ; missing=9 ; examples=3.55, 2.3, 3.96

n: integer ; missing=0 ; examples=1, 0

p: integer ; missing=0 ; examples=1
