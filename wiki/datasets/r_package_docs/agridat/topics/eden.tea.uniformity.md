...
Details
     ...
     Transcription details: Data were typed by K.Wright.  Although the
     pdf of the paper had a crease across the page that hid some of the
     digits, the row and column totals included in the paper allowed
     for re-construction of the missing digits.
...
entry: integer ; missing=0 ; examples=3, 10, 7

yield: numeric ; missing=0 ; examples=827, 877.3, 977.1

row: integer ; missing=0 ; examples=12, 11, 10
