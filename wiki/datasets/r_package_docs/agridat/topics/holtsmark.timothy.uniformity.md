...
Source
     ...
     Holtsmark, G. and Bastian R. Larsen (1907) Uber die Fehler, welche
     bei Feldversuchen, durch die Ungleichartigkeit des Bodens bedingt
     werden.  Die Landwirtschaftlichen Versuchs-Stationen, 65, 1-22.
     (In German) https://books.google.com/books?id=eXA2AQAAMAAJ&pg=PA1
...
yield: numeric ; missing=0 ; examples=17.1, 22.2, 26.6
