...
Format
     ...
     ‘a’ whole-plot, 3 levels

     Used with permission of Walt Stroup.

Source

     Walter W. Stroup, 1989.  Predictable functions and prediction
     space in the mixed model procedure.  Applications of Mixed Models
...
y: integer ; missing=0 ; examples=56, 50, 39

rep: factor ; missing=0 ; examples=r1

b: factor ; missing=0 ; examples=b1

a: factor ; missing=0 ; examples=a1, a2, a3
