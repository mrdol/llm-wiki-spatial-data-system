...
Source
     ...
     international wheat yield trial.  Theoretical and Applied
     Genetics, 81, 27-37.  https://doi.org/10.1007/BF00226108
...
loc: factor ; missing=0 ; examples=AK, AS, BJ

locgroup: factor ; missing=0 ; examples=Grp2, Grp1

gen: factor ; missing=0 ; examples=G01

gengroup: factor ; missing=0 ; examples=W2

yield: numeric ; missing=0 ; examples=6, 4.1, 2.7
