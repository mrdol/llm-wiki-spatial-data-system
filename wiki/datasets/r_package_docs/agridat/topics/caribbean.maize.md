...
Format
     ...
     ‘trt’ treatment factor combining N,P,K

     ‘ears’ number of ears harvested

     ‘yield’ yield in kilograms

     ‘N’ nitrogen fertilizer level

     ‘P’ phosphorous fertilizer level

     ‘K’ potassium fertilizer level
...
isle: factor ; missing=0 ; examples=Antigua

site: factor ; missing=0 ; examples=DBAN

block: factor ; missing=0 ; examples=B1

plot: integer ; missing=0 ; examples=1, 2, 3

trt: factor ; missing=0 ; examples=T111, T000, T311

ears: integer ; missing=325 ; examples=42, 41, 49

yield: numeric ; missing=1 ; examples=4.96, 3.94, 6.35

N: integer ; missing=0 ; examples=1, 0, 3

P: integer ; missing=0 ; examples=1, 0
