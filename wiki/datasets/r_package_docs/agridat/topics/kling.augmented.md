...
Details
     ...
     checks have 6 reps.  The response variable is thousand seed
     weight.
...
gen: factor ; missing=0 ; examples=G08, G45, G90

name: factor ; missing=0 ; examples=31, 126, MF183

block: factor ; missing=0 ; examples=B1

tsw: numeric ; missing=0 ; examples=9.25, 9.43, 10.3
