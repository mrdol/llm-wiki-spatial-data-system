...
Details
     ...
     documents to pdf. Screen captures of the pdf were saved as jpg
     files, then uploaded to an OCR conversion site. The resulting text
     was about 95 percent accurate and was carefully hand-checked by
     K.Wright and formatted into csv files.
...
yield: numeric ; missing=17 ; examples=7.4, 6.6, 8
