...
Format
     ...
     ‘gen’ genotype, 24 levels

     ‘env’ environrment, 13 levels

     ‘score’ score

     ‘scale’ scale used for score
...
env: factor ; missing=0 ; examples=Bj03

score: numeric ; missing=0 ; examples=4, 2.5, 3.5

scale: factor ; missing=0 ; examples=0-9
