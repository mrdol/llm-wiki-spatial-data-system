...
Details
     ...
     with a drill that sowed eight rows at a time.  Individual rows
     were harvested in August and threshed with a small nursery
     thresher.  Some authors recommend analyzing the square root of the
     yields.
...
References
     ...
     D.A. Preece, 1981, Distributions of final digits in data, _The
     Statistician_, 30, 31-60.  https://doi.org/10.2307/2987702

     Wilkinson et al. (1983).  Nearest Neighbour (NN) Analysis of Field
     Experiments.  _J. R. Statist. Soc. B_, 45, 151-211.
...
yield: integer ; missing=0 ; examples=715, 595, 580
