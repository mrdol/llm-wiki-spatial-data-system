...
Format
     ...
     ‘y’ weight of cork deposit (centigrams), north direction

Source

     C.R. Rao (1948).  Tests of significance in multivariate analysis.
     _Biometrika_, 35, 58-79.  https://doi.org/10.2307/2332629

References

     K.V. Mardia, J.T. Kent and J.M. Bibby (1979) _Multivariate
     Analysis_, Academic Press.

     Russell D Wolfinger, (1996).  Heterogeneous Variance: Covariance
     Structures for Repeated Measures.  _Journal of Agricultural,
     Biological, and Environmental Statistics_, 1, 205-230.


Variables detected from installed object

tree: factor ; missing=0 ; examples=T01, T02, T03

dir: factor ; missing=0 ; examples=N

y: integer ; missing=0 ; examples=72, 60, 56
