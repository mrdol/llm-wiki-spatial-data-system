...
Format
     ...
     ‘line’ genotype line number

     ‘sire’ sire number

     ‘damage’ dam age, class 1,2,3

     ‘weight’ lamb birth weight
...
Source
     ...
     Linear Model.  _Biometrics_, 41, 137-152.
...
References
     ...
     Daniel Gianola, Keith Hammond.  Advances in Statistical Methods
     for Genetic Improvement of Livestock. Table 8.1, page 165.


Variables detected from installed object

line: integer ; missing=0 ; examples=1

sire: integer ; missing=0 ; examples=1, 2, 3

damage: integer ; missing=0 ; examples=1

weight: numeric ; missing=0 ; examples=6.2, 13, 9.5
