...
Format
     ...
     ‘trial’ Factor for trial

     ‘row’ row ordinate

     ‘col’ column ordinate

     ‘yield’ yield per plant/plot in grams
...
trial: factor ; missing=0 ; examples=T1

row: integer ; missing=0 ; examples=1, 2, 3

col: integer ; missing=0 ; examples=1

yield: integer ; missing=0 ; examples=176, 235, 217
