...
Source
     ...
     Sulphur and phosphorus in balanced pasture nutrition.  _Proc N Z
     Grass Assoc_, 56, 13-16.

References

     Dodds, KG and Sinclair, AG and Morrison, JD. (1995).  A bivariate
     response surface for growth data.  _Fertilizer research_, 45,
     117-122.  https://doi.org/10.1007/BF00790661


Variables detected from installed object

yield: numeric ; missing=0 ; examples=2.7, 3.62, 4.26

P: integer ; missing=0 ; examples=0, 20, 40

S: numeric ; missing=0 ; examples=0
