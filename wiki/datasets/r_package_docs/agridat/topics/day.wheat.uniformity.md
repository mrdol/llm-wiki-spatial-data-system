...
Format
     ...
     ‘grain’ grain weight, grams per plot

     ‘straw’ straw weight, grams per plot
...
grain: numeric ; missing=10 ; examples=67.2, 63.3, 42.8

straw: numeric ; missing=10 ; examples=136.8, 111.7, 83.2
