...
Format
     ...
     ‘gen’ Genotype factor, 36 levels plus Border

     ‘col’ Column

     ‘block’ Row/Block

     ‘wheel’ Position relative to wheel tracks

     ‘yield’ Root yields, kg/plot
...
gen: factor ; missing=0 ; examples=G19, B, G23

col: integer ; missing=0 ; examples=2, 1, 3

block: integer ; missing=0 ; examples=1

wheel: integer ; missing=6 ; examples=1, 2, 3

yield: numeric ; missing=0 ; examples=14.2, 37.1, 29.9
