...
Details
     ...
     harvested area = (distance * swath width) / 6272640 yield =
     drygrain / area

Source

     University of Minnesota Precision Agriculture Center.  Retrieved
     27 Aug 2015 from
...
long: numeric ; missing=0 ; examples=-93.97842, -93.978421, -93.978422

lat: numeric ; missing=0 ; examples=43.927265, 43.927228, 43.927184

mass: numeric ; missing=0 ; examples=16.54, 22.52, 27.01

time: integer ; missing=0 ; examples=0, 3, 6

seconds: integer ; missing=0 ; examples=3

dist: integer ; missing=0 ; examples=116, 159, 169

moist: numeric ; missing=0 ; examples=18.5, 16.7, 17.2

elev: numeric ; missing=0 ; examples=1030.58, 1029.92
