...
Format
     ...
     ‘thinning’ thinning treatment

     ‘volume’ stem volume in m^3/ha

     ‘growth’ annual stem volume increment m^3/ha at age 11
...
Source
     ...
     P.G. De Vries, J.W. Hildebrand, N.R. De Graaf. (1978).  Analysis
     of 11 years growth of carribbean pine in a replicated Graeco-Latin
...
spacing: factor ; missing=0 ; examples=a, b, c

thinning: factor ; missing=0 ; examples=s, z, m

volume: numeric ; missing=0 ; examples=91, 53.7, 37.8

growth: numeric ; missing=0 ; examples=24.4, 28.9, 25.7
