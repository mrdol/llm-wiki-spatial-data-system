...
county: factor ; missing=0 ; examples=CerroGordo, Hamilton, Worth

segment: integer ; missing=0 ; examples=1

countysegs: integer ; missing=0 ; examples=545, 566, 394

cornhect: numeric ; missing=0 ; examples=165.76, 96.32, 76.08

soyhect: numeric ; missing=0 ; examples=8.09, 106.03, 103.6

cornpix: integer ; missing=0 ; examples=374, 209, 253

soypix: integer ; missing=0 ; examples=55, 218, 250

cornmean: numeric ; missing=0 ; examples=295.29, 300.4, 289.6

soymean: numeric ; missing=0 ; examples=189.7, 196.55, 205.28
