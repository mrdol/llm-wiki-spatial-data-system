...
Format
     ...
     ‘gen’ genotype / cultivar factor

     ‘col’ column

     ‘row’ row

     ‘rep’ replicate block (numeric)

     ‘date’ date for data collection

     ‘y’ score 1-9 for blight resistance
...
Details
     ...
     _Phytophthora infestans_. In each trial, the damage to necrotic
...
Source
     ...
     Lee, Arier Chi-Lun (2009).  Random effects models for ordinal
     data.  Ph.D. thesis, The University of Auckland.
     https://researchspace.auckland.ac.nz/handle/2292/4544.


Variables detected from installed object

year: integer ; missing=0 ; examples=1983

gen: factor ; missing=0 ; examples=064.37, 064.1, RUA

col: integer ; missing=0 ; examples=1, 2, 3

row: integer ; missing=0 ; examples=1

rep: integer ; missing=0 ; examples=1

date: factor ; missing=0 ; examples=1983-10-17

y: integer ; missing=121 ; examples=9
