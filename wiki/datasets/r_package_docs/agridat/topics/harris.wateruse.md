...
Format
     ...
     ‘species’ species factor, 2 levels

     ‘age’ age factor, 2 levels

     ‘tree’ tree factor, 40 (non-consecutive) levels

     ‘day’ day, numeric

     ‘water’ water use, numeric
...
species: factor ; missing=0 ; examples=S2

age: factor ; missing=0 ; examples=A1

tree: factor ; missing=0 ; examples=T01

day: integer ; missing=0 ; examples=161, 166, 170

water: numeric ; missing=48 ; examples=0.92, 0.93, 0.86
