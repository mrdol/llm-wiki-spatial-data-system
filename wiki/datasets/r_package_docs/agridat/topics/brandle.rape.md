...
Source
     ...
     grown in Manitoba.  Canadian Journal of Plant Science, 68,
     381-388.


Variables detected from installed object

gen: factor ; missing=0 ; examples=Altex, Andor, Regent

year: integer ; missing=0 ; examples=1983

loc: factor ; missing=0 ; examples=Souris

yield: integer ; missing=0 ; examples=1868, 2256, 2808
