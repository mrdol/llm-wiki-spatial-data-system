...
Source
     ...
     height growth in year-old western white pine.  _Proc Forest Genet
     Workshop_. 22, 71-76.

     Walter A. Becker (1984).  _Manual of Quantitative Genetics_, 4th
     ed. Page 83.
...
female: factor ; missing=0 ; examples=F193

male: factor ; missing=0 ; examples=M17

length: numeric ; missing=0 ; examples=4.47, 4.32, 3.5
