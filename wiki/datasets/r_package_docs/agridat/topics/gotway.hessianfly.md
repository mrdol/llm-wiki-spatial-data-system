...
Format
     ...
     ‘y’ number of damaged plants

     ‘n’ number of total plants
...
Source
     ...
     C. A. Gotway and W. W. Stroup.  A Generalized Linear Model
     Approach to Spatial Data Analysis and Prediction _Journal of
     Agricultural, Biological, and Environmental Statistics_, 2,
     157-178.
...
gen: factor ; missing=0 ; examples=G14, G16, G07

lat: integer ; missing=0 ; examples=1

long: integer ; missing=0 ; examples=1, 2, 3

y: integer ; missing=0 ; examples=2, 1, 9

n: integer ; missing=0 ; examples=8, 9, 13
