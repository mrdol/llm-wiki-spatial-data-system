...
Format
     ...
     ‘yield’ weight of marketable fruit per plot
...
loc: factor ; missing=0 ; examples=Clemson

gen: factor ; missing=0 ; examples=Dasher

row: integer ; missing=0 ; examples=1, 2, 3

col: integer ; missing=0 ; examples=3, 4, 2

yield: numeric ; missing=0 ; examples=44.2, 54.1, 47.2
