...
Source
     ...
     Jawahar R. Sharma. 1988.  Statistical and Biometrical Techniques
     in Plant Breeding.  New Age International Publishers.
...
gen: factor ; missing=0 ; examples=A, B, C
...
yield: integer ; missing=0 ; examples=60, 80, 25
