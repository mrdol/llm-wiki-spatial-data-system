...
Format
     ...
     ‘iblock’ incomplete block

     ‘gen_new’ new genotype (1=yes, 0=no)

     ‘gen_check’ check genotype (0=no)
...
Source
     ...
     Baenziger (2018).  Genomic Selection in Preliminary Yield Trials
     in a Winter Wheat Breeding Program.  G3 Genes|Genomes|Genetics, 8,
...
loc: factor ; missing=0 ; examples=Alliance

rep: factor ; missing=0 ; examples=R1

iblock: factor ; missing=0 ; examples=I01

gen_new: integer ; missing=0 ; examples=0, 1

gen_check: factor ; missing=0 ; examples=Camelot, 0

gen: factor ; missing=0 ; examples=Camelot, NE16471, NE16510

col: integer ; missing=0 ; examples=1

row: integer ; missing=0 ; examples=16, 17, 18

yield: numeric ; missing=9 ; examples=71.4, 56.5, 50.8
