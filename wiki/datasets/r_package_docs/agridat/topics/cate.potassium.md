...
Source
     ...
     Cate, R.B. and Nelson, L.A. (1971).  A simple statistical
     procedure for partitioning soil test correlation data into two
     classes.  _Soil Science Society of America Journal_, 35, 658-660.
     https://doi.org/10.2136/sssaj1971.03615995003500040048x


Variables detected from installed object

yield: numeric ; missing=0 ; examples=53.5, 64.8, 63

potassium: integer ; missing=0 ; examples=26, 28, 30
