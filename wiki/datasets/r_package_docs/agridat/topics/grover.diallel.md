...
Format
     ...
     ‘parent1’ a character vector

     ‘parent2’ a character vector

     ‘cross’ a character vector
...
yield: numeric ; missing=0 ; examples=104.86, 88.66, 109.76

rep: factor ; missing=0 ; examples=R1

parent1: factor ; missing=0 ; examples=P1

parent2: factor ; missing=0 ; examples=P1, P2, P3

cross: factor ; missing=0 ; examples=P1:P1, P1:P2, P1:P3
