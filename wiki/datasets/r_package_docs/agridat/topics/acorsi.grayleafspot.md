...
Details
     ...
     Experiments conducted in 9 environments in Brazil in 2010-11.
     Each location had an RCB with 2 reps.
...
Source
     ...
     resistant to grey leaf spot.  _Journal of Agricultural Science_.
...
env: factor ; missing=0 ; examples=LD, CM

rep: factor ; missing=0 ; examples=R1, R2

y: numeric ; missing=0 ; examples=1e-04, 0.2
