...
Details
     ...
     parts of the field for the two papers.
     ...
     deviations from the mean yield (15.6 bu).  We added the mean to
     all plot data.

     Paper #2 - Garber (1931)

     The year and crop was 1927 corn, 1928 oats, 1929 wheat. The data
     given in the paper were percent-of-mean. We converted the data
     back to absolute yield
...
plot: integer ; missing=1197 ; examples=1, 51, 101

year: integer ; missing=0 ; examples=1923

crop: factor ; missing=0 ; examples=oats

yield: numeric ; missing=1169 ; examples=1923, 2066, 1943
