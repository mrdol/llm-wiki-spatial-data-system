...
Format
     ...
     ‘gen’ genotype, 17 levels

     ‘env’ environment, 12 levels

     ‘yield’ yield, tonnes/ha

     ‘environment’ environment, 13 levels

     ‘year’ year, 85-87

     ‘loc’ location, 4 levels
...
Details
     ...
     1987.  Each loc was planted as RCB design with 4 reps.  Mean
     yields are given in this data.
...
gen: factor ; missing=0 ; examples=Coker21, G4522, G4673A

env: factor ; missing=0 ; examples=AL85

yield: numeric ; missing=0 ; examples=10.2, 8.8

year: integer ; missing=0 ; examples=85

loc: factor ; missing=0 ; examples=AL
