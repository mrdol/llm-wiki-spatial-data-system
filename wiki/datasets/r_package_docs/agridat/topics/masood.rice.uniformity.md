...
Details
     ...
     yield trial.  A single variety of rice was harvested in an area
     12m x 24 m.  Yield in kilograms was measured for each square
     meter.  Masood et al report a low degree of similarity for
     neighboring plots.
...
Source
     ...
     plot size and shape in paddy yield trial.  Pakistan J. Agric.
     Res., Vol. 25 No. 4, 2012
...
yield: numeric ; missing=0 ; examples=0.36, 0.29, 0.26
