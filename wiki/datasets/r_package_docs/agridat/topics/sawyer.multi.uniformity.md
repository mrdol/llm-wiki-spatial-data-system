...
Format
     ...
     ‘grain’ wheat/oats grain weight, pounds

     ‘straw’ wheat/oats straw weight, pounds

     ‘leafwt’ swedes leaf weight, pounds

     ‘rootwt’ swedes root weight, pounds

     ‘rootct’ swedes root count
...
References
     ...
     heterogeneity on the growth and yield of successive crops.  Jour
...
year: integer ; missing=0 ; examples=1925

crop: factor ; missing=0 ; examples=wheat

row: integer ; missing=0 ; examples=6

col: integer ; missing=0 ; examples=1, 2, 3

grain: numeric ; missing=50 ; examples=229, 202.625, 197.375

straw: numeric ; missing=50 ; examples=282.5, 247, 252

leafwt: numeric ; missing=97 ; examples=613.5, 601.5, 816.5

rootwt: integer ; missing=97 ; examples=3608, 3936, 4372

rootct: integer ; missing=97 ; examples=1716, 1689, 1688
