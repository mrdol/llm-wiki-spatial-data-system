...
archbold.apple: Split-split plot experiment of apple trees
...
Format
     ...
     ‘spacing’ spacing between trees, 6,10,14 feet

     ‘stock’ rootstock, 4 levels

     ‘gen’ genotype, 2 levels

     ‘yield’ yield total, kg/tree from 1975-1979
...
Source
     ...
     delicious and Golden delicious apple.  _Journal of the American
     Society for Horticultural Science_, 112, 219-222.

References

     Cornelius, PL and Archbold, DD, 1989.  Analysis of a split-split
     plot experiment with missing data using mixed model equations.
     _Applications of Mixed Models in Agriculture and Related
     Disciplines_.  Pages 55-79.
...
row: integer ; missing=0 ; examples=2

pos: integer ; missing=0 ; examples=1, 2, 8

spacing: integer ; missing=0 ; examples=6

stock: factor ; missing=0 ; examples=Seedling, MM111

gen: factor ; missing=0 ; examples=Redspur, Golden

yield: numeric ; missing=28 ; examples=70.9, 130.9, 114.5

trt: integer ; missing=0 ; examples=601, 602, 611
