...
Details
     ...
     where gen was fixed and all other terms random.  The adjusted
     means were used as the response in a second stage:
...
References
     ...
     (2014).  Inheritance of Decay of Fresh-cut Lettuce in a
     Recombinant Inbred Line Population from "Salinas 88" × "La
     Brillante".  J. Amer. Soc. Hort. Sci., 139(4), 388-398.
...
gen: factor ; missing=0 ; examples=G1, G2

rep: factor ; missing=0 ; examples=R1, R2

dmr: numeric ; missing=2 ; examples=2, 2.5, 1.5
