...
Details
     ...
     that _Urtica dioica_ (nettle) became established according to the
...
References
     ...
     randomized complete blocks.  _Journal of agricultural, biological,
     and environmental statistics_, 6, 367-378.
...
nettle: numeric ; missing=0 ; examples=5, 0.1

herb: integer ; missing=0 ; examples=58, 76, 83
