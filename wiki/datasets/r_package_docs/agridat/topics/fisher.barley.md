...
Format
     ...
     ‘gen’ genotype/variety, 5 levels

     ‘env’ environment/location, 2 levels
...
Details
     ...
     This is a subset of Immer's barley data.  The yield values here
     are totals of 3 reps (Immer gave the average yield of 3 reps).

Source

     Ronald Fisher (1935).  _The Design of Experiments_.
...
yield: numeric ; missing=0 ; examples=81, 80.7, 146.6

gen: factor ; missing=0 ; examples=Manchuria

env: factor ; missing=0 ; examples=UniversityFarm, Waseca

year: integer ; missing=0 ; examples=1931, 1932
