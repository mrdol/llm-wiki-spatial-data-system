...
Format
     ...
     ‘fumigant’ fumigant factor

     ‘dose’ dose, Numeric 0,1,2.  Maybe should be a factor?

     ‘initial’ count of eelworms pre-treatment

     ‘final’ count of eelworms post-treatment

     ‘grain’ grain yield in pounds

     ‘straw’ straw yield in pounds

     ‘weeds’ ratio of weeds to total oats
...
Source
     ...
     Cochran and Cox, 1950.  _Experimental Designs_. Table 3.1.

References

     R. A. Bailey (2008).  Design of Comparative Experiments.
     Cambridge.
...
col: integer ; missing=0 ; examples=2, 3, 4

fumigant: factor ; missing=0 ; examples=Con, See, Chl

dose: integer ; missing=0 ; examples=0, 2, 1

initial: integer ; missing=0 ; examples=269, 283, 252

final: integer ; missing=0 ; examples=466, 280, 398

grain: numeric ; missing=0 ; examples=8, 0.5, 5.1

straw: numeric ; missing=0 ; examples=9.1, 0.4, 6.7

weeds: numeric ; missing=0 ; examples=52.1, 0.1, 14.4
