...
Format
     ...
     ‘county’ county factor, 99 levels
     ...
     ‘yield’ average corn yield per acre (bu)

     ‘corn’ percent of land in corn

     ‘grain’ percent of land in small grains

     ‘untillable’ percent of land untillable

     ‘fedval’ land value (excluding buildings) per acre, 1925 federal
          census

     ‘stval’ land value (excluding buildings) per acre, 1925 state
          census
...
Source
     ...
     H.A. Wallace (1926). Comparative Farm-Land Values in Iowa.  _The
     Journal of Land & Public Utility Economics_, 2, 385-392.  Page
...
county: factor ; missing=0 ; examples=adair, adams, allamakee

fips: integer ; missing=0 ; examples=19001, 19003, 19005

lat: numeric ; missing=0 ; examples=41.327, 41.033, 43.28

long: numeric ; missing=0 ; examples=-94.466, -94.702, -91.373

yield: integer ; missing=0 ; examples=36, 33, 42

corn: integer ; missing=0 ; examples=32, 30, 13

grain: integer ; missing=0 ; examples=16, 14, 15

untillable: integer ; missing=0 ; examples=19, 14, 44

fedval: integer ; missing=0 ; examples=93, 90, 66

stval: integer ; missing=0 ; examples=88, 89, 49
