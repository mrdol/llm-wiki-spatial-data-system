...
Details
     ...
     otherwise extremely difficult to find.  There may be alternate
     ways the actual Russian name is translated into German/English.
     ...
     12m tall, then field is 48m wide x 480m long.  If 4m tall 12m
     wide, then field is 144m wide x 160m long. This seems much more
     likely.
...
yield: integer ; missing=0 ; examples=359, 366, 344
