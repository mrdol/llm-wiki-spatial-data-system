...
Details
     ...
     acre.  The criteria in the example below are (1) total acres <
     200, (2) total labor < 10000, (3) crop rotation.
...
Source
     ...
     _Am. J. Agric. Econ._, 53, 53-62.  https://doi.org/10.2307/3180297

References

     Carlos Romero, Tahir Rehman. (2003).  _Multiple Criteria Analysis
     for Agricultural Decisions_. Elsevier.


Variables detected from installed object

year: factor ; missing=0 ; examples=y1, y2, y3

carrot: integer ; missing=0 ; examples=292, 179, 114

celery: integer ; missing=0 ; examples=-128, 560, 648

cucumber: integer ; missing=0 ; examples=420, 187, 366

pepper: integer ; missing=0 ; examples=579, 639, 379
