...
Format
     ...
     ‘date’ heading date (days from April 1)

Details

     These data are heading dates (days from April 1 to heading) of 25
     cock's foot _Dactylis glomerata_ varieties in trials at Hannover,
...
Source
     ...
     Methods for Nonlinear Mixed Models.  _Biometrics_, 55, 1120-1128.
     https://doi.org/10.1111/j.0006-341X.1999.01120.x


Variables detected from installed object

gen: factor ; missing=0 ; examples=G01, G03, G04

year: integer ; missing=0 ; examples=1990

date: numeric ; missing=0 ; examples=45.07, 41.58, 40.44
