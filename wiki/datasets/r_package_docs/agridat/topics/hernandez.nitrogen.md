...
Source
     ...
     economically optimum fertilizer rates, _Agronomy Journal_, 100,
...
loc: factor ; missing=0 ; examples=Faribault

rep: factor ; missing=0 ; examples=R1, R2, R3

nitro: numeric ; missing=0 ; examples=0

yield: numeric ; missing=0 ; examples=3.69685, 3.87813, 4.3887
