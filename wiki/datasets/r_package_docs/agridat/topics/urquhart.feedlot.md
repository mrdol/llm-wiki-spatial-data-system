...
Source
     ...
     N. Scott Urquhart (1982).  Adjustment in Covariance when One
     Factor Affects the Covariate Biometrics, 38, 651-660.  Table 4, p.
     659.  https://doi.org/10.2307/2530046
...
animal: integer ; missing=0 ; examples=1, 2, 3

herd: integer ; missing=0 ; examples=9

diet: factor ; missing=0 ; examples=Low

weight1: integer ; missing=0 ; examples=575, 605, 640

weight2: integer ; missing=0 ; examples=826, 816, 902
