...
Details
     ...
     Most genotypes are unreplicated, with some augmented genotypes.
     In each row, every 6th plot was variety 526 = 'Kite'.  Six other
...
Source
     ...
     Early Generation Variety Trials.  _Journal of the Royal
     Statistical Society. Series C (Applied Statistics)_, 38, 361-375.
...
gen: factor ; missing=0 ; examples=Kite

row: integer ; missing=0 ; examples=1

col: integer ; missing=0 ; examples=1, 2, 3

entry: integer ; missing=0 ; examples=1

yield: integer ; missing=2 ; examples=2652, 2691, 2770

weed: integer ; missing=0 ; examples=0
