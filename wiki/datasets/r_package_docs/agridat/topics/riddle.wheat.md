...
Format
     ...
     ‘row’ row (nested in column)

     ‘year’ year

     ‘yield’ yield, grams

     ‘col’ column (group of rows)
...
expt: factor ; missing=0 ; examples=Baart

strain: factor ; missing=0 ; examples=5037, 3061, 2725

rep: integer ; missing=0 ; examples=1

row: integer ; missing=0 ; examples=54, 44, 42

year: integer ; missing=0 ; examples=1939

yield: integer ; missing=0 ; examples=575, 500, 450

col: integer ; missing=0 ; examples=3, 1
