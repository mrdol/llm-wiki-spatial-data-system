...
Format
     ...
     ‘depth’ depth in soil (feet)

     ‘temp’ temperature (the units are "du Crest")
...
Source
     ...
     Johann Heinrich Lambert (1779), _Pyrometrie_.  Page 358.
...
month: integer ; missing=0 ; examples=1, 2, 3

depth: numeric ; missing=0 ; examples=0.25

temp: integer ; missing=0 ; examples=-84, -90, -29
