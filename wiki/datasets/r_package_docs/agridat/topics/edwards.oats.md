...
Format
     ...
     ‘eid’ Environment identification (factor)
...
eid: integer ; missing=0 ; examples=1

year: integer ; missing=0 ; examples=1997

loc: factor ; missing=0 ; examples=Ame

block: factor ; missing=0 ; examples=B1

gen: factor ; missing=0 ; examples=Belle, Brawn, Burton

yield: numeric ; missing=0 ; examples=151.1, 171.9, 158.9

testwt: numeric ; missing=0 ; examples=32, 33.3, 33.7
