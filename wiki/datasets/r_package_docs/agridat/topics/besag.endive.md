...
Source
     ...
     Data.  _Bulletin of the International Statistical Institute_, 47,
     77-92.

References

     N Friel & A. N Pettitt (2004). Likelihood Estimation and Inference
     for the Autologistic Model.  _Journal of Computational and
     Graphical Statistics_, 13:1, 232-246.
...
disease: factor ; missing=0 ; examples=Y, N
