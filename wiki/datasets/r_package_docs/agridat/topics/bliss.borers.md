...
Format
     ...
     ‘borers’ number of borers per hill

     ‘treat’ treatment factor

     ‘freq’ frequency of the borer count
...
Source
     ...
     Distribution to Biological Data.  _Biometrics_, 9, 176-200.  Table
     ...
     _Ecology_, 21, 460-474.  Page 463.
     https://doi.org/10.2307/1930285


Variables detected from installed object

borers: integer ; missing=0 ; examples=0, 1, 2

treat: factor ; missing=0 ; examples=T1

freq: integer ; missing=0 ; examples=19, 12, 18
