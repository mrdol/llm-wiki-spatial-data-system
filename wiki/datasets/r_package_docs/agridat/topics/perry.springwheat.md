...
Format
     ...
     ‘gen’ genotype/cultivar factor, 28 levels

     ‘env’ environment factor, 20 levels

     ‘site’ site factor

     ‘year’ year, 1979-1982

     ‘yor’ year of release, 1860-1982
...
yield: integer ; missing=14 ; examples=1708, 1409, 1589

gen: factor ; missing=0 ; examples=PurpleStraw883, PurpleStraw888, Steinwedel

env: factor ; missing=0 ; examples=E01

site: factor ; missing=0 ; examples=Avo

year: integer ; missing=0 ; examples=1979

yor: integer ; missing=0 ; examples=1863, 1866, 1884
