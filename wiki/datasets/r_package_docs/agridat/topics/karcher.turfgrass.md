...
Details
     ...
     replicates and four sampling weeks.  The eight treatments were in
...
week: integer ; missing=0 ; examples=1

rep: factor ; missing=0 ; examples=R1

manage: factor ; missing=0 ; examples=M1, M2

nitro: factor ; missing=0 ; examples=N1, N2

rating: factor ; missing=0 ; examples=Poor, Average

count: integer ; missing=0 ; examples=1, 2
