...
Format
     ...
     ‘age’ dam age factor, 9 levels

     ‘score’ score for birthing difficulty, S1 < S2 < S3

     ‘count’ count of births for each category
...
age: factor ; missing=0 ; examples=0.0-2.0, 2.0-2.5, 2.5-3.0

score: factor ; missing=0 ; examples=S1

count: integer ; missing=0 ; examples=7836, 16656, 9542
