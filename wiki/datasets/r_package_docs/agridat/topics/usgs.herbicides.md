...
mapnum: integer ; missing=0 ; examples=1

usgsid: integer ; missing=0 ; examples=5411850

long: numeric ; missing=0 ; examples=91.8088888888889

lat: numeric ; missing=0 ; examples=43.0541666666667

site: factor ; missing=0 ; examples=TurkeyRiver

city: factor ; missing=0 ; examples=Eldorado

sampletype: factor ; missing=0 ; examples=S1, CR, S2

date: factor ; missing=0 ; examples=5/14/2002, 6/24/2002

hour: integer ; missing=0 ; examples=1400, 1405, 950

acetochlor: factor ; missing=0 ; examples=0.27, 0.11

alachlor: factor ; missing=0 ; examples=<0.05, <.05

ametryn: factor ; missing=0 ; examples=<0.05, <.05

atrazine: factor ; missing=0 ; examples=1.1, 1, 4.3

CIAT: factor ; missing=0 ; examples=0.2, 0.18, 0.76

CEAT: factor ; missing=0 ; examples=0.06, 0.31

cyanazine: factor ; missing=0 ; examples=<0.05, <.05

CAM: factor ; missing=0 ; examples=<0.05, <.05

dimethenamid: factor ; missing=0 ; examples=0.11, 0.1, 0.21

flufenacet: factor ; missing=0 ; examples=<0.05, <.05
