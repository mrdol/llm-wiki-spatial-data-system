...
Format
     ...
     ‘gen’ genotype factor, 25 levels

     ‘rep’ rep factor, 6 levels

Details

     The trial was of spring wheat at Slate Hall Farm in 1978.  The
     experiment was a balanced lattice with 25 varieties in 6
     replicates.  The 'rep' labels are arbitrary (no rep labels
     appeared in the source data).  Each row within a rep is an
     incomplete block.  The plot size was 1.5 meters by 4 meters.
...
col: integer ; missing=0 ; examples=1, 10, 2

yield: integer ; missing=0 ; examples=2555, 2660, 2930

gen: factor ; missing=0 ; examples=G18, G07, G05

rep: factor ; missing=0 ; examples=R3, R6
