...
Multi-environment trial of barley, percent of leaves affected by leaf
blotch
...
Format
     ...
     ‘y’ Percent of leaf area affected, 0-100.

     ‘site’ Site factor, 9 levels

     ‘gen’ Variety factor, 10 levels

Details

     Incidence of _Rhynchosporium secalis_ (leaf blotch) on the leaves
...
References
     ...
     R. B. Millar.  _Maximum Likelihood Estimation and Inference: With
     Examples in R, SAS and ADMB_.  Chapter 8.


Variables detected from installed object

y: numeric ; missing=0 ; examples=0.05, 0

site: factor ; missing=0 ; examples=S1
