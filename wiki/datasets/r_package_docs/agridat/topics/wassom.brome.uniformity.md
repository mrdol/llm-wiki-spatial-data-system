...
Format
     ...
     ‘yield’ forage yield, pounds

Details

     Experiments were conducted at Ames, Iowa.  The response variable
     is forage yield in pounds of green weight.
...
expt: factor ; missing=0 ; examples=E1

row: integer ; missing=0 ; examples=1, 2, 3

col: integer ; missing=0 ; examples=1

yield: numeric ; missing=0 ; examples=4.3, 3.7, 3.4
