...
Details
     ...
     Transcription details: The tables in Wiedemann were converted by
     OCR to digital format, and all values were checked by K.Wright.
...
yield: integer ; missing=0 ; examples=132, 136, 165
