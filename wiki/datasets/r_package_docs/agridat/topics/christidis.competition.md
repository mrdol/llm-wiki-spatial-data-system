...
Source
     ...
     trials with cotton.  _The Journal of Agricultural Science_, 25,
...
plotrow: integer ; missing=0 ; examples=1, 2, 3
...
gen: factor ; missing=0 ; examples=Serres

yield: numeric ; missing=0 ; examples=14.94, 16.59, 17.32

height: integer ; missing=0 ; examples=62, 65, 68
