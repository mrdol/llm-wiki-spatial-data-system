...
Format
     ...
     ‘yield’ yield, pounds/acre

Details

     Ten years of uniformity trials were sown on the same ground.
     Baker (1952) shows a map of the field, in which gravel subsoil
     extended from the upper right corner diagonally lower-center.
     This part of the field had lower yields on the 10-year average
     map.
...
Source
     ...
     trial on unirrigated barley of ten years' duration.  _Agronomy
     Journal_, 44, 267-270.
...
year: integer ; missing=0 ; examples=1924

yield: integer ; missing=2 ; examples=2960, 3060, 3280
