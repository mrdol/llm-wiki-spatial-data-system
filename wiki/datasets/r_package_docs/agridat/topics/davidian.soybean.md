...
Source
     ...
     Marie Davidian and D. M. Giltinan, (1995).  _Nonlinear Models for
...
plot: factor ; missing=0 ; examples=1988F1

variety: factor ; missing=0 ; examples=F

year: integer ; missing=0 ; examples=1988

day: integer ; missing=0 ; examples=14, 21, 28

weight: numeric ; missing=0 ; examples=0.106, 0.261, 0.666
