...
References
     ...
     Populations. _Biometrics_, 22, 439-452.
     https://doi.org/10.2307/2528181


Variables detected from installed object

p1: factor ; missing=0 ; examples=C, L

p2: factor ; missing=0 ; examples=C, L

yield: numeric ; missing=0 ; examples=91.8, 87.6, 54.9
