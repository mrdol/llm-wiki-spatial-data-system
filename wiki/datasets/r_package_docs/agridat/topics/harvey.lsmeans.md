...
Format
     ...
     ‘line’ line of the dam

     ‘sire’ sire

     ‘damage’ age class of the dam

     ‘calf’ calf number

     ‘weanage’ calf age at weaning

     ‘weight’ calf weight at start of feeding
...
line: factor ; missing=0 ; examples=L1

sire: factor ; missing=0 ; examples=S1

damage: factor ; missing=0 ; examples=A3, A4

calf: factor ; missing=0 ; examples=C01, C02, C03

weanage: integer ; missing=0 ; examples=192, 154, 185

weight: integer ; missing=0 ; examples=390, 403, 432

adg: numeric ; missing=0 ; examples=2.24, 2.65, 2.41
