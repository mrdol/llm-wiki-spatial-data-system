...
Format
     ...
     ‘nitro’ nitrogen fertilizer, pound/acre
...
Source
     ...
     of Field Corn in Eastern Oregon.  _Soil Science Society of America
     Journal_, 19, 214-218.
...
nitro: integer ; missing=0 ; examples=0, 50, 100

year: integer ; missing=0 ; examples=1950

loc: factor ; missing=0 ; examples=Moeller

yield: numeric ; missing=0 ; examples=46.4, 85.2, 110.2
