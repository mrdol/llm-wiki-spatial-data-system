...
Details
     ...
     with a temperature _above_ 65 Fahrenheit.
...
References
     ...
     Kevin Wright. 2013.  Revisiting Immer's Barley Data.  _The
     American Statistitician_, 67, 129-133.
     https://doi.org/10.1080/00031305.2013.801783


Variables detected from installed object

site: factor ; missing=0 ; examples=Morris

year: integer ; missing=0 ; examples=1927

mo: integer ; missing=0 ; examples=1, 2, 3

cdd: integer ; missing=0 ; examples=0

hdd: integer ; missing=0 ; examples=1546, 1259, 993

precip: numeric ; missing=0 ; examples=0.78, 0.5, 2.62

min: numeric ; missing=0 ; examples=3.9, 11.3, 23.7

max: numeric ; missing=0 ; examples=23, 28.6, 42.1
