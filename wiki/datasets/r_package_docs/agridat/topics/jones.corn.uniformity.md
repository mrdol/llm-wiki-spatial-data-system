...
Details
     ...
     Electronic version provided as an online supplement.  The "row"
     and "col" variables in the supplement have been swapped for the
...
col: integer ; missing=0 ; examples=12, 11, 10

row: integer ; missing=0 ; examples=1

yield: numeric ; missing=0 ; examples=210.9, 262.8, 264.3
