...
Format
     ...
     ‘fert’ fertilizer treatment

     ‘block’ block

     ‘yield’ yield, tons/acres

     ‘plants’ number of plants per plot
...
Source
     ...
     George Snedecor (1946).  _Statisitcal Methods_, 4th ed. Table
     12.13, p. 332.

References

     H. Fairfield Smith (1957).  Interpretation of Adjusted Treatment
     Means and Regressions in Analysis of Covariance.  _Biometrics_,
     13, 282-308.  https://doi.org/10.2307/2527917


Variables detected from installed object

fert: factor ; missing=0 ; examples=None, P, K

block: factor ; missing=0 ; examples=B1

yield: numeric ; missing=0 ; examples=2.45, 6.71, 3.22

plants: integer ; missing=0 ; examples=183, 356, 224
