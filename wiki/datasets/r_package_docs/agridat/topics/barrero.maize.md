...
Format
     ...
     ‘year’ year of testing, 2000-2010

     ‘yor’ year of release, 2000-2010

     ‘loc’ location, 16 places in Texas

     ‘env’ environment (year+loc), 107 levels

     ‘rep’ replicate, 1-4

     ‘gen’ genotype, 847 levels

     ‘daystoflower’ numeric
     ...
     ‘lodged’ percent of plants lodged

     ‘moisture’ moisture percent

     ‘testweight’ test weight kg/ha
...
Source
     ...
     Barrero, Ivan D. et al. (2013).  A multi-environment trial
     analysis shows slight grain yield improvement in Texas commercial
     maize.  Field Crops Research, 149, Pages 167-176.
...
year: integer ; missing=0 ; examples=2000

yor: integer ; missing=716 ; examples=2000

loc: factor ; missing=0 ; examples=BA

env: factor ; missing=0 ; examples=2000BA

rep: factor ; missing=0 ; examples=R1, R2, R3

gen: factor ; missing=0 ; examples=9211

daystoflower: integer ; missing=1548 ; examples=78, 77

plantheight: numeric ; missing=645 ; examples=233.68, 236.22, 228.6

earheight: numeric ; missing=653 ; examples=83.82, 76.2, 78.74

population: numeric ; missing=511 ; examples=57407.4336, 61712.0027

lodged: integer ; missing=854 ; examples=0

moisture: numeric ; missing=222 ; examples=11.2, 10.7

testweight: numeric ; missing=369 ; examples=81.40275, 81.41562, 80.38602

yield: numeric ; missing=321 ; examples=9.791344564, 9.481664576, 8.690091928
