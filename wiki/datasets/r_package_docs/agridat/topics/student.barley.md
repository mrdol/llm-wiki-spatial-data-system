...
Format
     ...
     ‘place’ place (nearest town)

     ‘district’ district, geographical area

     ‘gen’ genotype, ‘Archer’ and ‘Goldthorpe’

     ‘yield’ yield, 'stones' per acre (1 stone = 14 pounds)

     ‘income’ income per acre in shillings, based on yield and quality
...
Details
     ...
     One stone is 14 pounds.  To convert lb/ac to tonnes/ha, multiply
     by 0.00112085116
     ...
     230 shillings.  A quick glance at Table I of Student shows that
     the maximum income for Goldthorpe is 220 shillings (11 pounds, 0
...
Source
     ...
     15, 271-293.  https://doi.org/10.1093/biomet/15.3-4.271

References

     R A Kempton and P N Fox, 1997.  _Statistical Methods for Plant
     Variety Evaluation_.


Variables detected from installed object

year: integer ; missing=0 ; examples=1901

farmer: factor ; missing=0 ; examples=McCarthy, Hawkins, Dwan

place: factor ; missing=0 ; examples=Ballinacurra, Whitegate, Thurles

district: factor ; missing=0 ; examples=Cork, CentralPlain

gen: factor ; missing=0 ; examples=Archer

yield: integer ; missing=0 ; examples=180, 163, 242

income: integer ; missing=0 ; examples=180, 163, 233
