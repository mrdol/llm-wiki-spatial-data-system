...
Format
     ...
     ‘year’ numeric 1980/1981

     ‘breed’ breed PP, BRP, BR

     ‘sex’ sex of lamb M/F

     ‘sire0’ sire ID according to Alwan

     ‘shape’ sire ID according to Gilmour

     ‘count’ number of lambs

     ‘sire’ shape of foot

     ‘yr’ numeric contrast for year

     ‘b1’ numeric contrast for breeds

     ‘b2’ numeric contrast for breeds

     ‘b3’ numeric contrast for breeds
...
References
     ...
     using a generalized linear mixed model.  Journal of Animal
     Breeding and Genetics, 104, 149-155.
...
year: integer ; missing=0 ; examples=1980

breed: factor ; missing=0 ; examples=PP

sex: factor ; missing=0 ; examples=F

sire0: factor ; missing=0 ; examples=S03

shape: factor ; missing=0 ; examples=LF5, LF4, LF3

count: integer ; missing=0 ; examples=31, 17, 0

sire: factor ; missing=0 ; examples=S01

yr: integer ; missing=0 ; examples=1

b1: integer ; missing=0 ; examples=1

b2: integer ; missing=0 ; examples=0

b3: integer ; missing=0 ; examples=0
