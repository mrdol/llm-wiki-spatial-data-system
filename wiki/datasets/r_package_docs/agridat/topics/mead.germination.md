...
References
     ...
     statistical models for the plant and soil sciences.  CRC.


Variables detected from installed object

temp: factor ; missing=0 ; examples=T1

rep: factor ; missing=0 ; examples=R1

conc: numeric ; missing=0 ; examples=0, 0.1, 1

germ: integer ; missing=0 ; examples=9, 13, 21

seeds: integer ; missing=0 ; examples=50
