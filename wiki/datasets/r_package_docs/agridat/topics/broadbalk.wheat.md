...
Format
     ...
     ‘grain’ grain yield, tonnes

     ‘straw’ straw yield, tonnes
...
year: integer ; missing=0 ; examples=1852

plot: factor ; missing=0 ; examples=P02, P03, P05

grain: numeric ; missing=0 ; examples=1.92, 0.97, 1.18

straw: numeric ; missing=0 ; examples=3.87, 1.78, 2.21
