...
Format
     ...
     ‘grain’ grain yield, pounds

     ‘straw’ straw yield, pounds
...
References
     ...
     Baker, G. A. (1941).  Fundamental Distribution of Errors for
     Agricultural Field Trials.  _National Mathematics Magazine_, 16,
...
row: integer ; missing=0 ; examples=20, 19, 18

col: integer ; missing=0 ; examples=1

grain: numeric ; missing=0 ; examples=3.63, 4.07, 4.51

straw: numeric ; missing=0 ; examples=6.37, 6.24, 7.05
