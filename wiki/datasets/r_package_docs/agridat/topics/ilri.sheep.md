...
References
     ...
     era of data-rich animal science.  Journal of Animal Science,
     Volume 99, Issue 2, February 2021, skaa402.
...
lamb: integer ; missing=0 ; examples=627, 629, 635

sex: factor ; missing=0 ; examples=M, F

gen: factor ; missing=0 ; examples=DD

birthwt: numeric ; missing=0 ; examples=2.7, 2.9, 2.5

weanwt: numeric ; missing=182 ; examples=16.3, 18.4, 14.7

weanage: integer ; missing=175 ; examples=125, 112, 109

ewe: integer ; missing=0 ; examples=1682, 1082, 1520

ewegen: factor ; missing=0 ; examples=D

damage: integer ; missing=0 ; examples=2, 5

ram: integer ; missing=0 ; examples=1980, 4908, 1974

ramgen: factor ; missing=0 ; examples=D
