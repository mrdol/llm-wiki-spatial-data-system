...
Format
     ...
     ‘trt’ nitrogen treatment factor

     ‘nitro’ soil nitrogen content, percent

     ‘rep’ replicate

     ‘stage’ growth stage, three periods
...
References
     ...
     R-help mailing list, 9 May 2013.  Data provided by Cyril
     Lundrigan.  Analysis method by Rich Heiberger.
...
nitro: numeric ; missing=0 ; examples=3.26, 3.84, 3.5

rep: factor ; missing=0 ; examples=R1

stage: factor ; missing=0 ; examples=P1
