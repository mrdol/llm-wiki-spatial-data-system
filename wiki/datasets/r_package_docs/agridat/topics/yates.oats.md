...
Format
     ...
     ‘yield’ yield in 1/4 pounds per sub-plot, each 1/80 acre
     ...
     ‘grain’ grain weight in pounds per sub-plot

     ‘straw’ straw weight in pounds per sub-plot
...
row: integer ; missing=0 ; examples=16, 12, 3

col: integer ; missing=0 ; examples=3, 4

yield: integer ; missing=0 ; examples=80, 60, 89

nitro: numeric ; missing=0 ; examples=0

gen: factor ; missing=0 ; examples=GoldenRain

block: factor ; missing=0 ; examples=B1, B2, B3

grain: numeric ; missing=0 ; examples=20, 15, 22.25

straw: numeric ; missing=0 ; examples=28, 25, 40.5
