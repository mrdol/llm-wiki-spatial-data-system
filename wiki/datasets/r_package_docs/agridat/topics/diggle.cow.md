...
Source
     ...
     Diggle, P. J., Liang, K.-Y., & Zeger, S. L. (1994).  _Analysis of
     Longitudinal Data_. Page 100-101.
...
animal: factor ; missing=0 ; examples=A01

iron: factor ; missing=0 ; examples=NoIron

infect: factor ; missing=0 ; examples=NonInfected

weight: integer ; missing=1 ; examples=110, 135, 150

day: integer ; missing=0 ; examples=122, 150, 166
