...
Format
     ...
     ‘nitro’ nitrogen, 4 levels

     ‘cowpea’ cowpea variety, 2 levels

     ‘maize’ maize variety, 3 levels

     ‘cyield’ cowpea yield, kg/ha

     ‘myield’ maize yield, kg/ha
...
nitro: factor ; missing=0 ; examples=N0, N1, N2

cowpea: factor ; missing=0 ; examples=C1

maize: factor ; missing=0 ; examples=M1

cyield: integer ; missing=0 ; examples=259, 614, 355

myield: integer ; missing=0 ; examples=2121, 3055, 3922
