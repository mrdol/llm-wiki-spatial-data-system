...
Details
     ...
     unsprayed control.  On 30 Sep 1990, disease incidence was
     measured.  For each plot, 5 randomly chosen shoots on each of the
     3 vines were observed.  The canopy was closed and shoots could be
...
trt: factor ; missing=0 ; examples=T1, T2, T3

vine: factor ; missing=0 ; examples=V1

shoot: factor ; missing=0 ; examples=S1

diseased: integer ; missing=0 ; examples=1, 2, 0

total: integer ; missing=0 ; examples=14, 12
