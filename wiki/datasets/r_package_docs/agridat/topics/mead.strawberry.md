...
References
     ...
     R. Mead, 1990, _The Design of Experiments_.

     Julian Besag and D Higdon, 1999.  Bayesian Analysis of
     Agricultural Field Experiments, _Journal of the Royal Statistical
     Society: Series B (Statistical Methodology)_,61, 691-746. Table 4.
...
block: factor ; missing=0 ; examples=B3

gen: factor ; missing=0 ; examples=E, Re, M

yield: numeric ; missing=0 ; examples=7.5, 7, 6.1
