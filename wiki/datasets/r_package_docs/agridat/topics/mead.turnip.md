...
Format
     ...
     ‘yield’ log yield (pounds/plot)

     ‘block’ block

     ‘spacing’ row spacing, inches

     ‘density’ density of seeds, pounds/acre
...
Source
     ...
     Roger Mead. (1988).  _The Design of Experiments: Statistical
     Principles for Practical Applications_.  Example 12.3. Page 323.
...
yield: numeric ; missing=0 ; examples=0, 1.39, 2.4

block: factor ; missing=0 ; examples=B1

spacing: integer ; missing=0 ; examples=4

density: numeric ; missing=0 ; examples=0.5, 2, 8
