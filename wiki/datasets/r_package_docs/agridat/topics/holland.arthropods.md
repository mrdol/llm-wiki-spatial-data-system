...
Format
     ...
     ‘n.brevicollis’ species counts

     ‘linyphiidae’ species counts

     ‘collembola’ species counts

     ‘carabidae’ species counts

     ‘lycosidae’ species counts

     ‘weedcover’ percent weed cover
...
n.brevicollis: integer ; missing=0 ; examples=6, 3

linyphiidae: integer ; missing=0 ; examples=67, 114, 59

collembola: integer ; missing=0 ; examples=85, 30, 56

carabidae: integer ; missing=0 ; examples=35, 24, 18

lycosidae: integer ; missing=0 ; examples=13, 22, 20

weedcover: integer ; missing=0 ; examples=42, 23, 17
