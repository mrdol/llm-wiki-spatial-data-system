...
Source
     ...
     and its practical applications.  _Annals of Applied Biology_, 100,
     229-244.  Table 2.
...
References
     ...
     James William Hardin, Joseph M. Hilbe.  _Generalized Linear Models
     and Extensions_, 2nd ed.

     F Famoye (1995). Generalized Binomial Regression.  _Biom J_, 37,
     581-594.


Variables detected from installed object

treatment: factor ; missing=0 ; examples=T01, T02, T03

insecticide: factor ; missing=0 ; examples=diazinon

depth: numeric ; missing=6 ; examples=1, 2.5, 5

rep: factor ; missing=0 ; examples=R1

damaged: integer ; missing=0 ; examples=120, 60, 35

total: integer ; missing=0 ; examples=187, 184, 179
