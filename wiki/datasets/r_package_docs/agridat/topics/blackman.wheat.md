...
Details
     ...
     was _lower_ for the high-nitrogen treatment.  Blackman et al. say
...
Source
     ...
     application of nitrogen fertilizer.  _The Journal of Agricultural
     Science_, 90, 543-550.  https://doi.org/10.1017/S0021859600056070

References

     Gower, J. and Lubbe, S.G. and Gardner, S. and Le Roux, N. (2011).
     _Understanding Biplots_, Wiley.


Variables detected from installed object

gen: factor ; missing=0 ; examples=Cap

loc: factor ; missing=0 ; examples=Cra, Beg

nitro: factor ; missing=0 ; examples=L, H

yield: integer ; missing=0 ; examples=321, 411, 317

type: factor ; missing=0 ; examples=conv
