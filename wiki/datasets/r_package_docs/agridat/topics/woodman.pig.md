...
pen: factor ; missing=0 ; examples=P1

treatment: factor ; missing=0 ; examples=A, B, C

pig: integer ; missing=0 ; examples=993, 989, 987

sex: factor ; missing=0 ; examples=F

weight1: numeric ; missing=0 ; examples=48.5, 48

weight2: numeric ; missing=0 ; examples=204.5, 205.5, 203.4

feed: numeric ; missing=0 ; examples=542.15, 552.3, 549.15

w0: integer ; missing=0 ; examples=48

g: numeric ; missing=0 ; examples=9.94, 10, 9.75

h: numeric ; missing=0 ; examples=0.199, 0.146, 0.136
