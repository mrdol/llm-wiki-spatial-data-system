...
Format
     ...
     ‘trt’ fertilizer treatment with 9 levels

     ‘grain’ grain, pounds per plot

     ‘straw’ straw, pounds per plot
...
Details
     ...
     Early/late application.  S/M = Sulphate or muriate of ammonia.
...
block: factor ; missing=0 ; examples=x

trt: factor ; missing=0 ; examples=oa, 2me, 2sl

grain: numeric ; missing=0 ; examples=61.375, 68.75, 64.25

straw: numeric ; missing=0 ; examples=83, 130, 100

row: integer ; missing=0 ; examples=12
