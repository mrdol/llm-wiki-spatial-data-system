...
Details
     ...
     effect, and the 9 treatments (spacings * seedlings) are completely
     randomized withing the sub-plot effect.

Source

     Chakravertti, S. C. and S. S. Bose and P. C. Mahalanobis (1936).
     A complex experiment on rice at the Chinsurah farm, Bengal,
     1933-34.  The Indian Journal of Agricultural Science, 6, 34-51.
...
yield: numeric ; missing=0 ; examples=264, 211, 296

date: factor ; missing=0 ; examples=S01

gen: factor ; missing=0 ; examples=Nehara

treat: factor ; missing=0 ; examples=d, f, e

seeds: factor ; missing=0 ; examples=2

spacing: integer ; missing=0 ; examples=6, 12, 9
