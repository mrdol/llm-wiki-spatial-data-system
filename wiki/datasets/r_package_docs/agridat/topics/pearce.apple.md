...
pearce.apple: Apple tree yields for 6 treatments with covariate
...
Format
     ...
     ‘trt’ treatment factor, 6 levels

     ‘prev’ previous yield in boxes
...
Source
     ...
     S. C. Pearce (1953).  _Field Experiments With Fruit Trees and
     Other Perennial Plants_.  Commonwealth Bureau of Horticulture and
...
References
     ...
     Analysis of Covariance in Designed Experiments.  _Statistical
     Science_, 24, 223-237.
...
trt: factor ; missing=0 ; examples=A, B, C

prev: numeric ; missing=0 ; examples=8.2, 6.8

yield: integer ; missing=0 ; examples=287, 271, 234
