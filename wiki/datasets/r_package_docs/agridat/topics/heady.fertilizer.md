...
Format
     ...
     ‘P’ phosphorous, pounds/acre

     ‘K’ potassium, pounds/acre

     ‘N’ nitrogen, pounds/acre
...
Details
     ...
     Clover and alfalfa yields are in tons/acre.  The clover and
     alfalfa experiments were grown in 1952.
...
References
     ...
     grade of fertilizer for alfalfa.  _Soil Science Society of America
     Journal_, 20, 240-246.
...
crop: factor ; missing=0 ; examples=corn

rep: integer ; missing=0 ; examples=1, 2

P: integer ; missing=0 ; examples=0, 40

K: integer ; missing=0 ; examples=0

N: integer ; missing=0 ; examples=0

yield: numeric ; missing=192 ; examples=24.5, 6.2, 26.7
