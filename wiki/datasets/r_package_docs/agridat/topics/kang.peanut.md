...
Format
     ...
     ‘rep’ replicate factor, 4 levels

     ‘yield’ yield

     ‘env’ environment factor, 15 levels
...
References
     ...
     are Standardized.  _JABES_
     https://doi.org/10.1007/s13253-019-00355-5


Variables detected from installed object

gen: factor ; missing=0 ; examples=Florman

rep: factor ; missing=0 ; examples=R1, R2, R3

yield: numeric ; missing=0 ; examples=0.5218, 0.5923, 0.7686
