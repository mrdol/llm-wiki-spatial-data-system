...
Format
     ...
     ‘time’ time factor, T1-T4

     ‘manage’ management, M1-M6

     ‘rep’ rep/block, R1-R3

     ‘sample’ subsample, S1-S2
...
time: factor ; missing=0 ; examples=T1

manage: factor ; missing=0 ; examples=M1, M2, M3

rep: factor ; missing=0 ; examples=R1

sample: factor ; missing=0 ; examples=S1

height: numeric ; missing=0 ; examples=104.5, 92.3, 96.8
