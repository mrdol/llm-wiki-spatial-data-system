...
Format
     ...
     ‘date’ planting date, levels ‘21Aug1990’ ‘28Aug1990’

     ‘density’ planting density, 1, 2, 4, 8 kg/ha
...
gen: factor ; missing=0 ; examples=Barkant

date: factor ; missing=0 ; examples=21Aug1990

density: integer ; missing=0 ; examples=1

block: factor ; missing=0 ; examples=B1, B2, B3

yield: numeric ; missing=0 ; examples=2.7, 1.4, 1.2
