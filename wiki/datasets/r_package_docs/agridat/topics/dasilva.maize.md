...
Details
     ...
     In DaSilva Table 1, the mean of E1 is 10.803.  This appears to be
     a copy of the mean from row 1 of Table 1 in Machado. Using the
...
yield: numeric ; missing=0 ; examples=7.9107, 6.4057, 5.8616
