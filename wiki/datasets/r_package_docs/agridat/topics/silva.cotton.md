...
References
     ...
     of experimental underdispersed data.  _Journal of Applied
     Statistics_, 41(12), 1-11.
...
stage: factor ; missing=0 ; examples=vegetative

defoliation: integer ; missing=0 ; examples=0

plant: integer ; missing=0 ; examples=1

rep: factor ; missing=0 ; examples=R1, R2, R3

reproductive: integer ; missing=0 ; examples=5, 4

bolls: integer ; missing=0 ; examples=5, 4

height: numeric ; missing=0 ; examples=73, 63, 65.5

nodes: integer ; missing=0 ; examples=16, 17, 14

weight: numeric ; missing=125 ; examples=33.16, 28.675, 31.485
