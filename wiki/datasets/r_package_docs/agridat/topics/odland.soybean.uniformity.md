...
Format
     ...
     ‘yield’ yield: hay in tons/acre, beans in bushels/acre
...
Details
     ...
     8-foot plats were recorded.  In 1926, data for the last row on
     page 96 seems to be missing.
...
Source
     ...
     Replications in Field Experiments with Soybeans.  Agronomy
     Journal, 20, 93-108.
...
yield: integer ; missing=27 ; examples=22, 25, 21
