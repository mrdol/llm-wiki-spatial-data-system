...
Details
     ...
     doses (0, 1.1, 2.2, 4.5) in 3 reps.  Experiment was done in 1986
     at Manti, Utah.
...
Source
     ...
     _Weed Technology_, 6, 424-430.
     https://www.jstor.org/stable/3987312

References

     Christopher Bilder, Thomas Loughin.  _Analysis of Categorical Data
     with R_.
...
rate: numeric ; missing=0 ; examples=0, 1.1, 2.2

live: integer ; missing=0 ; examples=18, 24, 29

dead: integer ; missing=0 ; examples=0, 13, 28
