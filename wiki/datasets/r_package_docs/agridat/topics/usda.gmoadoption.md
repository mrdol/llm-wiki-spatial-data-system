...
Description
     ...
     Adoption of genetically modified crops in the U.S. from 1996 to
     2022.
...
Format
     ...
     ‘percent’ Percent of planted acres

Details

     HT indicates herbicide-tolerant crops.  Bt indicates
     insect-resistant (Bacillus thuringiensis) crops.  The "percent"
     column is the percentage of planted acres for each crop that were
     genetically modified.  HT/Bt for corn and cotton are not mutually
     exclusive categories. For example, as time progressed corn hybrids
     tended to be both HT and Bt.
...
crop: factor ; missing=0 ; examples=HT corn, Bt corn, Bt cotton

percent: numeric ; missing=0 ; examples=3, 1.4, 14.6
