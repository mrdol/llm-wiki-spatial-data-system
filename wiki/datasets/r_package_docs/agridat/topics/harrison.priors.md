...
Format
     ...
     ‘substance’ Analyte substance

     ‘min’ minimum amount (numeric)

     ‘max’ maximum analyte amount (numeric)

     ‘number’ number of substances
...
Source
     ...
     informative prior distributions.  _Regulatory Toxicology and
     Pharmacology_, 65, 251-258.
...
References
     ...
     composition _Proceedings of the 24th Conference on Applied
     Statistics in Agriculture (2012)_.


Variables detected from installed object

source: factor ; missing=0 ; examples=Hutabarat, Primomo, Morrison

substance: factor ; missing=0 ; examples=daidzein

min: numeric ; missing=0 ; examples=343, 434, 696

max: numeric ; missing=0 ; examples=1400, 696, 1230

number: integer ; missing=0 ; examples=4, 7, 14
