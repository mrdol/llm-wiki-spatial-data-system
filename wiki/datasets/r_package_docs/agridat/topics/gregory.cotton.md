...
Format
     ...
     ‘spacing’ spacing between plants
...
Source
     ...
     under irrigation in the Sudan.  _The Journal of Agricultural
     Science_, 22, 617-638. Table 1, 10.
...
yield: numeric ; missing=0 ; examples=0.99, 1.34, 1.26

year: factor ; missing=0 ; examples=Y1

nitrogen: factor ; missing=0 ; examples=N0

date: factor ; missing=0 ; examples=D1

water: factor ; missing=0 ; examples=I1

spacing: factor ; missing=0 ; examples=S1, S2, S3
