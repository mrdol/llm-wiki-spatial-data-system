...
Description
     ...
     Fractional factorial of rice, 1/2 2^6 = 2x2x2x2x2x2.  Two reps
...
yield: numeric ; missing=0 ; examples=3.68, 3.52, 3.89

rep: factor ; missing=0 ; examples=R1

block: factor ; missing=0 ; examples=B1

trt: factor ; missing=0 ; examples=cd, af, abcd

col: integer ; missing=0 ; examples=1

row: integer ; missing=0 ; examples=8, 7, 6

a: integer ; missing=0 ; examples=1, 0

b: integer ; missing=0 ; examples=1, 0

c: integer ; missing=0 ; examples=0, 1

d: integer ; missing=0 ; examples=0, 1

e: integer ; missing=0 ; examples=1

f: integer ; missing=0 ; examples=1, 0
