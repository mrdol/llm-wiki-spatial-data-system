...
Format
     ...
     ‘wet’ wet yield, kg/plot

     ‘dry’ dry yield, kg/plot
...
Source
     ...
     useful, _Experimental Agriculture_, 17, 243-256.
...
gen: factor ; missing=0 ; examples=F, A, D

wet: numeric ; missing=0 ; examples=3.8, 5.2, 3

dry: numeric ; missing=0 ; examples=2.3, 3.3, 1.8
