...
Format
     ...
     ‘rate’ seeding rate, kg/ha

     ‘nitro’ nitrogen rate, kw/ha

     ‘regulator’ growth regulator, 3 levels
...
Source
     ...
     231-251. Table 2.  https://doi.org/10.2307/2531047
...
yield: integer ; missing=0 ; examples=478, 595, 499

row: integer ; missing=0 ; examples=1

col: integer ; missing=0 ; examples=1, 2, 3

gen: factor ; missing=0 ; examples=Torrs, Newton

rate: integer ; missing=0 ; examples=150, 125

nitro: integer ; missing=0 ; examples=150, 100

regulator: factor ; missing=0 ; examples=Cycocel
