...
Details
     ...
     feet) * (22.5 faden * 7 feet) * 416 plots = 609991 sq feet = 5.68
     hectares, which matches the experiment description.
...
yield: integer ; missing=0 ; examples=489, 506, 533
