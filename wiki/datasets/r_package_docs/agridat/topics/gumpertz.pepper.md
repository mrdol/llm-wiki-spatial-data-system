...
Format
     ...
     ‘field’ field factor, 2 levels

     ‘row’ x ordinate

     ‘quadrat’ y ordinate

     ‘disease’ presence (Y) or absence (N) of disease

     ‘water’ soil moisture percent

     ‘leaf’ leaf assay count
...
Details
     ...
     colonized out of five.  In field 2, the pattern of disease
     presence appears to follow soil water content.  In field 1, no
     obvious trends were present.
...
quadrat: integer ; missing=0 ; examples=1, 2, 3

disease: factor ; missing=0 ; examples=N

water: numeric ; missing=9 ; examples=15.05, 14.32, 13.99

leaf: integer ; missing=0 ; examples=5, 2, 3
