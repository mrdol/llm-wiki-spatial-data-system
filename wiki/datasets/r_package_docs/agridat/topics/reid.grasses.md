...
Format
     ...
     ‘nitro’ nitrogen, 21 numeric levels

     ‘year’ Y1, Y2, or Y3

     ‘gen’ genotype

     ‘drymatter’ dry matter content
...
Source
     ...
     grasses to a wide range of nitrogen application rates.  _J. Agric.
     Sci._, 105, 381-387. Table 1 & 3.
...
nitro: integer ; missing=0 ; examples=0, 28, 56

year: factor ; missing=0 ; examples=Y1

gen: factor ; missing=0 ; examples=S.24

drymatter: numeric ; missing=0 ; examples=1.58, 2.71, 4.14

protein: integer ; missing=0 ; examples=139, 242, 397
