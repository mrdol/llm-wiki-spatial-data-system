...
Description
     ...
     This data set gives the abundance of 32 mollusk species in 163
     samples.  For each sample, 4 informations are known : the sampling
     sites, the seasons, the sampler types and the time of exposure.
...
Format
     ...
     fau is a data frame with 163 samples and 32 mollusk species
          (abundance).
...
Source
     ...
     Methodological approach.  _Archiv fùr Hydrobiologie_, *107*,
     363-383.
