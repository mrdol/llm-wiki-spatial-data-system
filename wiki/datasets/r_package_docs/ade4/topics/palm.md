...
Description
     ...
     This data set describes the phylogeny of 66 amazonian palm trees.
     It also gives 7 traits corresponding to these 66 species.
...
Format
     ...
     traits is a data frame with 66 species (rows) and 7 traits
          (columns).
...
Details
     ...
     ‘sout : subterranean’, ‘ d1(0, 5 cm)’, ‘ d2(5, 15 cm)’, ‘ d3(15,
     30 cm)’ and ‘ d4(30, 100 cm)’
