...
Description
     ...
     This data set gives the repartition in diameter classes of deposit
     samples.
...
Format
     ...
     tab contains the 49 deposit samples, 9 diameter classes, weight of
          grains by size class

     born contains the boundaries of the diameter classes

Source

     Gaschignard-Fossati, O. (1986) _Répartition spatiale des
     macroinvertébrés benthiques d'un bras vif du Rhône. Rôle des crues
     et dynamique saisonnière._ Thèse de doctorat, Université Lyon 1.
