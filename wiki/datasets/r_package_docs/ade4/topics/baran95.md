...
Format
     ...
     plan is a data frame 2 factors : date and site. The ‘date’ has 6
          levels (april 1993, june 1993, august 1993, october 1993,
          december 1993 and february 1994) and the ‘sites’ are defined
          by 4 distances to the Atlantic Ocean (km03, km17, km33 and
          km46).
...
Source
     ...
     Poissons estuariens en Guinée (Afrique de l'Ouest)_. Thèse de
     Doctorat, Université de Bretagne Occidentale.  Data collected by
     net fishing sampling in the Fatala river estuary.

References

     See a data description at
     <http://pbil.univ-lyon1.fr/R/pdf/pps027.pdf> (in French).
