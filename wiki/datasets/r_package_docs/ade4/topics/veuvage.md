...
Description
     ...
     Economical Studies).  It is an array of widower percentages in
     relation with the age and the socioprofessional category.
...
Format
     ...
     tab is a data frame with 37 rows (widowers) 6 columns
