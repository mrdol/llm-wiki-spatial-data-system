...
Description
     ...
     This data set gives the road distances between 13 towns in
     New-Zealand.
...
Format
     ...
     road a data frame with 13 rows (New Zealand towns) and 13 columns
          (New Zealand towns) containing the road distances between
          these towns
