...
Description
     ...
     Bauwens and Díaz-Uriarte (1997).  It also gives life-history
     traits corresponding to these 18 species.
...
Format
     ...
     hprA is a character string giving the phylogenetic tree
          (hypothesized phylogenetic relationships based on
          immunological distances) in Newick format.

     hprB is a character string giving the phylogenetic tree
          (hypothesized phylogenetic relationships based on
...
References
     ...
     <http://pbil.univ-lyon1.fr/R/pdf/pps063.pdf> (in French).
