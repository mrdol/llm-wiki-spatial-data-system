...
Description
     ...
     This data set describes the taxonomy of 39 carnivora. It also
     gives life-history traits corresponding to these 39 species.
...
Details
     ...
     Variables of ‘pap$tab’ are the following ones : genre (genus with
     30 levels), famille (family with 6 levels), superfamille
     (superfamily with 2 levels).
     Variables of ‘pap$tab’ are Group Size, Body Weight, Brain Weight,
     Litter Size.
