...
Description
     ...
     This data set coleo (coleoptera) is a a fuzzy biological traits
     table.
...
Format
     ...
     tab is a data frame with 110 rows (species) and 32 columns
          (categories).
     ...
     col.blocks is a vector containing the number of categories of each
          trait.

Source

     Bournaud, M., Richoux, P. and Usseglio-Polatera, P. (1992) An
     approach to the synthesis of qualitative ecological information
     from aquatic coleoptera communities. _Regulated rivers: Research
     and Management_, *7*, 165-180.
