...
Description
     ...
     This data set gives the average temperatures of 30 French cities
     during 12 months.
...
Format
     ...
     temp a data frame with 30 rows (cities) and 12 columns (months).
          Each column contains the average temperature in tenth of
          degree Celsius.

     contour a data frame with 4 columns (x1, y1, x2, y2) for the
...
Source
     ...
     Besse, P. (1979) _Etude descriptive d'un processus; approximation,
     interpolation_. Thèse de troisième cycle, Université Paul
     Sabatier, Toulouse.
