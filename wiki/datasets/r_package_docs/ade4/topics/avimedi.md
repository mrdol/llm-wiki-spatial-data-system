...
Description
     ...
     frequencies of 51 bird species ; two factors (habitats and
...
Format
     ...
     plan is a data frame 302 sites - 2 factors : ‘reg’ with two levels
          Provence (‘Pr’, South of France) and Corsica (‘Co’) ; ‘str’
          with six levels describing the vegetation from a very low
          matorral (1) up to a mature forest of holm oaks (6).
...
Source
     ...
     mediterranean island habitats. _Ecology_, *69*, 1899-1917.
