...
Format
     ...
     tab a data frame with 160 rows (quadrats) and 7 variables
          (species)

     xy a data frame with the coordinates of the 160 quadrats
          (positioned by their centers)

     area a data frame with 3 variables returning the boundary lines of
          each quadrat. The first variable is a factor. The levels of
          this one are the row.names of ‘tab’. The second and third
...
Details
     ...
     _Parahancornia fasciculata_, _Virola michelii_, and _Pourouma
     spp_.
...
References
     ...
     Guyane : impact de la dissémination des graines sur la
     régénération forestière. Thèse de troisième cycle, Université de
     Tours.

     Julliot, C. (1997). Impact of seed dispersal by red howler monkeys
     _Alouatta seniculus_ on the seedling population in the understorey
     of tropical rain forest. _Journal of Ecology_, *85*, 431-440.
