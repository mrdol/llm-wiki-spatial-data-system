...
Description
     ...
     This data set contains information about spatial distribution of
     bird species in a zone surrounding the river Rhône near Lyon
     (France).
...
Format
     ...
     spe.names.fr a vector of strings of character with the species
          names in french
...
Source
     ...
     Bournaud, M., Amoros, C., Chessel, D., Coulet, M., Doledec, S.,
     Michelot, J.L., Pautou, G., Rostan, J.C., Tachet, H. and
     Thioulouse, J. (1990). _Peuplements d'oiseaux et propriétés des
     écocomplexes de la plaine du Rhône : descripteurs de
     fonctionnement global et gestion des berges._ Rapport programme
     S.R.E.T.I.E., Ministère de l'Environnement CORA et URA CNRS 367,
     Univ. Lyon I.
...
References
     ...
     *2*, 1-14.
     ...
     <http://pbil.univ-lyon1.fr/R/pdf/pps051.pdf> (in French).
