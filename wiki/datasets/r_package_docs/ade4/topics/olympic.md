...
Format
     ...
     tab is a data frame with 33 rows and 10 columns events of the
          decathlon: 100 meters (100), long jump (long), shotput
          (poid), high jump (haut), 400 meters (400), 110-meter hurdles
          (110), discus throw (disq), pole vault (perc), javelin (jave)
          and 1500 meters (1500).
...
Source
     ...
     (1994) _A handbook of small data sets_, Chapman & Hall, London.
     458 p.

     Lunn, A. D. and McNeil, D.R. (1991) _Computer-Interactive Data
     Analysis_, Wiley, New York
