...
Description
     ...
     This data set contains information about sites, environmental
     variables and Ephemeroptera Species.
...
Format
     ...
     env is a data frame with 24 sites and 10 physicochemical
          variables.

     spe is a data frame with 24 sites and 13 Ephemeroptera Species.
...
Details
     ...
     Data set equivalents to ‘meaudret’, except that one site (6) along
     the Bourne (a Meaudret affluent) and one physico chemical variable
     - the oxygen concentration were added.

Source

     Pegaz-Maucet, D. (1980) _Impact d'une perturbation d'origine
     organique sur la dérive des macro-invertébrés benthiques d'un
     cours d'eau. Comparaison avec le benthos_. Thèse de 3ème cycle,
     Université Lyon 1, 130 p.

     Thioulouse, J., Simier, M. and Chessel, D. (2004) Simultaneous
     analysis of a sequence of paired ecological tables. _Ecology_,
     *85*, 1, 272-283.
