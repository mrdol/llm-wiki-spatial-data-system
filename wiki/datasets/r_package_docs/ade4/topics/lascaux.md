...
Source
     ...
     Lascaux, J.M. (1996) _Analyse de la variabilité morphologique de
     la truite commune (Salmo trutta L.) dans les cours d'eau du bassin
     pyrénéen méditerranéen_. Thèse de doctorat en sciences
     agronomiques, INP Toulouse.

References

     See a data description at
     <http://pbil.univ-lyon1.fr/R/pdf/pps022.pdf> (in French).
