...
Format
     ...
     phychi a data frame with 92 sites and 12 physico-chemical
          variables
     ...
     Spatial an object of the class ‘SpatialLines’ of ‘sp’, containing
          the map
...
References
     ...
     <http://pbil.univ-lyon1.fr/R/pdf/pps047.pdf> (in French).
