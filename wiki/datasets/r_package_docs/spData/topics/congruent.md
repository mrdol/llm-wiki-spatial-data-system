...
Description
     ...
     zones from UK statistical agencies
...
Format
     ...
     Simple feature geographic data in a projected CRS (OSGB) with
     random values assigned for teaching purposes.
...
level: character ; missing=0 ; examples=Congruent

value: numeric ; missing=0 ; examples=5.06093395738106, 4.88727349501007, 4.96836517148417
