...
Sat: ordered/factor ; missing=0 ; examples=Low, Medium, High

Infl: factor ; missing=0 ; examples=Low

Type: factor ; missing=0 ; examples=Tower

Cont: factor ; missing=0 ; examples=Low

Freq: integer ; missing=0 ; examples=21, 28
