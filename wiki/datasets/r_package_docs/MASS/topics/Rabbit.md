...
BPchange: numeric ; missing=0 ; examples=0.5, 4.5, 10

Dose: numeric ; missing=0 ; examples=6.25, 12.5, 25

Run: factor ; missing=0 ; examples=C1

Treatment: factor ; missing=0 ; examples=Control

Animal: factor ; missing=0 ; examples=R1
