...
ID: integer ; missing=0 ; examples=1

Age: integer ; missing=0 ; examples=30

OME: factor ; missing=0 ; examples=low

Loud: integer ; missing=0 ; examples=35, 40

Noise: factor ; missing=0 ; examples=coherent, incoherent

Correct: integer ; missing=0 ; examples=1, 4, 0

Trials: integer ; missing=0 ; examples=4, 5, 3
