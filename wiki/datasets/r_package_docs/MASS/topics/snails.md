...
Species: factor ; missing=0 ; examples=A

Exposure: integer ; missing=0 ; examples=1

Rel.Hum: numeric ; missing=0 ; examples=60

Temp: integer ; missing=0 ; examples=10, 15, 20

Deaths: integer ; missing=0 ; examples=0

N: integer ; missing=0 ; examples=20
