...
y: factor ; missing=0 ; examples=y

ap: factor ; missing=0 ; examples=p

hilo: factor ; missing=0 ; examples=hi

week: integer ; missing=0 ; examples=0, 2, 4

ID: factor ; missing=0 ; examples=X01
