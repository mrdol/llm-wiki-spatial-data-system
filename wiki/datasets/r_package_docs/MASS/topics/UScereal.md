...
mfr: factor ; missing=0 ; examples=N, K

calories: numeric ; missing=0 ; examples=212.12121, 100

protein: numeric ; missing=0 ; examples=12.1212121, 8

fat: numeric ; missing=0 ; examples=3.030303, 0

sodium: numeric ; missing=0 ; examples=393.93939, 787.87879, 280

fibre: numeric ; missing=0 ; examples=30.30303, 27.272727, 28

carbo: numeric ; missing=0 ; examples=15.15152, 21.21212, 16

sugars: numeric ; missing=0 ; examples=18.181818, 15.151515, 0

shelf: integer ; missing=0 ; examples=3

potassium: numeric ; missing=0 ; examples=848.48485, 969.69697, 660

vitamins: factor ; missing=0 ; examples=enriched
