...
y: numeric ; missing=0 ; examples=5, 3

trt: factor ; missing=0 ; examples=placebo

base: integer ; missing=0 ; examples=11

age: integer ; missing=0 ; examples=31

V4: integer ; missing=0 ; examples=0

subject: integer ; missing=0 ; examples=1

period: integer ; missing=0 ; examples=1, 2, 3

lbase: numeric ; missing=0 ; examples=-0.756353788717556

lage: numeric ; missing=0 ; examples=0.114203695299265
