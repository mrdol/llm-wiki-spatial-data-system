...
Sex: factor ; missing=1 ; examples=Female, Male

Wr.Hnd: numeric ; missing=1 ; examples=18.5, 19.5, 18

NW.Hnd: numeric ; missing=1 ; examples=18, 20.5, 13.3

W.Hnd: factor ; missing=1 ; examples=Right, Left

Fold: factor ; missing=0 ; examples=R on L, L on R

Pulse: integer ; missing=45 ; examples=92, 104, 87

Clap: factor ; missing=1 ; examples=Left, Neither

Exer: factor ; missing=0 ; examples=Some, None

Smoke: factor ; missing=1 ; examples=Never, Regul, Occas

Height: numeric ; missing=28 ; examples=173, 177.8, 160

M.I: factor ; missing=28 ; examples=Metric, Imperial

Age: numeric ; missing=0 ; examples=18.25, 17.583, 16.917
