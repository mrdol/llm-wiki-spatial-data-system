...
Composition: integer ; missing=0 ; examples=10, 15, 8

Drawing: integer ; missing=0 ; examples=8, 16, 13

Colour: integer ; missing=0 ; examples=16, 4

Expression: integer ; missing=0 ; examples=3, 14, 7

School: factor ; missing=0 ; examples=A
