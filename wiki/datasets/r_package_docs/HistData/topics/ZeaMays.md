...
Description
     ...
     In the _Design of Experiments_, Fisher (1935) used these data to
...
Details
     ...
     permutations would suffice.  But this doesn't take the paired
     ...
     median signed rank of the ‘diff’ is zero, or that the distribution
     of ‘diff’ is symmetric about 0, vs. a location shifted
     alternative.

Source

     Darwin, C. (1876). _The Effect of Cross- and Self-fertilization in
     the Vegetable Kingdom_, 2nd Ed. London: John Murray.

     Andrews, D. and Herzberg, A. (1985) _Data: a collection of
...
References
     ...
     Fisher, R. A. (1935). _The Design of Experiments_. London: Oliver
     & Boyd.
...
pair: integer ; missing=0 ; examples=1, 2, 3

pot: factor ; missing=0 ; examples=1

cross: numeric ; missing=0 ; examples=23.5, 12, 21

self: numeric ; missing=0 ; examples=17.375, 20.375, 20

diff: numeric ; missing=0 ; examples=6.125, -8.375, 1
