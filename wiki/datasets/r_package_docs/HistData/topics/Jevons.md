...
Description
     ...
     In a remarkable brief note in _Nature_, 1871, W. Stanley Jevons
     ...
     important philosophical question: _How many objects can the mind
     embrace at once?_
...
Format
     ...
     ‘frequency’ Frequency of this combination of (actual, estimated):
          a numeric vector
...
actual: numeric ; missing=0 ; examples=3, 4, 5

estimated: numeric ; missing=0 ; examples=3, 4, 5

frequency: numeric ; missing=0 ; examples=23, 65, 102

error: numeric ; missing=0 ; examples=0
