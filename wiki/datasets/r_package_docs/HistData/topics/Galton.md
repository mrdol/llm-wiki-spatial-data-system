...
Format
     ...
     ‘parent’ a numeric vector: height of the mid-parent (average of
          father and mother)
...
References
     ...
     of the scatterplot.  _Journal of the History of the Behavioral
     Sciences_, *41*, 103-130.

     Galton, F. (1869). _Hereditary Genius: An Inquiry into its Laws
     and Consequences_. London: Macmillan.
...
parent: numeric ; missing=0 ; examples=70.5, 68.5, 65.5

child: numeric ; missing=0 ; examples=61.7
