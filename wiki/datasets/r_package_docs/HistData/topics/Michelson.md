...
Description
     ...
     Michelson's measurements in km/sec.  The number of cases is 100
     and the "true" value on this scale is 734.5.
...
References
     ...
     Anapolis". _Astronomical Papers_, *1*, 109-145, U. S. Nautical
     Almanac Office.
...
velocity: integer ; missing=0 ; examples=850, 740, 900
