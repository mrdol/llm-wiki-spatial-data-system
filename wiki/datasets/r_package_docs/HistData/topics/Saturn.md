...
Description
     ...
     were, _de facto_, due to "a very long, 917-year, periodic
...
Format
     ...
     ‘X3’ a numeric vector, a variable compound of the rate of change
          of Saturn's aphelion minus rates of change of the mean
          longitude of Saturn in 1750, multiplied by 2 times the mean
...
Details
     ...
     statistical failure. After he had found values for _n_ and _u_,
     Euler had the data needed to produce seventy-five equations, all
     linear in _x, y, m, z, a_, and _k_. He might have added them
...
Source
     ...
     Laplace", _Biometrika_, *62*, 503-517.
...
Year: numeric ; missing=0 ; examples=1591, 1598, 1660

Y: numeric ; missing=0 ; examples=1.19833333333333, 3.545, 5.2

X1: numeric ; missing=0 ; examples=-158, -151.78, -89.67

X2: numeric ; missing=0 ; examples=0.22041, 0.99974, 0.79735

X3: numeric ; missing=0 ; examples=-0.97541, -0.02278, 0.60352
