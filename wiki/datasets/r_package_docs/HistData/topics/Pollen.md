...
Description
     ...
     Graphics Section. Some surprising discoveries were made.
...
Details
     ...
     along the z dimension.  The fourth variable is pollen grain
     weight, and the fifth is density.
     ...
     package, using ‘rgl’ to zoom in on the magic word. See the video
     on <https://vimeo.com/1982725>.
...
References
     ...
     Datacryptanalysis: A Case Study. _Proceedings of the Section on
     Statistical Graphics_, 92-97.

     Slomka, M. (1986). The Analysis of a Synthetic Data Set.
     _Proceedings of the Section on Statistical Graphics_, 113-116.


Variables detected from installed object

ridge: numeric ; missing=0 ; examples=-2.3482, -1.152, -2.5245

nub: numeric ; missing=0 ; examples=3.6314, 1.4805, -6.8633

crack: numeric ; missing=0 ; examples=5.0289, 3.2375, -2.8037

weight: numeric ; missing=0 ; examples=10.8721, -0.5939, 8.4631

density: numeric ; missing=0 ; examples=-1.3852, 2.1235, -3.4126
