...
Description
     ...
     he gives a table (Table I) showing the actual number of yeast
     cells counted in the 20 x 20 grid for sample D, given here as
     ‘YeastD.mat’.
...
Details
     ...
     unit area. With uniform mixing, for a given particle, the
...
Source
     ...
     _A Handbook of Small Data Sets_. London: Chapman & Hall. The data
...
sample: factor ; missing=0 ; examples=A

count: integer ; missing=0 ; examples=0, 1, 2

freq: integer ; missing=0 ; examples=213, 128, 37
