...
Details
     ...
     in the Arbuthnot data.  In particular, the values for 1674 and
     1704 are identical, suggesting that the latter were copied
     erroneously from the former.
...
Source
     ...
     Sexes," _Philosophical transactions_, 27, 186-190.  Published in
     1711.

References

     Campbell, R. B., Arbuthnot and the Human Sex Ratio (2001). _Human
     Biology_, 73:4, 605-610.
     ...
     S. Zabell (1976). Arbuthnot, Heberden, and the _Bills of
     Mortality_. Technical Report No. 40, Department of Statistics,
...
Year: integer ; missing=0 ; examples=1629, 1630, 1631

Males: integer ; missing=0 ; examples=5218, 4858, 4422

Females: integer ; missing=0 ; examples=4683, 4457, 4102

Plague: integer ; missing=0 ; examples=0, 1317, 274

Mortality: integer ; missing=0 ; examples=8771, 10554, 8562

Ratio: numeric ; missing=0 ; examples=1.1142430066, 1.0899708324, 1.0780107265

Total: numeric ; missing=0 ; examples=9.901, 9.315, 8.524
