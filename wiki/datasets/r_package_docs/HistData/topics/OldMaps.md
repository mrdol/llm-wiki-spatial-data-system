...
Format
     ...
     ‘name’ Name of the map maker, using ‘Actual’ for the true
          coordinates of the points.  A factor with levels ‘Actual’
          ‘Arrowsmith’ ‘Belin’ ‘Cary’ ‘Coronelli’ D'Anville Del'Isle
...
point: integer ; missing=0 ; examples=1

col: integer ; missing=0 ; examples=1, 2, 3

name: factor ; missing=0 ; examples=Actual, Coronelli, Del'Isle

year: numeric ; missing=39 ; examples=1688, 1703, 1733

lat: numeric ; missing=0 ; examples=41.68, 41.62, -41.12

long: numeric ; missing=0 ; examples=82.85, 87.67, -83.03
