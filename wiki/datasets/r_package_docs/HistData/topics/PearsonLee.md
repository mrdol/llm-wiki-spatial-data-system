...
Source
     ...
     theory of evolution. On telegony in man, etc. _Proceedings of the
     Royal Society of London_, *60* , 273-283.

     Pearson, K. and Lee, A. (1903).  On the laws of inheritance in
     man: I. Inheritance of physical characters. _Biometrika_, *2*(4),
...
References
     ...
     regression data.  _The American Statistician_, *57*, 190-192.
...
child: numeric ; missing=0 ; examples=59.5

parent: numeric ; missing=0 ; examples=62.5, 63.5, 64.5

frequency: numeric ; missing=0 ; examples=0.5, 1

gp: factor ; missing=0 ; examples=fs

par: factor ; missing=0 ; examples=Father

chl: factor ; missing=0 ; examples=Son
