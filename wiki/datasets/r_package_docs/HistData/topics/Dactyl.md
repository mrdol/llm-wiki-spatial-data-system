...
Description
     ...
     _Aeneid_ and classified each of the first four "feet" of the line
     ...
     ‘Foot’ and ‘Lines’. Edgeworth used this table in what was among
     the first examples of analysis of variance applied to a two-way
     classification.
...
Format
     ...
     ‘Lines’ an ordered factor with levels ‘1:5’ < ‘6:10’ < ‘11:15’ <
...
Source
     ...
     Stigler, S. (1999) _Statistics on the Table_ Cambridge, MA:
     Harvard University Press, table 5.1.

References

     Edgeworth, F. Y. (1885). On methods of ascertaining variations in
     the rate of births, deaths and marriages. _Journal of the Royal
     Statistical Society_, 48, 628-649.


Variables detected from installed object

Foot: ordered/factor ; missing=0 ; examples=1

Lines: ordered/factor ; missing=0 ; examples=1:5, 6:10, 11:15

count: integer ; missing=0 ; examples=3, 5
