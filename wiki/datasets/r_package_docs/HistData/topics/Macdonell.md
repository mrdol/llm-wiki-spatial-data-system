...
Description
     ...
     In the second issue of _Biometrika_, W. R. Macdonell (1902)
     published an extensive paper, _On Criminal Anthropometry and the
     Identification of Criminals_ in which he included numerous tables
...
Source
     ...
     <https://doi.org/10.1093/biomet/1.2.177>
...
References
     ...
     and s: What if Gosset had R? _The American Statistician_, 62(1),
     64-69.

     Gosset, W. S. (Student) (1908). Probable error of a mean.
     _Biometrika_, 6(1), 1-25.
     <https://www.york.ac.uk/depts/maths/histstat/student.pdf>

     Gosset, W. S. (Student) (1908). Probable error of a correlation
     coefficient. _Biometrika_, 6, 302-310.


Variables detected from installed object

height: numeric ; missing=0 ; examples=4.63020833333333

finger: numeric ; missing=0 ; examples=9.4, 9.5, 9.6

frequency: integer ; missing=0 ; examples=0
