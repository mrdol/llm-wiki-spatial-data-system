...
Description
     ...
     Her _Diagram of the Causes of Mortality in the Army in the East_
...
Format
     ...
     ‘Date’ a Date, composed as ‘as.Date(paste(Year, Month, 1,
          sep='-'), "\%Y-\%b-\%d")’
     ...
     ‘Disease’ Number of deaths from preventable or mitagable zymotic
          diseases
     ...
     ‘Disease.rate’ Annual rate of deaths from preventable or mitagable
          zymotic diseases, per 1000

     ‘Wounds.rate’ Annual rate of deaths directly from battle wounds,
          per 1000
...
References
     ...
     Nightingale, F. (1858) _Notes on Matters Affecting the Health,
     Efficiency, and Hospital Administration of the British Army_
     Harrison and Sons, 1858

     Nightingale, F. (1859) _A Contribution to the Sanitary History of
     the British Army during the Late War with Russia_ London: John W.
     Parker and Son.
...
Date: Date ; missing=0 ; examples=1854-04-01, 1854-05-01, 1854-06-01

Month: ordered/factor ; missing=0 ; examples=Apr, May, Jun

Year: integer ; missing=0 ; examples=1854

Army: integer ; missing=0 ; examples=8571, 23333, 28333

Disease: integer ; missing=0 ; examples=1, 12, 11

Wounds: integer ; missing=0 ; examples=0

Other: integer ; missing=0 ; examples=5, 9, 6

Disease.rate: numeric ; missing=0 ; examples=1.4, 6.2, 4.7

Wounds.rate: numeric ; missing=0 ; examples=0

Other.rate: numeric ; missing=0 ; examples=7, 4.6, 2.5
