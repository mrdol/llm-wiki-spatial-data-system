...
Format
     ...
     ‘L_hyoscyamine’ a numeric vector: number of observations

     ‘L_hyoscine’ a numeric vector: number of observations

     ‘DL_hyoscine’ a numeric vector: number of observations
...
Source
     ...
     Isomers. II: Hyoscines," _Journal of Physiology_, 32, 501-510.
...
References
     ...
     _Statistics in Medicine_, 13, 785-803.
...
Control: numeric ; missing=1 ; examples=0.6, 3, 4.7

L_hyoscyamine: numeric ; missing=0 ; examples=1.3, 1.4, 4.5

L_hyoscine: numeric ; missing=0 ; examples=2.5, 3.8, 5.8

DL_hyoscine: numeric ; missing=0 ; examples=2.1, 4.4, 4.7
