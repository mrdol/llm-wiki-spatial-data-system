...
Format
     ...
     ‘Bags’ an ordered factor with levels 1 and 2 < ‘3’ < ‘4’ < ‘5’ <
          ‘6’ < ‘7’ < ‘8’ < ‘9’ < ‘10’

     ‘Group’ an ordered factor with levels below std < near std < above
          std

     ‘Deviation’ an ordered factor with levels ‘Below -R’ < (-R to -.2)
          < (-.2 to -.l) < (-.1 to 0) < (0 to .l) < (.1 to .2) < (.2 to
          R) < Above R
...
References
     ...
     Mint." In Vol 28 of _House Documents for 1849_.

     Stigler, S. M. (1997). Eight Centuries of Sampling Inspection: The
     Trial of the Pyx _Journal of the American Statistical
     Association_, *72*(359), 493-500.
...
Bags: ordered/factor ; missing=0 ; examples=1 and 2, 3, 4

Group: ordered/factor ; missing=0 ; examples=near std

Deviation: ordered/factor ; missing=0 ; examples=Below -R

count: integer ; missing=0 ; examples=34, 11, 20
