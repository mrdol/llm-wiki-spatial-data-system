---
title: Python_geodatasets_geoda.ncovr_1980
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.ncovr_1980.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`ncovr_1980`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.ncovr_1980
- Observation unit: observation spatiale de type POINT
- Observed population: 3085 enregistrements dans l’artefact local Python_geodatasets_geoda.ncovr_1980.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
...
- Source description: Dataset spatial issu du package Python `geodatasets` (`ncovr_1980`).
...
|---|---|---|---|---|
| `homicide_rate` | `numeric` | continuous | [0, 59.1339] | 0% |


> Selection Y/X (claude-sonnet-4-6) : homicide_rate est la variable cible naturelle de ce dataset (taux de criminalité à expliquer spatialement). Les variables socio-économiques et démographiques (resource_deprivation, population_structure, median_age, unemployment_rate, divorce_rate) ainsi que l'indicateur géographique SOUTH constituent des covariables explicatives classiques dans les modèles de criminalité ; NAME, STATE_NAME, FIPS et FIPSNO sont des identifiants/codes administratifs ignorés.
...
- Dataset ID: `Python_geodatasets_geoda.ncovr_1980`
- Dataset name: geodatasets::ncovr_1980
...
- CRS EPSG: 4326
- CRS nom: WGS 84
- CRS analyse recommande: pending — multi-zones (span=56.7deg) -- etendue compatible avec un grand pays/une region ; verifier qu'une projection nationale/regionale existe et convient a cette zone avant de l'utiliser, sinon envisager une projection continentale equal-area
