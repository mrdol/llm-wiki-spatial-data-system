---
title: Python_geodatasets_geoda.nyc_earnings_2013
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.nyc_earnings_2013.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2013`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.nyc_earnings_2013
- Observation unit: observation spatiale de type POINT
- Observed population: 108487 enregistrements dans l’artefact local Python_geodatasets_geoda.nyc_earnings_2013.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
...
- Source description: Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2013`).
...
|---|---|---|---|---|
| `total_jobs` | `integer` | count | [0, 2442] | 0% |
| `jobs_earnings_high` | `integer` | count | [0, 1381] | 0% |


> Selection Y/X (claude-sonnet-4-6) : Les variables d'emploi (total_jobs, jobs_earnings_high) sont des cibles naturelles pour modéliser la distribution spatiale des emplois et des hauts salaires à NYC en 2013. Les covariables retenues incluent jobs_earnings_low (composition salariale du bloc), ALAND10/AWATER10 (superficie terrestre/aquatique, proxy de densité urbaine), et COUNTYFP10 (arrondissement, effet de zone). Les colonnes GEOID10, STATEFP10, TRACTCE10, BLOCKCE10, INTPTLAT10, INTPTLON10 sont des identifiants ou libellés géographiques administratifs ignorés.
...
- Dataset ID: `Python_geodatasets_geoda.nyc_earnings_2013`
- Dataset name: geodatasets::nyc_earnings_2013
