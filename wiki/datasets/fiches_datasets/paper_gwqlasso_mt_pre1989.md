---
title: paper_gwqlasso_mt_pre1989
type: dataset
created: 2026-09-08
updated: 2026-09-08
sources:
  - data/final_datasets/sf/paper_gwqlasso_mt_pre1989.rds
  - DataCite_2022_GeographicallyWeightedQuantileLasso_10_1590_1982_7849rac2022200387_en
tags: [dataset, paper-derived, spatial, point]
---

Sous-ensemble (1974-1988 regroupees (15 annees clairsemees)) du jeu panel principal [[paper_gwqlasso_mt]], decoupe le 2026-09-08 pour elargir le nombre de jeux de donnees benchmarkables sans casser la validite spatiale (memes 141 municipalites que le parent, geometrie/CRS identiques). Papier source : "An application of geographically weighted quantile lasso to weather index insurance design" (DOI 10.1590/1982-7849rac2022200387.en).

## Description du jeu de donnees

- Topic: agriculture_economic
- Observation unit: observation spatiale, municipalites de Mato Grosso (MT)
- Observed population: sous-ensemble temporel (1974-1988 regroupees (15 annees clairsemees)) du dataset parent [[paper_gwqlasso_mt]] (N total parent = 6063) ; voir Bloc 4 pour le N exact de ce sous-ensemble
- Geographic context: Municipalites geocodees via reference publique IBGE (kelvins/Municipios-Brasileiros), CRS EPSG:4326.
- Temporal context: sous-panel reduit, 15 annees regroupees (1974-1988)
...
- Local sf output: `data/final_datasets/sf/paper_gwqlasso_mt_pre1989.rds`
...
- Reference publication: Miquelluti, D.L., Ozaki, V.A. & Miquelluti, D.J. (2022), Revista de Administracao Contemporanea 26(3): e200387, doi:10.1590/1982-7849rac2022200387.en. Sous-ensemble (1974-1988 regroupees (15 annees clairsemees)) du jeu parent [[paper_gwqlasso_mt]] -- meme formule, aucune modification.
...
- Recommended validation: N lignes=2115; N spatial=141; T declare=15. Grouper la CV par municipalite ET respecter le decoupage temporel (sous-panel, plusieurs annees regroupees).
...
- Dataset ID: `paper_gwqlasso_mt_pre1989`
- Dataset name: Rendement de soja et precipitation, municipalites de Mato Grosso -- sous-ensemble 1974-1988 regroupees (15 annees clairsemees)
...
modeling_evidence:
  ...
  source_ref: "Miquelluti, D.L., Ozaki, V.A. & Miquelluti, D.J. (2022), Revista de Administracao Contemporanea 26(3): e200387, doi:10.1590/1982-7849rac2022200387.en. Sous-ensemble (1974-1988 regroupees (15 annees clairsemees)) du jeu parent paper_gwqlasso_mt."
  confidence: medium
```
...
- Note N/T (session 2026-09-08) : Sous-panel reduit : regroupe les annees clairsemees 1974-1988 (15 annees) ou tres peu de mesures de rendement etaient disponibles individuellement (voir note sur la sparsite ci-dessous). N spatial = 141 municipalites (identiques a chaque annee, panel equilibre au niveau du parent). A traiter comme un VRAI sous-panel (comme paper_korea_hedonic_housing_pre1989), pas comme une simple coupe transversale -- grouper la CV par municipalite ET respecter le decoupage temporel (annee), memes principes que le sous-panel Coree pre1989.

## Bloc 5 - Resolution et etendue

- Type de geometrie: POINT
- Spatial resolution: point observation (municipalite)
- Temporal resolution: 1974-1988 regroupees (15 annees clairsemees)
- CRS EPSG: 4326
- CRS nom: WGS 84
- Spatial extent: x [-61.4697, -50.514], y [-17.8241, -9.4612]
- Time range: 1974 to 1988 (variable: Year, 15 annees regroupees)
...
Fiche generee par decoupage temporel du panel parent [[paper_gwqlasso_mt]] (regroupement des annees clairsemees 1974-1988 regroupees (15 annees clairsemees), sous-panel legitime -- meme logique que paper_korea_hedonic_housing_pre1989), sur decision explicite de l'utilisateur, pour elargir le nombre de jeux de donnees benchmarkables sans casser la validite spatiale (memes 141 municipalites que le parent, matrice W non degeneree). Le parent [[paper_gwqlasso_mt]] (panel complet, N=6063) est conserve tel quel.
