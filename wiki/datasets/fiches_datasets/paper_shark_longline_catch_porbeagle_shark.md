---
title: paper_shark_longline_catch_porbeagle_shark
type: dataset
created: 2026-09-23
updated: 2026-09-23
sources:
  - data/final_datasets/sf/paper_shark_longline_catch_porbeagle_shark.rds
...
Espece : requin-taupe commun (Porbeagle Shark, Lamna nasus). Reponse binaire `pres_abs` positive dans 6.5% (reponse rare -- quasi constante, a surveiller pour certains estimateurs) des lignes.

## Description du jeu de donnees

- Topic: halieutique / capture de requins par palangre industrielle -- Porbeagle Shark
- Observation unit: cellule de grille (5x5 degres) x annee, une seule espece
- Observed population: requin-taupe commun (Porbeagle Shark, Lamna nasus), captures par palangre, ORGP ICCAT (Atlantique), N=2148 lignes (300 sites x jusqu'a 9 annees)
...
- Source description: Global hotspots of shark interactions with industrial longline fisheries -- sous-jeu Porbeagle Shark
...
- Local sf output: `data/final_datasets/sf/paper_shark_longline_catch_porbeagle_shark.rds`
...
- y_term_pub: catch (capture de Porbeagle Shark, ICCAT -- Atlantique)
- Reference publication: Burns, Bradley & Thomas (2023), Global hotspots of shark interactions with industrial longline fisheries, Frontiers in Marine Science, doi:10.3389/fmars.2022.1062447 -- voir [[paper_shark_longline_catch]] pour le detail complet de la methodologie. Ce sous-jeu isole Porbeagle Shark (session 2026-09-23, split_shark_longline_catch.R) pour rendre le panel (site, annee) unique, condition necessaire a benchmark_spatial_panel().
...
formula_candidates:
  ...
  multivariate_constrained:
    ...
    response: "catch (capture de Porbeagle Shark, ICCAT -- Atlantique)"
...
- Dataset ID: `paper_shark_longline_catch_porbeagle_shark`
- Dataset name: Global hotspots of shark interactions with industrial longline fisheries -- Porbeagle Shark
...
modeling_evidence:
  ...
  source_ref: "Burns, Bradley & Thomas (2023), doi:10.3389/fmars.2022.1062447 -- voir [[paper_shark_longline_catch]] pour la citation complete. Ce sous-jeu isole Porbeagle Shark (session 2026-09-23)."
  confidence: medium
```
...
- License open: yes
- Reproducibility status: OK - script de split enregistre et reexecutable (`code/r_catalog/split_shark_longline_catch.R`, lit paper_shark_longline_catch.rds et filtre sur species_commonname="PORBEAGLE SHARK") ; source brute tracee dans inst/kg/paper_dataset_uses.json via le jeu parent.
