---
title: Python_geodatasets_geoda.nyc_earnings_2003
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.nyc_earnings_2003.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2003`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.nyc_earnings_2003
- Observation unit: observation spatiale de type POINT
- Observed population: 108487 enregistrements dans l’artefact local Python_geodatasets_geoda.nyc_earnings_2003.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
...
- Source description: Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2003`).
...
|---|---|---|---|---|
| `total_jobs` | `integer` | count | [0, 2048] | 0% |
| `jobs_earnings_high` | `integer` | count | [0, 1015] | 0% |


> Selection Y/X (claude-sonnet-4-6) : Les variables d'emploi (total_jobs, jobs_earnings_high) sont des cibles naturelles pour modéliser l'activité économique ou la concentration de hauts salaires au niveau des blocs census. Les covariables retenues incluent jobs_earnings_low (structure salariale complémentaire), ALAND10 et AWATER10 (surface terrestre/aquatique comme proxies de densité et d'usage du sol), et COUNTYFP10 (arrondissement NYC comme effet fixe spatial) ; les identifiants géographiques textuels (GEOID10, TRACTCE10, BLOCKCE10, STATEFP10) et les coordonnées internes (INTPTLAT10, INTPTLON10) sont ignorés car purement administratifs ou redondants avec la géométrie.
...
- Dataset ID: `Python_geodatasets_geoda.nyc_earnings_2003`
- Dataset name: geodatasets::nyc_earnings_2003
