...
|---|---|---|---|
| `DHSYEAR` | `integer` | unknown | 0% |
| `URBAN_RURA` | `character` | categorical | 0% |
| `NEG` | `integer` | unknown | 0% |
| `POS` | `integer` | unknown | 0% |
| `TOT` | `integer` | unknown | 0% |
...
- License evidence: DataCite API record for DOI 10.25413/sun.26976469 (checked 2026-08-18): rightsList = 'Creative Commons Attribution 4.0 International'.
...
- CRS analyse recommande: pending — multi-zones (span=40.7deg) -- etendue compatible avec un grand pays/une region ; verifier qu'une projection nationale/regionale existe et convient a cette zone avant de l'utiliser, sinon envisager une projection continentale equal-area
