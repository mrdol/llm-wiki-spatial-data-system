---
title: Python_geodatasets_geoda.nyc_earnings_2007
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.nyc_earnings_2007.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2007`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.nyc_earnings_2007
- Observation unit: observation spatiale de type POINT
- Observed population: 108487 enregistrements dans l’artefact local Python_geodatasets_geoda.nyc_earnings_2007.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
...
- Source description: Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2007`).
...
|---|---|---|---|---|
| `total_jobs` | `integer` | count | [0, 1891] | 0% |
| `jobs_earnings_high` | `integer` | count | [0, 1245] | 0% |
| `jobs_earnings_low` | `integer` | count | [0, 566] | 0% |


> Selection Y/X (claude-sonnet-4-6) : Les variables d'emploi et de revenus (total_jobs, jobs_earnings_high, jobs_earnings_low) sont des cibles thématiques naturelles pour modéliser la distribution spatiale de l'emploi à NYC en 2007. Les surfaces terrestres et aquatiques (ALAND10, AWATER10) ainsi que le comté (COUNTYFP10) constituent des covariables spatiales explicatives pertinentes ; les autres colonnes sont des identifiants ou codes géographiques administratifs sans valeur explicative directe.
...
- Dataset ID: `Python_geodatasets_geoda.nyc_earnings_2007`
- Dataset name: geodatasets::nyc_earnings_2007
