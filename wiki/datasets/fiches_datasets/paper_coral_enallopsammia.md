...
- Local sf output: `data/final_datasets/sf/paper_coral_enallopsammia.rds`
...
- Dataset ID: `paper_coral_enallopsammia`
...
- CRS EPSG: 4326
- CRS nom: WGS 84
- Spatial extent: x [-179.9895, 179.9945], y [-53.916698, -24.6567]
...
- Reproducibility: OK - loader R enregistre et reexecutable (`coral_enallopsammia` dans build_sf_datasets_papers.R) ; source brute tracee dans inst/kg/paper_dataset_uses.json.
