...
| `RH.G80.CHD.1` | `integer` | unknown | 0% |
| `RH.G80.CHD.2` | `integer` | unknown | 0% |
| `RH.G80.CHD.3` | `integer` | unknown | 0% |
| `RH.G90.CHD.1` | `integer` | unknown | 0% |
| `RH.G90.CHD.2` | `integer` | unknown | 0% |
| `RH.G90.CHD.3` | `integer` | unknown | 0% |
| `T.G30.CHD.1` | `integer` | unknown | 0% |
| `T.G30.CHD.2` | `integer` | unknown | 0% |
| `T.G30.CHD.3` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.CHD.1` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.CHD.2` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.CHD.3` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.CHD.1` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.CHD.2` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.CHD.3` | `integer` | unknown | 0% |
| `TRH.20T25nRHG85.CHD.1` | `integer` | unknown | 0% |
| `TRH.5T30nRHG75.CHD.1` | `integer` | unknown | 0% |
| `TRH.5T30nRHG75.CHD.2` | `integer` | unknown | 0% |
| `TRH.5T30nRHG75.CHD.3` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.CHD.1` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.CHD.2` | `integer` | unknown | 0% |
| `VPD.L11.CHD.1` | `integer` | unknown | 0% |
| `VPD.L11.CHD.2` | `integer` | unknown | 0% |
| `VPD.L635.CHD.1` | `integer` | unknown | 0% |
| `VPD.L635.CHD.2` | `integer` | unknown | 0% |
| `RH.G70.CD.1` | `integer` | unknown | 0% |
| `RH.G70.CD.2` | `integer` | unknown | 0% |
| `RH.G70.CD.3` | `integer` | unknown | 0% |
| `T.14T22.CD.1` | `integer` | unknown | 0% |
| `T.14T22.CD.2` | `integer` | unknown | 0% |
| `VPD.L6.CD.1` | `integer` | unknown | 0% |
| `VPD.L6.CD.2` | `integer` | unknown | 0% |
| `VPD.L6.CD.3` | `integer` | unknown | 0% |
...
| `T157` | `integer` | unknown | 0% |
| `T15307` | `integer` | unknown | 0% |
| `RH7` | `numeric` | continuous | 0% |
| `RH907` | `integer` | unknown | 0% |
| `TRH907` | `integer` | unknown | 0% |
| `TRH807` | `integer` | unknown | 0% |
| `MT10` | `numeric` | continuous | 0% |
| `T1510` | `integer` | unknown | 0% |
| `T153010` | `integer` | unknown | 0% |
| `RH10` | `numeric` | continuous | 0% |
| `RH9010` | `integer` | unknown | 0% |
| `RH8010` | `integer` | unknown | 0% |
| `TRH9010` | `integer` | unknown | 0% |
| `TRH8010` | `integer` | unknown | 0% |
| `INT3` | `integer` | unknown | 0% |
| `VPD.A.PRE5.12H` | `numeric` | continuous | 0% |
| `VPD.L20.PRE5.12H` | `integer` | unknown | 0% |
| `VPD.L45.PRE5.12H` | `integer` | unknown | 0% |
| `VPD.A.PRE7.12H` | `numeric` | continuous | 0% |
| `VPD.L20.PRE7.12H` | `integer` | unknown | 0% |
| `VPD.L45.PRE7.12H` | `integer` | unknown | 0% |
| `VPD.A.PRE10.12H` | `numeric` | continuous | 0% |
| `VPD.L20.PRE10.12H` | `integer` | unknown | 0% |
| `VPD.L45.PRE10.12H` | `integer` | unknown | 0% |
| `VPD.A.PRE14.12H` | `numeric` | continuous | 0% |
| `VPD.L20.PRE14.12H` | `integer` | unknown | 0% |
| `VPD.L45.PRE14.12H` | `integer` | unknown | 0% |
| `VPD.A.PRE15.12H` | `numeric` | continuous | 0% |
| `VPD.L20.PRE15.12H` | `integer` | unknown | 0% |
| `VPD.L45.PRE15.12H` | `integer` | unknown | 0% |
| `VPD.A.POST5.12H` | `numeric` | continuous | 0% |
| `VPD.L20.POST5.12H` | `integer` | unknown | 0% |
| `VPD.L45.POST5.12H` | `integer` | unknown | 0% |
| `VPD.A.POST7.12H` | `numeric` | continuous | 0% |
| `VPD.L20.POST7.12H` | `integer` | unknown | 0% |
| `VPD.L45.POST7.12H` | `integer` | unknown | 0% |
| `VPD.A.POST10.12H` | `numeric` | continuous | 0% |
| `VPD.L20.POST10.12H` | `integer` | unknown | 0% |
| `VPD.L45.POST10.12H` | `integer` | unknown | 0% |
| `VPD.A.POST14.12H` | `numeric` | continuous | 0% |
| `VPD.L20.POST14.12H` | `integer` | unknown | 0% |
| `VPD.L45.POST14.12H` | `integer` | unknown | 0% |
| `VPD.A.POST15.12H` | `numeric` | continuous | 0% |
| `VPD.L20.POST15.12H` | `integer` | unknown | 0% |
| `VPD.L45.POST15.12H` | `integer` | unknown | 0% |
| `DD.A.PRE5.12H` | `numeric` | continuous | 0% |
| `DD.L1.PRE5.12H` | `integer` | unknown | 0% |
| `DD.A.PRE7.12H` | `numeric` | continuous | 0% |
| `DD.L1.PRE7.12H` | `integer` | unknown | 0% |
| `DD.A.PRE10.12H` | `numeric` | continuous | 0% |
| `DD.L1.PRE10.12H` | `integer` | unknown | 0% |
| `DD.A.PRE14.12H` | `numeric` | continuous | 0% |
| `DD.L1.PRE14.12H` | `integer` | unknown | 0% |
| `DD.A.PRE15.12H` | `numeric` | continuous | 0% |
| `DD.L1.PRE15.12H` | `integer` | unknown | 0% |
| `DD.A.POST5.12H` | `numeric` | continuous | 0% |
| `DD.L1.POST5.12H` | `integer` | unknown | 0% |
| `DD.A.POST7.12H` | `numeric` | continuous | 0% |
| `DD.L1.POST7.12H` | `integer` | unknown | 0% |
| `DD.A.POST10.12H` | `numeric` | continuous | 0% |
| `DD.L1.POST10.12H` | `integer` | unknown | 0% |
| `DD.A.POST14.12H` | `numeric` | continuous | 0% |
| `DD.L1.POST14.12H` | `integer` | unknown | 0% |
| `DD.A.POST15.12H` | `numeric` | continuous | 0% |
| `DD.L1.POST15.12H` | `integer` | unknown | 0% |
| `RH.A.PRE5.12H` | `numeric` | continuous | 0% |
| `RH.A.PRE5.24H` | `numeric` | continuous | 0% |
| `RH.G80.PRE5.12H` | `integer` | unknown | 0% |
| `RH.G90.PRE5.12H` | `integer` | unknown | 0% |
| `RH.A.PRE7.12H` | `numeric` | continuous | 0% |
| `RH.G80.PRE7.12H` | `integer` | unknown | 0% |
| `RH.G90.PRE7.12H` | `integer` | unknown | 0% |
| `RH.A.PRE10.12H` | `numeric` | continuous | 0% |
| `RH.A.PRE10.24H` | `numeric` | continuous | 0% |
| `RH.G80.PRE10.12H` | `integer` | unknown | 0% |
| `RH.G90.PRE10.12H` | `integer` | unknown | 0% |
| `RH.A.PRE14.12H` | `numeric` | continuous | 0% |
| `RH.A.PRE14.24H` | `numeric` | continuous | 0% |
| `RH.G80.PRE14.12H` | `integer` | unknown | 0% |
| `RH.G90.PRE14.12H` | `integer` | unknown | 0% |
| `RH.A.PRE15.12H` | `numeric` | continuous | 0% |
| `RH.A.PRE15.24H` | `numeric` | continuous | 0% |
| `RH.G80.PRE15.12H` | `integer` | unknown | 0% |
| `RH.G90.PRE15.12H` | `integer` | unknown | 0% |
| `RH.A.POST5.12H` | `numeric` | continuous | 0% |
| `RH.A.POST5.24H` | `numeric` | continuous | 0% |
| `RH.G80.POST5.12H` | `integer` | unknown | 0% |
| `RH.G90.POST5.12H` | `integer` | unknown | 0% |
| `RH.A.POST7.12H` | `numeric` | continuous | 0% |
| `RH.A.POST7.24H` | `numeric` | continuous | 0% |
| `RH.G80.POST7.12H` | `integer` | unknown | 0% |
| `RH.G90.POST7.12H` | `integer` | unknown | 0% |
| `RH.A.POST10.12H` | `numeric` | continuous | 0% |
| `RH.G80.POST10.12H` | `integer` | unknown | 0% |
| `RH.G90.POST10.12H` | `integer` | unknown | 0% |
| `RH.A.POST14.12H` | `numeric` | continuous | 0% |
| `RH.A.POST14.24H` | `numeric` | continuous | 0% |
| `RH.G80.POST14.12H` | `integer` | unknown | 0% |
| `RH.G90.POST14.12H` | `integer` | unknown | 0% |
| `RH.A.POST15.12H` | `numeric` | continuous | 0% |
| `RH.A.POST15.24H` | `numeric` | continuous | 0% |
| `RH.G80.POST15.12H` | `integer` | unknown | 0% |
| `RH.G90.POST15.12H` | `integer` | unknown | 0% |
| `T.A.PRE5.24H` | `numeric` | continuous | 0% |
| `T.9T30.PRE5.24H` | `integer` | unknown | 0% |
| `T.15T30.PRE5.24H` | `integer` | unknown | 0% |
| `T.L9.PRE5.24H` | `integer` | unknown | 0% |
| `T.L15.PRE5.24H` | `integer` | unknown | 0% |
| `T.G30.PRE5.24H` | `integer` | unknown | 0% |
| `T.A.PRE7.24H` | `numeric` | continuous | 0% |
| `T.9T30.PRE7.24H` | `integer` | unknown | 0% |
| `T.L9.PRE7.24H` | `integer` | unknown | 0% |
| `T.L15.PRE7.24H` | `integer` | unknown | 0% |
| `T.G30.PRE7.24H` | `integer` | unknown | 0% |
| `T.A.PRE10.24H` | `numeric` | continuous | 0% |
| `T.9T30.PRE10.24H` | `integer` | unknown | 0% |
| `T.15T30.PRE10.24H` | `integer` | unknown | 0% |
| `T.L9.PRE10.24H` | `integer` | unknown | 0% |
| `T.L15.PRE10.24H` | `integer` | unknown | 0% |
| `T.G30.PRE10.24H` | `integer` | unknown | 0% |
| `T.A.PRE14.24H` | `numeric` | continuous | 0% |
| `T.9T30.PRE14.24H` | `integer` | unknown | 0% |
| `T.15T30.PRE14.24H` | `integer` | unknown | 0% |
| `T.L9.PRE14.24H` | `integer` | unknown | 0% |
| `T.L15.PRE14.24H` | `integer` | unknown | 0% |
| `T.G30.PRE14.24H` | `integer` | unknown | 0% |
| `T.A.PRE15.24H` | `numeric` | continuous | 0% |
| `T.9T30.PRE15.24H` | `integer` | unknown | 0% |
| `T.15T30.PRE15.24H` | `integer` | unknown | 0% |
| `T.L9.PRE15.24H` | `integer` | unknown | 0% |
| `T.L15.PRE15.24H` | `integer` | unknown | 0% |
| `T.G30.PRE15.24H` | `integer` | unknown | 0% |
| `T.A.POST5.24H` | `numeric` | continuous | 0% |
| `T.9T30.POST5.24H` | `integer` | unknown | 0% |
| `T.15T30.POST5.24H` | `integer` | unknown | 0% |
| `T.L9.POST5.24H` | `integer` | unknown | 0% |
| `T.L15.POST5.24H` | `integer` | unknown | 0% |
| `T.G30.POST5.24H` | `integer` | unknown | 0% |
| `T.A.POST7.24H` | `numeric` | continuous | 0% |
| `T.9T30.POST7.24H` | `integer` | unknown | 0% |
| `T.15T30.POST7.24H` | `integer` | unknown | 0% |
| `T.L9.POST7.24H` | `integer` | unknown | 0% |
| `T.L15.POST7.24H` | `integer` | unknown | 0% |
| `T.G30.POST7.24H` | `integer` | unknown | 0% |
| `T.9T30.POST10.24H` | `integer` | unknown | 0% |
| `T.L9.POST10.24H` | `integer` | unknown | 0% |
| `T.L15.POST10.24H` | `integer` | unknown | 0% |
| `T.G30.POST10.24H` | `integer` | unknown | 0% |
| `T.A.POST14.24H` | `numeric` | continuous | 0% |
| `T.9T30.POST14.24H` | `integer` | unknown | 0% |
| `T.15T30.POST14.24H` | `integer` | unknown | 0% |
| `T.L9.POST14.24H` | `integer` | unknown | 0% |
| `T.L15.POST14.24H` | `integer` | unknown | 0% |
| `T.G30.POST14.24H` | `integer` | unknown | 0% |
| `T.A.POST15.24H` | `numeric` | continuous | 0% |
| `T.9T30.POST15.24H` | `integer` | unknown | 0% |
| `T.15T30.POST15.24H` | `integer` | unknown | 0% |
| `T.L9.POST15.24H` | `integer` | unknown | 0% |
| `T.L15.POST15.24H` | `integer` | unknown | 0% |
| `T.G30.POST15.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.PRE5.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.PRE5.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.PRE5.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.PRE5.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.PRE7.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.PRE7.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.PRE7.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.PRE7.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.PRE10.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.PRE10.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.PRE10.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.PRE10.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.PRE14.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.PRE14.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.PRE14.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.PRE14.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.PRE15.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.PRE15.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.PRE15.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.PRE15.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.POST5.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.POST5.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.POST5.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.POST5.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.POST7.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.POST7.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.POST7.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.POST7.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.POST10.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.POST10.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.POST10.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.POST10.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.POST14.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.POST14.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.POST14.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.POST14.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.POST15.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.POST15.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.POST15.12H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.POST15.12H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.PRE5.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.PRE5.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.PRE5.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.PRE5.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.PRE7.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.PRE7.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.PRE10.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.PRE10.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.PRE10.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.PRE10.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.PRE14.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.PRE14.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.PRE14.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.PRE14.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.PRE15.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.PRE15.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.PRE15.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.PRE15.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.POST5.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.POST5.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.POST5.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.POST5.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.POST7.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.POST7.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.POST7.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.POST7.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.POST10.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.POST10.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.POST14.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.POST14.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.POST14.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.POST14.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG80.POST15.24H` | `integer` | unknown | 0% |
| `TRH.9T30nRHG90.POST15.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG80.POST15.24H` | `integer` | unknown | 0% |
| `TRH.15T30nRHG90.POST15.24H` | `integer` | unknown | 0% |
...
- License evidence: DataCite API record for DOI 10.5061/dryad.fn2z34trv (checked 2026-08-18): rightsList = 'Creative Commons Zero v1.0 Universal'.
...
- CRS analyse recommande: pending — multi-zones (span=25.9deg) -- etendue compatible avec un grand pays/une region ; verifier qu'une projection nationale/regionale existe et convient a cette zone avant de l'utiliser, sinon envisager une projection continentale equal-area
