...
- Spatial resolution: point observation (municipalite -- meme support que les fiches annuelles associees paper_gwqlasso_rs_*)
...
- Missing values: WARN - variables avec NA > 20%: Yield_kg_ha (NA=36.6%).
