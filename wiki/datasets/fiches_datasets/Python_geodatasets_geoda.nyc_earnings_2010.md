---
title: Python_geodatasets_geoda.nyc_earnings_2010
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.nyc_earnings_2010.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2010`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.nyc_earnings_2010
- Observation unit: observation spatiale de type POINT
- Observed population: 108487 enregistrements dans l’artefact local Python_geodatasets_geoda.nyc_earnings_2010.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
...
- Source description: Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2010`).
...
|---|---|---|---|---|
| `total_jobs` | `integer` | count | [0, 2773] | 0% |
| `jobs_earnings_high` | `integer` | count | [0, 2234] | 0% |
| `jobs_earnings_low` | `integer` | count | [0, 520] | 0% |


> Selection Y/X (claude-sonnet-4-6) : Les variables d'emploi (total_jobs, jobs_earnings_high, jobs_earnings_low) sont des cibles naturelles pour modéliser la distribution spatiale des emplois et des revenus à New York en 2010. ALAND10 (superficie terrestre), AWATER10 (superficie en eau) et COUNTYFP10 (arrondissement/borough, variable catégorielle ordonnée) sont des covariables spatiales utiles ; les autres colonnes sont des identifiants géographiques purement administratifs (GEOID10, TRACTCE10, BLOCKCE10, STATEFP10) ou des coordonnées encodées en texte (INTPTLAT10, INTPTLON10) déjà gérées en amont.
...
- Dataset ID: `Python_geodatasets_geoda.nyc_earnings_2010`
- Dataset name: geodatasets::nyc_earnings_2010
