---
title: Python_geodatasets_geoda.nyc_earnings_2014
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.nyc_earnings_2014.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2014`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.nyc_earnings_2014
- Observation unit: observation spatiale de type POINT
- Observed population: 108487 enregistrements dans l’artefact local Python_geodatasets_geoda.nyc_earnings_2014.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
...
- Source description: Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2014`).
...
|---|---|---|---|---|
| `total_jobs` | `integer` | count | [0, 2561] | 0% |
| `jobs_earnings_high` | `integer` | count | [0, 1587] | 0% |


> Selection Y/X (claude-sonnet-4-6) : Les variables d'emploi (total_jobs, jobs_earnings_high) sont des cibles naturelles pour modéliser la distribution spatiale de l'emploi ou des revenus élevés à NYC en 2014. Les covariables retenues incluent la proportion de bas salaires (jobs_earnings_low), la superficie terrestre (ALAND10) et en eau (AWATER10) comme proxies de densité/urbanisation, et le county (COUNTYFP10) comme facteur géographique structurant ; les codes purement administratifs (GEOID10, TRACTCE10, BLOCKCE10, STATEFP10) et les coordonnées textuelles (INTPTLAT10, INTPTLON10) sont ignorés.
...
- Dataset ID: `Python_geodatasets_geoda.nyc_earnings_2014`
- Dataset name: geodatasets::nyc_earnings_2014
