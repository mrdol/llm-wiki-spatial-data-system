---
title: Python_geodatasets_geoda.nyc_earnings_2011
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.nyc_earnings_2011.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2011`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.nyc_earnings_2011
- Observation unit: observation spatiale de type POINT
- Observed population: 108487 enregistrements dans l’artefact local Python_geodatasets_geoda.nyc_earnings_2011.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
...
- Source description: Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2011`).
...
|---|---|---|---|---|
| `total_jobs` | `integer` | count | [0, 2816] | 0% |
| `jobs_earnings_high` | `integer` | count | [0, 1368] | 0% |


> Selection Y/X (claude-sonnet-4-6) : Les variables d'emploi et de revenus (total_jobs, jobs_earnings_high, jobs_earnings_low) sont les seules variables substantielles modélisables ; total_jobs et jobs_earnings_high sont des cibles naturelles (volume total d'emplois ou emplois à hauts revenus), tandis que jobs_earnings_low, la superficie terrestre (ALAND10), la superficie en eau (AWATER10) et le comté (COUNTYFP10) servent de covariables explicatives. Les identifiants géographiques textuels (GEOID10, TRACTCE10, BLOCKCE10, STATEFP10, INTPTLAT10, INTPTLON10) sont ignorés car purement administratifs ou redondants avec la géométrie.
...
- Dataset ID: `Python_geodatasets_geoda.nyc_earnings_2011`
- Dataset name: geodatasets::nyc_earnings_2011
