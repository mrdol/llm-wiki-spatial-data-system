...
- formula_candidate_1: SDOH_CL ~ ep_pci + ep_nohs + ep_sngp + ep_lime + ep_crow + ep_nove + rntov30p_1 + ep_minrty
- formula_candidate_1_role: recommended_default
- formula_candidate_2: SDOH_CL ~ ep_pci + ep_nohs + ep_sngp + ep_lime
