...
- Raison: Y continu reel (Housing.price), sous-ensemble temporel de l'annee 1993 du dataset parent deja promu package_include="yes" (paper_korea_hedonic_housing, session 2026-08-16). N=5432 transactions, 164 localisations distinctes (verifie sur le .rds decoupe) -- assez pour une matrice de voisinage W non degeneree. Meme formule/Y/X que le parent, aucune correction necessaire.
