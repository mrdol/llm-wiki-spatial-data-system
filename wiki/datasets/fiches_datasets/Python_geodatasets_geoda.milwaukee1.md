...
- formula_pub: HSG_VAL~TOT_POP+POV_POP+WHITE_+BLACK_+PCTBLACK+EMPL16+OCC_MAN
- x_terms_pub: TOT_POP+POV_POP+WHITE_+BLACK_+PCTBLACK+EMPL16+OCC_MAN
- y_term_pub: HSG_VAL
...
modeling_evidence:
  ...
  equation_text: "HSG_VAL~TOT_POP+POV_POP+WHITE_+BLACK_+PCTBLACK+EMPL16+OCC_MAN"
