...
| `NFIRESM6` | `integer` | unknown | 5% |
| `NFIRESV1` | `integer` | unknown | 1.7% |
...
- CRS analyse recommande: aucune reprojection necessaire -- CRS deja projete et metrique. (EPSG:32619, WGS 84 / UTM zone 19N)
