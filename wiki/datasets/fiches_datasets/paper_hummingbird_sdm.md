...
| `species_richness` | `integer` | unknown | [1, 50] | 0% |
| `n_occurrences` | `integer` | unknown | [1, 739] | 0% |
...
- License evidence: DataCite API record for DOI 10.5061/dryad.k98sf7mdg (checked 2026-08-18): rightsList = 'Creative Commons Zero v1.0 Universal'.
...
- CRS analyse recommande: pending — multi-zones (span=54deg) -- etendue compatible avec un grand pays/une region ; verifier qu'une projection nationale/regionale existe et convient a cette zone avant de l'utiliser, sinon envisager une projection continentale equal-area
