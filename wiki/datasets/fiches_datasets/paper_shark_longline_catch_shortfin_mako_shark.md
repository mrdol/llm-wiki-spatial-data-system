---
title: paper_shark_longline_catch_shortfin_mako_shark
type: dataset
created: 2026-09-23
updated: 2026-09-23
sources:
  - data/final_datasets/sf/paper_shark_longline_catch_shortfin_mako_shark.rds
...
Espece : requin mako (Shortfin Mako Shark, Isurus oxyrinchus). Reponse binaire `pres_abs` positive dans 60.1% des lignes.

## Description du jeu de donnees

- Topic: halieutique / capture de requins par palangre industrielle -- Shortfin Mako Shark
- Observation unit: cellule de grille (5x5 degres) x annee, une seule espece
- Observed population: requin mako (Shortfin Mako Shark, Isurus oxyrinchus), captures par palangre, ORGP ICCAT (Atlantique), N=2148 lignes (300 sites x jusqu'a 9 annees)
...
- Source description: Global hotspots of shark interactions with industrial longline fisheries -- sous-jeu Shortfin Mako Shark
...
- Local sf output: `data/final_datasets/sf/paper_shark_longline_catch_shortfin_mako_shark.rds`
...
- y_term_pub: catch (capture de Shortfin Mako Shark, ICCAT -- Atlantique)
- Reference publication: Burns, Bradley & Thomas (2023), Global hotspots of shark interactions with industrial longline fisheries, Frontiers in Marine Science, doi:10.3389/fmars.2022.1062447 -- voir [[paper_shark_longline_catch]] pour le detail complet de la methodologie. Ce sous-jeu isole Shortfin Mako Shark (session 2026-09-23, split_shark_longline_catch.R) pour rendre le panel (site, annee) unique, condition necessaire a benchmark_spatial_panel().
...
formula_candidates:
  ...
  multivariate_constrained:
    ...
    response: "catch (capture de Shortfin Mako Shark, ICCAT -- Atlantique)"
...
- Dataset ID: `paper_shark_longline_catch_shortfin_mako_shark`
- Dataset name: Global hotspots of shark interactions with industrial longline fisheries -- Shortfin Mako Shark
...
modeling_evidence:
  ...
  source_ref: "Burns, Bradley & Thomas (2023), doi:10.3389/fmars.2022.1062447 -- voir [[paper_shark_longline_catch]] pour la citation complete. Ce sous-jeu isole Shortfin Mako Shark (session 2026-09-23)."
  confidence: medium
```
...
- License open: yes
- Reproducibility status: OK - script de split enregistre et reexecutable (`code/r_catalog/split_shark_longline_catch.R`, lit paper_shark_longline_catch.rds et filtre sur species_commonname="SHORTFIN MAKO SHARK") ; source brute tracee dans inst/kg/paper_dataset_uses.json via le jeu parent.
