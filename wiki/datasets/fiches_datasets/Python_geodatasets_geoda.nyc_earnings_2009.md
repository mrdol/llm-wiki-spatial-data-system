---
title: Python_geodatasets_geoda.nyc_earnings_2009
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.nyc_earnings_2009.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2009`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.nyc_earnings_2009
- Observation unit: observation spatiale de type POINT
- Observed population: 108487 enregistrements dans l’artefact local Python_geodatasets_geoda.nyc_earnings_2009.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
...
- Source description: Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2009`).
...
|---|---|---|---|---|
| `total_jobs` | `integer` | count | [0, 2560] | 0% |
| `jobs_earnings_high` | `integer` | count | [0, 2142] | 0% |
| `jobs_earnings_low` | `integer` | count | [0, 521] | 0% |


> Selection Y/X (claude-sonnet-4-6) : Les variables d'emploi et de revenus (total_jobs, jobs_earnings_high, jobs_earnings_low) sont des cibles naturelles pour modéliser l'activité économique à l'échelle des blocs census NYC 2009. La superficie terrestre (ALAND10), la superficie en eau (AWATER10) et le comté (COUNTYFP10) sont des covariables géographiques/structurelles exploitables ; les codes GEOID, TRACTCE, BLOCKCE, STATEFP sont des identifiants administratifs ignorés, et INTPTLAT/INTPTLON sont des coordonnées textuelles redondantes avec la géométrie sf.
...
- Dataset ID: `Python_geodatasets_geoda.nyc_earnings_2009`
- Dataset name: geodatasets::nyc_earnings_2009
