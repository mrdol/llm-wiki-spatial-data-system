---
title: Python_geodatasets_geoda.ncovr_1990
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.ncovr_1990.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`ncovr_1990`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.ncovr_1990
- Observation unit: observation spatiale de type POINT
- Observed population: 3085 enregistrements dans l’artefact local Python_geodatasets_geoda.ncovr_1990.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
...
- Source description: Dataset spatial issu du package Python `geodatasets` (`ncovr_1990`).
...
|---|---|---|---|---|
| `homicide_rate` | `numeric` | continuous | [0, 71.3776] | 0% |


> Selection Y/X (claude-sonnet-4-6) : Le taux d'homicide est la variable cible naturelle dans ce dataset issu de la criminologie spatiale (NCOVR). Les variables socio-économiques et démographiques (déprivation, structure de population, âge médian, chômage, divorce, indicateur Sud) constituent des covariables explicatives classiques de la littérature sur les déterminants spatiaux de la criminalité. NAME, STATE_NAME, FIPS et FIPSNO sont ignorés car purement administratifs/identifiants.
...
- Dataset ID: `Python_geodatasets_geoda.ncovr_1990`
- Dataset name: geodatasets::ncovr_1990
