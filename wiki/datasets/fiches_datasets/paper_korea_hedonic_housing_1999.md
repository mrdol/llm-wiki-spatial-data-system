...
- Local sf output: `data/final_datasets/sf/paper_korea_hedonic_housing_1999.rds`
...
- Dataset ID: `paper_korea_hedonic_housing_1999`
...
- CRS EPSG: 4326
- CRS nom: WGS 84
- Spatial extent: x [126.788351, 129.181163], y [35.068213, 36.448067]
...
- Reproducibility status: OK - loader R enregistre et reexecutable (`korea_hedonic_housing_1999` dans build_sf_datasets_papers.R) ; source brute tracee dans inst/kg/paper_dataset_uses.json.
- Code available: yes (loader `korea_hedonic_housing_1999` dans `code/r_catalog/build_sf_datasets_papers.R`)
...
- Reproducibility: OK - loader R enregistre et reexecutable (`korea_hedonic_housing_1999` dans build_sf_datasets_papers.R) ; source brute tracee dans inst/kg/paper_dataset_uses.json.
