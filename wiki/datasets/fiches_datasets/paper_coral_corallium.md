...
- Raison: Meme source/structure que coral_bathypathes (README Dryad commun aux 12 taxons).
...
- CRS analyse recommande: pending - multi-zones (span=359.9deg) -- projection nationale recommandee
