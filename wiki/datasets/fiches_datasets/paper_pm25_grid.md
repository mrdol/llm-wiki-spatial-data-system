...
- License evidence: DataCite API record for DOI 10.7910/dvn/58c6hg (checked 2026-08-18): rightsList = 'Creative Commons Zero v1.0 Universal'.
...
- Spatial resolution: point observation (support reel : point de grille de 1 km)
- Temporal resolution: not applicable (cross-sectional dataset)
- CRS EPSG: 4326
- CRS nom: WGS 84
- Spatial extent: x [-157.73833, -65.7630374], y [21.115, 58.8025]
- Time range: not applicable (cross-sectional dataset)
- CRS analyse recommande: pending — etendue continentale/mondiale (span=92deg) -- projection nationale non pertinente ; privilegier une projection equal-area continentale ou mondiale (ex: Albers equal-area continental, Behrmann/Mollweide pour une couverture mondiale)
