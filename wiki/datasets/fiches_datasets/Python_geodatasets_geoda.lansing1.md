...
- Topic: Donnees de python-package : Python_geodatasets_geoda.lansing1
- Observation unit: observation spatiale de type POINT
- Observed population: 117 enregistrements dans l’artefact local Python_geodatasets_geoda.lansing1.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
- Geographic context: Etendue mesuree dans le RDS : x [-85.016004324926, -84.19943929161], y [42.4655465, 43.0755035]; CRS WGS 84.
- Temporal context: aucune variable temporelle structurelle detectee
- Source description: Dataset spatial issu du package Python `geodatasets` (`lansing1`).
...
- formula_used: HH_INC ~ TOT_POP + POP_16 + POP_65 + WHITE + BLACK + ASIAN + HISP + MUTLI_RA
...
formula_candidates:
  ...
  ml_or_selected:
    formula: "HH_INC ~ TOT_POP + POP_16 + POP_65 + WHITE + BLACK + ASIAN + HISP + MUTLI_RA"
    response: "HH_INC"
    predictors: ["TOT_POP", "POP_16", "POP_65", "WHITE", "BLACK", "ASIAN", "HISP", "MUTLI_RA"]
...
modeling_evidence:
  ...
  equation_text: "HH_INC ~ TOT_POP + POP_16 + POP_65 + WHITE + BLACK + ASIAN + HISP + MUTLI_RA"
