...
- Local sf output: `data/final_datasets/sf/paper_coral_solenosmilia.rds`
...
| `OM_CAL3_C` | `numeric` | continuous | 1.2% |
...
- Dataset ID: `paper_coral_solenosmilia`
...
- CRS EPSG: 4326
- CRS nom: WGS 84
- Spatial extent: x [-179.996833, 179.993454], y [-56.3349991, -27.208666]
...
- Reproducibility status: OK - loader R enregistre et reexecutable (`coral_solenosmilia` dans build_sf_datasets_papers.R) ; source brute tracee dans inst/kg/paper_dataset_uses.json.
- Code available: yes (loader `coral_solenosmilia` dans `code/r_catalog/build_sf_datasets_papers.R`)
...
- Reproducibility: OK - loader R enregistre et reexecutable (`coral_solenosmilia` dans build_sf_datasets_papers.R) ; source brute tracee dans inst/kg/paper_dataset_uses.json.
