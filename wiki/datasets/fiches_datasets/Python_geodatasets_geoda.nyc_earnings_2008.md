---
title: Python_geodatasets_geoda.nyc_earnings_2008
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.nyc_earnings_2008.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2008`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.nyc_earnings_2008
- Observation unit: observation spatiale de type POINT
- Observed population: 108487 enregistrements dans l’artefact local Python_geodatasets_geoda.nyc_earnings_2008.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
...
- Source description: Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2008`).
...
|---|---|---|---|---|
| `total_jobs` | `integer` | count | [0, 1946] | 0% |
| `jobs_earnings_high` | `integer` | count | [0, 1541] | 0% |
| `jobs_earnings_low` | `integer` | count | [0, 522] | 0% |


> Selection Y/X (claude-sonnet-4-6) : Les variables d'emploi et de revenus (total_jobs, jobs_earnings_high, jobs_earnings_low) sont des cibles naturelles pour modéliser la distribution économique urbaine à l'échelle du bloc. Les surfaces terrestres (ALAND10) et aquatiques (AWATER10) ainsi que le comté (COUNTYFP10) constituent des covariables spatiales plausibles (densité, localisation administrative) ; les identifiants géographiques textuels (GEOID10, TRACTCE10, BLOCKCE10, STATEFP10) et les coordonnées stockées en caractères (INTPTLAT10, INTPTLON10) sont ignorés car purement administratifs ou redondants avec la géométrie.
...
- Dataset ID: `Python_geodatasets_geoda.nyc_earnings_2008`
- Dataset name: geodatasets::nyc_earnings_2008
