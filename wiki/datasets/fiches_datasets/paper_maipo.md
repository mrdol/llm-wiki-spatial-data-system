...
- Published X variables from paper: ndvi01, ndvi02, ndvi03, ndvi04, ndvi05, ndvi06, ndvi07, ndvi08, ndwi01, ndwi02, ndwi03, ndwi04, ndwi05, ndwi06, ndwi07, ndwi08, b12, b13, b14, b15, b16, b17, b22, b23, b24, b25, b26, b27, b32, b33, b34, b35, b36, b37, b42, b43, b44, b45, b46, b47, b52, b53, b54, b55, b56, b57, b62, b63, b64, b65, b66, b67, b72, b73, b74, b75, b76, b77, b82, b83, b84, b85, b86, b87
- Published X count: 64
...
| `b12` | `integer` | unknown | 0% |
| `b13` | `integer` | unknown | 0% |
| `b14` | `integer` | unknown | 0% |
| `b15` | `integer` | unknown | 0% |
| `b16` | `integer` | unknown | 0% |
| `b17` | `integer` | unknown | 0% |
| `b22` | `numeric` | continuous | 0% |
| `b23` | `integer` | unknown | 0% |
| `b24` | `integer` | unknown | 0% |
| `b25` | `integer` | unknown | 0% |
| `b26` | `integer` | unknown | 0% |
| `b27` | `integer` | unknown | 0% |
| `b32` | `integer` | unknown | 0% |
| `b33` | `integer` | unknown | 0% |
| `b34` | `integer` | unknown | 0% |
| `b35` | `integer` | unknown | 0% |
| `b36` | `integer` | unknown | 0% |
| `b37` | `integer` | unknown | 0% |
| `b42` | `integer` | unknown | 0% |
| `b43` | `integer` | unknown | 0% |
| `b44` | `integer` | unknown | 0% |
| `b45` | `integer` | unknown | 0% |
| `b46` | `integer` | unknown | 0% |
| `b47` | `integer` | unknown | 0% |
| `b52` | `integer` | unknown | 0% |
| `b53` | `integer` | unknown | 0% |
| `b54` | `integer` | unknown | 0% |
| `b55` | `integer` | unknown | 0% |
| `b56` | `integer` | unknown | 0% |
| `b57` | `integer` | unknown | 0% |
| `b62` | `numeric` | continuous | 0% |
| `b63` | `integer` | unknown | 0% |
| `b64` | `integer` | unknown | 0% |
| `b65` | `integer` | unknown | 0% |
| `b66` | `integer` | unknown | 0% |
| `b67` | `integer` | unknown | 0% |
| `b72` | `numeric` | continuous | 0% |
| `b73` | `integer` | unknown | 0% |
| `b74` | `integer` | unknown | 0% |
| `b75` | `integer` | unknown | 0% |
| `b76` | `integer` | unknown | 0% |
| `b77` | `integer` | unknown | 0% |
| `b82` | `numeric` | continuous | 0% |
| `b83` | `numeric` | continuous | 0% |
| `b84` | `integer` | unknown | 0% |
| `b85` | `integer` | unknown | 0% |
| `b86` | `integer` | unknown | 0% |
| `b87` | `integer` | unknown | 0% |

### Formule - niveau publication

- formula_pub: pending
- x_terms_pub: ndvi01, ndvi02, ndvi03, ndvi04, ndvi05, ndvi06, ndvi07, ndvi08, ndwi01, ndwi02, ndwi03, ndwi04, ndwi05, ndwi06, ndwi07, ndwi08, b12, b13, b14, b15, b16, b17, b22, b23, b24, b25, b26, b27, b32, b33, b34, b35, b36, b37, b42, b43, b44, b45, b46, b47, b52, b53, b54, b55, b56, b57, b62, b63, b64, b65, b66, b67, b72, b73, b74, b75, b76, b77, b82, b83, b84, b85, b86, b87
- y_term_pub: croptype
...
- License evidence: GitHub repository license API (checked 2026-08-18): SPDX GPL-3.0.
...
formula_candidates:
  ...
  ml_or_selected:
    formula: "croptype ~ ndvi01 + ndvi02 + ndvi03 + ndvi04 + ndvi05 + ndvi06 + ndvi07 + ndvi08 + ndwi01 + ndwi02 + ndwi03 + ndwi04 + ndwi05 + ndwi06 + ndwi07 + ndwi08 + b12 + b13 + b14 + b15 + b16 + b17 + b22 + b23 + b24 + b25 + b26 + b27 + b32 + b33 + b34 + b35 + b36 + b37 + b42 + b43 + b44 + b45 + b46 + b47 + b52 + b53 + b54 + b55 + b56 + b57 + b62 + b63 + b64 + b65 + b66 + b67 + b72 + b73 + b74 + b75 + b76 + b77 + b82 + b83 + b84 + b85 + b86 + b87"
    response: "croptype"
    predictors: ["ndvi01", "ndvi02", "ndvi03", "ndvi04", "ndvi05", "ndvi06", "ndvi07", "ndvi08", "ndwi01", "ndwi02", "ndwi03", "ndwi04", "ndwi05", "ndwi06", "ndwi07", "ndwi08", "b12", "b13", "b14", "b15", "b16", "b17", "b22", "b23", "b24", "b25", "b26", "b27", "b32", "b33", "b34", "b35", "b36", "b37", "b42", "b43", "b44", "b45", "b46", "b47", "b52", "b53", "b54", "b55", "b56", "b57", "b62", "b63", "b64", "b65", "b66", "b67", "b72", "b73", "b74", "b75", "b76", "b77", "b82", "b83", "b84", "b85", "b86", "b87"]
...
- License URL: https://github.com/alexanderbrenning/spdiag/blob/main/LICENSE
- License open: yes
