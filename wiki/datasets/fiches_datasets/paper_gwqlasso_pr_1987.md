...
- Local sf output: `data/final_datasets/sf/paper_gwqlasso_pr_1987.rds`
...
| `precip_annual_mm` | `numeric` | continuous | 0.3% |
...
- Reference publication: Miquelluti, D.L., Ozaki, V.A. & Miquelluti, D.J. (2022), Revista de Administracao Contemporanea 26(3): e200387, doi:10.1590/1982-7849rac2022200387.en. Sous-ensemble (1987) du jeu parent [[paper_gwqlasso_pr]] -- meme formule, aucune modification.
...
- Dataset ID: `paper_gwqlasso_pr_1987`
- Dataset name: Rendement de soja et precipitation, municipalites de Parana -- sous-ensemble 1987
...
modeling_evidence:
  ...
  source_ref: "Miquelluti, D.L., Ozaki, V.A. & Miquelluti, D.J. (2022), Revista de Administracao Contemporanea 26(3): e200387, doi:10.1590/1982-7849rac2022200387.en. Sous-ensemble (1987) du jeu parent paper_gwqlasso_pr."
  confidence: medium
```
...
- Missing values: OK - Yield_kg_ha a 42.9% de NA (coherent avec le parent, placeholders textuels convertis en NA le 2026-09-08).
...
Fiche generee par decoupage temporel du panel parent [[paper_gwqlasso_pr]] (coupe transversale annuelle 1987), sur decision explicite de l'utilisateur, pour elargir le nombre de jeux de donnees benchmarkables sans casser la validite spatiale (memes 399 municipalites que le parent, matrice W non degeneree). Le parent [[paper_gwqlasso_pr]] (panel complet, N=17157) est conserve tel quel.
