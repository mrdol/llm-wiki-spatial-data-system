---
title: Python_geodatasets_geoda.orlando1
type: dataset
created: 2026-08-15
updated: 2026-09-07
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.orlando1.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`orlando1`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.orlando1
- Observation unit: observation spatiale de type POINT
- Observed population: 328 enregistrements dans l’artefact local Python_geodatasets_geoda.orlando1.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
- Geographic context: Etendue mesuree dans le RDS : x [-81.939478052786, -81.009356048433], y [27.994866, 29.118848]; CRS WGS 84.
- Temporal context: aucune variable temporelle structurelle detectee
- Source description: Dataset spatial issu du package Python `geodatasets` (`orlando1`).
...
|---|---|---|---|---|
| `HH_INC` | `integer` | count | [9800, 140634] | 0% |
| `HSG_VAL` | `integer` | count | [0, 436000] | 0% |
| `POV_TOT` | `integer` | count | [0, 3085] | 0% |


> Selection Y/X (claude-sonnet-4-6) : HH_INC (revenu médian des ménages), HSG_VAL (valeur médiane des logements) et POV_TOT (nombre de personnes en dessous du seuil de pauvreté) sont des variables socio-économiques synthétiques classiquement utilisées comme variables réponse dans les modèles spatiaux. Les variables démographiques (population totale, structure par âge, composition raciale/ethnique), d'emploi (EMPL16, EMP_AWAY, EMP_HOME, catégories professionnelles) et POV_POP constituent des covariables explicatives naturelles ; FIPS et MSA sont des codes administratifs ignorés.
...
- Dataset ID: `Python_geodatasets_geoda.orlando1`
- Dataset name: geodatasets::orlando1
...
- Spatial extent: x [-81.9395, -81.0094], y [27.9949, 29.1188] (EPSG:4326)
