...
Dataset spatial issu du package Python `geodatasets` (`charleston1`).
...
|---|---|---|---|---|
| `HH_INC` | `integer` | count | [9356, 101198] | 0% |
| `HSG_VAL` | `integer` | count | [0, 713600] | 0% |
| `POV_TOT` | `integer` | count | [8, 1908] | 0% |


> Selection Y/X (claude-sonnet-4-6) : HH_INC (revenu médian des ménages), HSG_VAL (valeur médiane des logements) et POV_TOT (nombre de personnes en pauvreté) sont des cibles socio-économiques classiques en spatial ML. Les variables démographiques (population, race, sexe, âge) et d'emploi/occupation constituent des covariables explicatives naturelles ; FIPS et MSA sont des codes administratifs ignorés.
...
- Dataset ID: `Python_geodatasets_geoda.charleston1`
- Dataset name: geodatasets::charleston1
