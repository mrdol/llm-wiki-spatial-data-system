...
- Observation unit: unite spatiale administrative ou scolaire
- Observed population: population scolaire ou socio-demographique locale
- Geographic context: Etendue mesuree dans le RDS : x [-74.23968843153, -73.705030000136], y [40.507671662552, 40.912682100886]; CRS EPSG:4326.
- Temporal context: aucune variable temporelle structurelle detectee
- Source description: Dataset spatial issu du package Python `geodatasets` (`nyc_education`).
...
formula_candidates:
  ...
  ml_or_selected:
    formula: "YOUTH_DROP ~ PER_MNRTY + PER_ASIAN + PER_WHITE + PER_BLACK + mean_inc + pop1619 + enrollhs + PER_PRV_SC"
    response: "YOUTH_DROP"
    predictors: ["PER_MNRTY", "PER_ASIAN", "PER_WHITE", "PER_BLACK", "mean_inc", "pop1619", "enrollhs", "PER_PRV_SC"]
...
modeling_evidence:
  ...
  equation_text: "YOUTH_DROP ~ PER_MNRTY + PER_ASIAN + PER_WHITE + PER_BLACK + mean_inc + pop1619 + enrollhs + PER_PRV_SC"
