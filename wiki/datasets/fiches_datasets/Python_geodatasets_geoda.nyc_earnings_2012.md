---
title: Python_geodatasets_geoda.nyc_earnings_2012
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.nyc_earnings_2012.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2012`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.nyc_earnings_2012
- Observation unit: observation spatiale de type POINT
- Observed population: 108487 enregistrements dans l’artefact local Python_geodatasets_geoda.nyc_earnings_2012.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
- Geographic context: Etendue mesuree dans le RDS : x [1796851.348471047, 1990735.0437511161], y [544218.8336771992, 675975.440276064]; CRS USA_Contiguous_Albers_Equal_Area_Conic.
- Temporal context: aucune variable temporelle structurelle detectee
- Source description: Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2012`).
...
- Candidate Y variables: `total_jobs`, `jobs_earnings_high`, `jobs_earnings_low`
- Candidate Y typology: count
- Candidate X variables: `ALAND10`, `AWATER10`, `COUNTYFP10`
...
|---|---|---|---|---|
| `total_jobs` | `integer` | count | [0, 2677] | 0% |
| `jobs_earnings_high` | `integer` | count | [0, 1389] | 0% |
| `jobs_earnings_low` | `integer` | count | [0, 593] | 0% |


> Selection Y/X (claude-sonnet-4-6) : Les variables d'emploi (total_jobs, jobs_earnings_high, jobs_earnings_low) sont des cibles naturelles pour modéliser la distribution spatiale des emplois et des niveaux de revenus à l'échelle des block groups NYC 2012. Les surfaces terrestres (ALAND10) et aquatiques (AWATER10) ainsi que le comté (COUNTYFP10) constituent des covariables spatiales pertinentes (densité, effets de borough) ; les codes géographiques (GEOID10, TRACTCE10, BLOCKCE10, STATEFP10) et les coordonnées centroïdes en chaîne (INTPTLAT10, INTPTLON10) sont ignorés car purement administratifs ou redondants avec la géométrie.
...
- Dataset ID: `Python_geodatasets_geoda.nyc_earnings_2012`
- Dataset name: geodatasets::nyc_earnings_2012
