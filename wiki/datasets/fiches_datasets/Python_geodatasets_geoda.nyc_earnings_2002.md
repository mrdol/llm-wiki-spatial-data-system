---
title: Python_geodatasets_geoda.nyc_earnings_2002
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.nyc_earnings_2002.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2002`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.nyc_earnings_2002
- Observation unit: observation spatiale de type POINT
- Observed population: 108487 enregistrements dans l’artefact local Python_geodatasets_geoda.nyc_earnings_2002.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
...
- Source description: Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2002`).
...
|---|---|---|---|---|
| `total_jobs` | `integer` | count | [0, 1961] | 0% |
| `jobs_earnings_high` | `integer` | count | [0, 1044] | 0% |
| `jobs_earnings_low` | `integer` | count | [0, 609] | 0% |


> Selection Y/X (claude-sonnet-4-6) : Les variables d'emploi (total_jobs, jobs_earnings_high, jobs_earnings_low) sont des cibles plausibles pour modéliser la distribution spatiale des emplois et des revenus au niveau des blocs Census NYC 2002. Les caractéristiques physiques du bloc (superficie terrestre ALAND10, superficie en eau AWATER10) et le comté (COUNTYFP10) servent de covariables explicatives spatiales ; les identifiants géographiques textuels (GEOID10, TRACTCE10, BLOCKCE10, STATEFP10) et les coordonnées encodées en caractères (INTPTLAT10, INTPTLON10) sont ignorés car purement administratifs ou redondants avec la géométrie.
...
- Dataset ID: `Python_geodatasets_geoda.nyc_earnings_2002`
- Dataset name: geodatasets::nyc_earnings_2002
