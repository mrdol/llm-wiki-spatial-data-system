---
title: Python_geodatasets_geoda.seattle1
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.seattle1.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`seattle1`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.seattle1
- Observation unit: observation spatiale de type POINT
- Observed population: 664 enregistrements dans l’artefact local Python_geodatasets_geoda.seattle1.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
- Geographic context: Etendue mesuree dans le RDS : x [-122.760446707592, -121.35287114963], y [46.851862, 48.261598]; CRS WGS 84.
- Temporal context: aucune variable temporelle structurelle detectee
- Source description: Dataset spatial issu du package Python `geodatasets` (`seattle1`).
...
- Candidate X variables: `TOT_POP`, `POP_16`, `POP_65`, `WHITE_`, `BLACK_`, `ASIAN_`, `HISP_`, `MULTI_RA`, `MALES`, `FEMALES`, `MALE1664`, `FEM1664`, `EMPL16`, `EMP_AWAY`, `EMP_HOME`, `EMP_29`, `EMP_30`, `EMP16_2`, `EMP_MALE`, `EMP_FEM`, `OCC_MAN`, `OCC_OFF1`, `OCC_INFO`, `POV_POP`
...
|---|---|---|---|---|
| `HH_INC` | `integer` | count | [0, 133756] | 0% |
| `HSG_VAL` | `integer` | count | [0, 781000] | 0% |
| `POV_TOT` | `integer` | count | [0, 2065] | 0% |


> Selection Y/X (claude-sonnet-4-6) : Les variables HH_INC (revenu médian du ménage), HSG_VAL (valeur du logement) et POV_TOT (population en dessous du seuil de pauvreté) sont des cibles socio-économiques classiques en spatial ML. Les variables démographiques (population, composition raciale, âge, genre) et d'emploi/occupation servent de covariables explicatives ; FIPS et MSA sont des identifiants/codes administratifs ignorés.
...
- Dataset ID: `Python_geodatasets_geoda.seattle1`
- Dataset name: geodatasets::seattle1
...
- Spatial extent: x [-122.7604, -121.3529], y [46.8519, 48.2616] (EPSG:4326)
