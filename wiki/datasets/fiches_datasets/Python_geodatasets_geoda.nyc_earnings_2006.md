---
title: Python_geodatasets_geoda.nyc_earnings_2006
type: dataset
created: 2026-08-15
updated: 2026-09-16
sources:
  - data/final_datasets/sf/Python_geodatasets_geoda.nyc_earnings_2006.rds
tags: [dataset, python-package, spatial, point]
---

Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2006`).

## Description du jeu de donnees

- Topic: Donnees de python-package : Python_geodatasets_geoda.nyc_earnings_2006
- Observation unit: observation spatiale de type POINT
- Observed population: 108487 enregistrements dans l’artefact local Python_geodatasets_geoda.nyc_earnings_2006.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
...
- Source description: Dataset spatial issu du package Python `geodatasets` (`nyc_earnings_2006`).
...
|---|---|---|---|---|
| `total_jobs` | `integer` | count | [0, 2028] | 0% |
| `jobs_earnings_high` | `integer` | count | [0, 1112] | 0% |


> Selection Y/X (claude-sonnet-4-6) : Les variables d'emploi (total_jobs, jobs_earnings_high) sont des cibles naturelles pour modéliser l'activité économique ou la distribution salariale au niveau bloc. ALAND10, AWATER10 et COUNTYFP10 sont des covariables morphologiques/géographiques exploitables, et jobs_earnings_low peut servir de prédicteur des emplois bien rémunérés ; les identifiants géographiques (GEOID10, TRACTCE10, BLOCKCE10, STATEFP10, INTPTLAT10, INTPTLON10) sont administratifs ou redondants avec la géométrie et sont ignorés.
...
- Dataset ID: `Python_geodatasets_geoda.nyc_earnings_2006`
- Dataset name: geodatasets::nyc_earnings_2006
