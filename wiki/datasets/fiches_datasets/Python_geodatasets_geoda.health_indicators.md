...
- formula_candidate_1: Infan_Rate ~ Below_evel + Unemp_ment + NoHig_loma + PerCa_come + Dependency + Crowd_sing + Prena_ster + Prete_rths
- formula_candidate_2: Infan_Rate ~ Below_evel + Unemp_ment + NoHig_loma + PerCa_come
