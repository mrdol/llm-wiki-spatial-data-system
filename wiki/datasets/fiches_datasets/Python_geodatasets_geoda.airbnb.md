...
- Topic: Donnees de python-package : Python_geodatasets_geoda.airbnb
- Observation unit: observation spatiale de type POINT
- Observed population: 77 enregistrements dans l’artefact local Python_geodatasets_geoda.airbnb.rds; unite declaree : observation spatiale de type POINT. Le nombre de lignes n’est pas le nombre de sites independants.
...
formula_candidates:
  ...
  ml_or_selected:
    formula: "price_pp ~ poverty + crowded + dependency + without_hs + unemployed + income_pc + harship_in + num_crimes"
    response: "price_pp"
    predictors: ["poverty", "crowded", "dependency", "without_hs", "unemployed", "income_pc", "harship_in", "num_crimes"]
...
modeling_evidence:
  ...
  equation_text: "price_pp ~ poverty + crowded + dependency + without_hs + unemployed + income_pc + harship_in + num_crimes"
