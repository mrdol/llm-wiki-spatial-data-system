...
Dataset spatial converti en sf a partir des donnees brutes du papier "Spatiotemporal analysis of leptospirosis in Colombia from 2007 to 2021. An environmental health metrics approach" (DOI 10.1080/09581596.2025.2578588).
...
- Geographic context: Etendue mesuree dans le RDS : x [-78.185980606933, -66.996784940973], y [-3.60316595, 11.99163965]; CRS WGS 84.
- Temporal context: none (cross-sectional)
- Source description: Spatiotemporal analysis of leptospirosis in Colombia from 2007 to 2021. An environmental health metrics approach
- Description source: paper_dataset_uses.json + lecture directe du papier
- Description confidence: medium
- Paper DOI: 10.1080/09581596.2025.2578588
...
> Selection Y/X (paper-loader / curated evidence) : Pour `colombia_leptospirosis_risk`, la ou les reponses `RR` viennent du loader papier et/ou des preuves de l article `Spatiotemporal analysis of leptospirosis in Colombia from 2007 to 2021. An environmental health metrics approach`. Les covariables X retenues sont `MannKendall`, `emerging_trend`, `mean_annual_temp_c`, `annual_precip_mm`. Les coordonnees (geometrie sf `geom_point` (POINT)), identifiants (`key`, `shapeName`, `Municipality`, `significance_95`), geometries et champs techniques sont exclus de X. Statut benchmark actuel : not_ready_main_benchmark; la promotion package reste conditionnee au bloc benchmark_readiness.
...
- License evidence: DataCite API record for DOI 10.5281/zenodo.17104058 (checked 2026-08-18): rightsList = 'Creative Commons Attribution 4.0 International'.
...
- Paper title: Spatiotemporal analysis of leptospirosis in Colombia from 2007 to 2021. An environmental health metrics approach
- Paper DOI: 10.1080/09581596.2025.2578588
- Dataset DOI: 10.5281/zenodo.17104058
- Source URL: https://doi.org/10.5281/zenodo.17104058
- Year: 2025
...
benchmark_readiness:
  ...
  package_include: "no"
  has_local_rds: true
  missing_items: "RR et MannKendall sont des sorties statistiques; covariables climatiques ajoutées. Géométrie réelle ne transforme pas ces sorties en observations d’incidence. Garder cette version hors benchmark empirique général; rechercher cas/populations municipaux pour une tâche distincte."
  reason: "RR et MannKendall sont des sorties statistiques; covariables climatiques ajoutées. Géométrie réelle ne transforme pas ces sorties en observations d’incidence. Garder cette version hors benchmark empirique général; rechercher cas/populations municipaux pour une tâche distincte."
```

- Decision: not_ready_main_benchmark
- Manque principal: RR et MannKendall sont des sorties statistiques; covariables climatiques ajoutées. Géométrie réelle ne transforme pas ces sorties en observations d’incidence. Garder cette version hors benchmark empirique général; rechercher cas/populations municipaux pour une tâche distincte.
- Raison: RR et MannKendall sont des sorties statistiques; covariables climatiques ajoutées. Géométrie réelle ne transforme pas ces sorties en observations d’incidence. Garder cette version hors benchmark empirique général; rechercher cas/populations municipaux pour une tâche distincte.
...
estimator_eligibility:
  ...
  ineligible_reason: "RR et MannKendall sont des sorties statistiques; covariables climatiques ajoutées. Géométrie réelle ne transforme pas ces sorties en observations d’incidence. Garder cette version hors benchmark empirique général; rechercher cas/populations municipaux pour une tâche distincte."
...
- Source: Spatiotemporal analysis of leptospirosis in Colombia from 2007 to 2021. An environmental health metrics approach

## Curation documentée — 2026-09-07

Decision conservatoire : RR et MannKendall sont des sorties statistiques; covariables climatiques ajoutées. Géométrie réelle ne transforme pas ces sorties en observations d’incidence. Garder cette version hors benchmark empirique général; rechercher cas/populations municipaux pour une tâche distincte. La fiche et les donnees sont conservees ; aucune suppression ni promotion.
