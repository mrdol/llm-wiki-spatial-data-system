...
- Published X variables from paper: MannKendall, emerging_trend, mean_annual_temp_c, annual_precip_mm -- proxy de la pluviometrie identifiee par le papier comme le determinant environnemental le plus important
- Published X count: 4
...
- x_terms_pub: MannKendall, emerging_trend, mean_annual_temp_c, annual_precip_mm -- proxy de la pluviometrie identifiee par le papier comme le determinant environnemental le plus important
- y_term_pub: RR
...
formula_candidates:
  ...
  multivariate_constrained:
    ...
    response: "RR"
    predictors: ["MannKendall", "emerging_trend", "mean_annual_temp_c", "annual_precip_mm -- proxy de la pluviometrie identifiee par le papier comme le determinant environnemental le plus important"]
